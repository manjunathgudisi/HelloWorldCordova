...
var OneViewAdvAutoCompleteEvent;
var AutoCompleteCloseEvent;
...
MyApp.controller('CookingAndBlastChillingMonitoringController',
    function ($scope, $document, xlatService, $timeout, $location, $templateCache, snapRemote, $compile) {
      //  oSetDefaultSpinner.Start();
       ...
       // xlatService.setCurrentPage('CookingAndBlastChillingMonitoring');
        document.getElementById('PageTitle').innerHTML = xlatService.xlat('PageTitle');
        var oCookingAndBlastChillingMonitoringFacade =
            new CookingAndBlastChillingMonitoringFacade({ 'scope': $scope, 'document': $document, 'location': $location, 'xlatService': xlatService, 'toaster': '', 'SpinService': '', '$timeout': $timeout, 'compile': $compile });
       ...
       // oSetDefaultSpinner.Stop();
        ...
        if (OneViewSessionStorage.Get("NCInlineEdit") == 'true') {
            ...
            ////oCookingAndBlastChillingMonitoringFacade.NCInlineEditPageLoadTimeSave();
...
function CookingAndBlastChillingMonitoringFacade(parm) {
    ...
    try {
      ...
      //  }
        ...
        this.NCInlineEditPageLoadTimeSave = function () {
            try {
                OneViewConsole.Debug("NCInlineEditPageLoadTimeSave Start", "CookingAndBlastChillingMonitoringFacade.NCInlineEditPageLoadTimeSave");
                if (OneViewSessionStorage.Get("NCInlineEdit") != 'true') {
                    //alert('1');
                    $scope.DivNGForm = false;
                    $scope.DivContent = true;
                ...
                oSetDefaultSpinner.Start();
                var Status = _oDataCaptureBO.UpdateDC(DcId, undefined, _oDataCaptureBO.PreEditValues);
                //alert(JSON.stringify(_oDataCaptureBO.PreEditValues));
                //if (Status != false) {
                //    alert('in');
                //    _oDataCaptureBO.DCNCMappingList = new Array();
                //    $scope['DCBoutNCSignature_IsModified'] = '';
            ...
            OneViewConsole.Debug("NCInlineEditPageLoadTimeSave End", "CookingAndBlastChillingMonitoringFacade.NCInlineEditPageLoadTimeSave");
            }
            catch (Excep) {
                oOneViewExceptionHandler.Catch(Excep, "CookingAndBlastChillingMonitoringFacade.NCInlineEditPageLoadTimeSave", xlatService);
            }
            finally {
                Status = null;
            }
        ...
        var ValidateActionNC = function (AttributeId, ControlId, RefreshcontrolId) {
            try {
               ...
               // alert("11 CookingAndBlastChillingMonitoringFacade.ValidateActionNC Excep" + Excep);
               // alert("22 CookingAndBlastChillingMonitoringFacade.ValidateActionNC Excep" + JSON.stringify(Excep));
                throw Excep;
            }
            finally {
                oDataCaptureBO = null;
        ...
        this.ShowNCFormAction = function (ControlId, RefreshcontrolId) {
            try {
               ...
               // alert("11 CookingAndBlastChillingMonitoringFacade.ShowNCFormAction Excep" + Excep);
               // alert("22 CookingAndBlastChillingMonitoringFacade.ShowNCFormAction Excep" + JSON.stringify(Excep));
        ...
        var Loadddl_OneViewAdv = function () {
            try {
                ...
                var oProductddl = new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'AddlProductControlId', 'DataSourceModelName': 'Products', 'DisplayElementModelName': 'NewDCModel.AddlProductControlId', 'DATEntityTypeId': DATEntityType.RCO_WorkOrder, 'xlatService': xlatService, 'ToasterService': '', 'AttributeNodeId': 4 });
        ...
        var BindNCLoadDatas = function () {
            try {
                ...
                var oSectionddl =
                  new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'ddlSectionControlId', 'DataSourceModelName': 'Section', 'DisplayElementModelName': 'NewDCModel.ddlSectionControlId', 'DATEntityTypeId': DATEntityType.RCOMaster_Location, 'xlatService': xlatService, 'ToasterService': '', 'MinCharToSearch': 0, 'AttributeNodeId': 10337 });
                    ...
                    try {
                        ...
                        //   /// alert('in DTNCChillerTimeOutControlId' + scope.NewDCModel['DTNCChillerTimeOutControlId']);
                            ...
                            if (AnswerToBind.Answer != "") {
                               ...
                               // alert('GetBoutNCDataCaptureBO : ' + AnswerModeObject.ControlId + '      scope.NewDCModel[AnswerModeObject.ControlId]  : ' + scope.NewDCModel[AnswerModeObject.ControlId] + ' AnswerToBind.Answer : ' + AnswerToBind.Answer);
                            }
                        }
