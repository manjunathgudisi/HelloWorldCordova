...
MyApp.controller('pHMeterCalibrationRecordsController',
    function ($scope, $document, xlatService, $timeout, $location, $templateCache, snapRemote, $compile) {
    //oSetDefaultSpinner.Start();
        //  xlatService.setCurrentPage('pHMeterCalibrationRecords');
	...
	var opHMeterCalibrationRecordsFacade = new pHMeterCalibrationRecordsFacade({ 'scope': $scope, 'document': $document, 'Mylocation': $location, 'xlatService': xlatService, 'toaster': '', 'SpinService': '', 'compile': $compile, '$timeout': $timeout });

    opHMeterCalibrationRecordsFacade.Init();
    opHMeterCalibrationRecordsFacade.PageLoad();
	//oSetDefaultSpinner.Stop();
  
    $scope.Signature = function () {
        opHMeterCalibrationRecordsFacade.Signature();
    }

    $scope.ngChange_setIsManualFlag = function (ControlId) {
        opHMeterCalibrationRecordsFacade.ngChange_setIsManualFlag(ControlId);
    }

    $scope.$on('$destroy', function () {
        var oOneViewSidePanel = new OneViewSidePanel();
        oOneViewSidePanel.Clear();
        opHMeterCalibrationRecordsFacade.Destroy();

        xlatService.RemoveCurrentPageMetadata(currentPage);
    });

    $scope.GetProbeStatus = function () {
        opHMeterCalibrationRecordsFacade.GetProbeStatus();
    };

    $scope.AddRecords = function () {
        opHMeterCalibrationRecordsFacade.SaveDCRecords();
    };
    
    $scope.SetSelectedTextBoxColor = function (ControlId) {
        opHMeterCalibrationRecordsFacade.SetSelectedTextBoxColor(ControlId);
    };
    ...
    $scope.SetAutoTemperatureListener = function (EventArg, TimeModelId) {
        opHMeterCalibrationRecordsFacade.SetAutoTemperatureListener(EventArg, TimeModelId);
    };
    ...
    $scope.Temperature_NgKeyUp = function (AttributeId, ControlId, RefreshcontrolId, IsNc, RefreshAttributeId) {
        ...
        lastTimeOutId = $timeout(function () { opHMeterCalibrationRecordsFacade.Temperature_NgKeyUp(AttributeId, ControlId, RefreshcontrolId, IsNc, RefreshAttributeId); }, Timeout);
    }
    ...
    $scope.ClearForm = function () {
        opHMeterCalibrationRecordsFacade.ClearForm();
    }
    $scope.$on('$destroy', function () {
        ...
        scope = null;
        ionicBackdrop = null;
        opHMeterCalibrationRecordsFacade = null;
        $scope = null;
    });

    $scope.PreControlEvents = function (AttributeId, ControlId, $event) {
        opHMeterCalibrationRecordsFacade.PreControlEvents(AttributeId, ControlId, $event);
    }

    $scope.PostControlEvents = function (AttributeId, ControlId) {

        opHMeterCalibrationRecordsFacade.PostControlEvents(AttributeId, ControlId);
    }

    $scope.ngChange_setDateTime = function (ControlId) {
        opHMeterCalibrationRecordsFacade.ngChange_setDateTime(ControlId);
    }

    $scope.SubmitRecords = function () {
        opHMeterCalibrationRecordsFacade.SaveDCRecords(true);
    }



    $scope.CustomNCClick = function () {
        opHMeterCalibrationRecordsFacade.CustomNCClick();
    }

    $scope.NCClick = function () {
        opHMeterCalibrationRecordsFacade.NCClick($compile);
    }

    $scope.ObservationTabClick = function () {
        opHMeterCalibrationRecordsFacade.ObservationTabClick($compile);
    }

    $scope.NCTabClick = function () {
        opHMeterCalibrationRecordsFacade.NCTabClick($compile);
    }

    $scope.CloseRightPanel = function () {
        opHMeterCalibrationRecordsFacade.CloseRightPanel();
    }

    $scope.ProbeTesting = function () {
        opHMeterCalibrationRecordsFacade.ProbeTesting();
    };
    $scope.ClearReasons = function () {
        opHMeterCalibrationRecordsFacade.ClearReasons();
    }

    $scope.ClearComments = function () {
        opHMeterCalibrationRecordsFacade.ClearComments();
    } 
    ...
    $scope.ngChange_SetObservedvalueDifference = function (ControlId, CorrectionControlId, UnitofReferenceControlId, DifferenceValue) {
        opHMeterCalibrationRecordsFacade.ngChange_SetObservedvalueDifference(ControlId, CorrectionControlId, UnitofReferenceControlId, DifferenceValue);
    }
...
function pHMeterCalibrationRecordsFacade(parm) {

    try {
        OneViewConsole.Debug("pHMeterCalibrationRecordsFacade Start", "Facade.pHMeterCalibrationRecordsFacade");
      ...
      //  var _oNCComponent = new NCComponent($scope, TemplateNodes, '', xlatService);
        ...
        OneViewConsole.Debug("pHMeterCalibrationRecordsFacade End", "Facade.pHMeterCalibrationRecordsFacade");
    }
    catch (Excep) {
        oOneViewExceptionHandler.Catch(Excep, "Facade.pHMeterCalibrationRecordsFacade", xlatService);
    }

        this.Init = function () {
            try {
                OneViewConsole.Debug("Init Start", "pHMeterCalibrationRecordsFacade.Init");
                ...
                OneViewConsole.Debug("Init End", "pHMeterCalibrationRecordsFacade.Init");
            }

            catch (Excep) {
                oOneViewExceptionHandler.Catch(Excep, "pHMeterCalibrationRecordsFacade.Init", xlatService);
            }
        }
        ...
        this.PageLoad = function () {
            try {
                OneViewConsole.Debug("PageLoad Start", "pHMeterCalibrationRecordsFacade.PageLoad");
                ...
                OneViewConsole.Debug("PageLoad End", "pHMeterCalibrationRecordsFacade.PageLoad");
            }

            catch (Excep) {
                oOneViewExceptionHandler.Catch(Excep, "pHMeterCalibrationRecordsFacade.PageLoad", xlatService);
            }
        }

        this.SetSelectedTextBoxColor = function (ControlId) {
            try {
                OneViewConsole.Debug("SetSelectedTextBoxColor Start", "pHMeterCalibrationRecordsFacade.SetSelectedTextBoxColor");

                SetSelectedTextBoxColor_Private(ControlId);

                OneViewConsole.Debug("SetSelectedTextBoxColor End", "pHMeterCalibrationRecordsFacade.SetSelectedTextBoxColor");
            }
            catch (Excep) {
                oOneViewExceptionHandler.Catch(Excep, "pHMeterCalibrationRecordsFacade.SetSelectedTextBoxColor", xlatService);
            }
        }

        var SetSelectedTextBoxColor_Private = function (ControlId) {
            try {
                OneViewConsole.Debug("SetSelectedTextBoxColor_Private Start", "pHMeterCalibrationRecordsFacade.SetSelectedTextBoxColor_Private");

                if (ControlId == 'txtTempControlId') {
                    $scope.txtTempControlId = 'highlight';
                }

                OneViewConsole.Debug("SetSelectedTextBoxColor_Private End", "pHMeterCalibrationRecordsFacade.SetSelectedTextBoxColor_Private");
            }
            catch (Excep) {
                throw Excep;
            }
        ...
        var BindNc = function (NcStatus, objRule, AttributeId, ControlId) {
            try {
                OneViewConsole.Debug("BindNc Start", "pHMeterCalibrationRecordsFacade.BindNc");
                ...
                OneViewConsole.Debug("BindNc End", "pHMeterCalibrationRecordsFacade.BindNc");
            }
            catch (Excep) {
                throw Excep;
            }
        ...
        this.GetProbeStatus = function () {
            try {
                OneViewConsole.Debug("GetProbeStatus Start", "pHMeterCalibrationRecordsFacade.GetProbeStatus");
                               
                _oSettingsBO.ProbeStatus('', xlatService);

                OneViewConsole.Debug("GetProbeStatus End", "pHMeterCalibrationRecordsFacade.GetProbeStatus");

            }
            catch (Excep) {
                oOneViewExceptionHandler.Catch(Excep, "pHMeterCalibrationRecordsFacade.GetProbeStatus", xlatService);
            }
        }

        this.SetAutoTemperatureListener = function (EventArg, TimeControlId) {
            try {
                OneViewConsole.Debug("SetAutoTemperatureListener Start", "pHMeterCalibrationRecordsFacade.SetAutoTemperatureListener");
                ...
                OneViewConsole.Debug("SetAutoTemperatureListener End", "pHMeterCalibrationRecordsFacade.SetAutoTemperatureListener");
            }
            catch (Excep) {
                oOneViewExceptionHandler.Catch(Excep, "pHMeterCalibrationRecordsFacade.SetAutoTemperatureListener", xlatService);
            }
            finally {
                modelName = null;
            }
        ...
        this.SaveDCRecords = function (IsSubmit) {
            oSetDefaultSpinner.Start();
            try {
                OneViewConsole.Debug("SaveDCRecords Start", "pHMeterCalibrationRecordsFacade.SaveDCRecords");
                ...
                OneViewConsole.Debug("SaveDCRecords End", "pHMeterCalibrationRecordsFacade.SaveDCRecords");
            }
            catch (Excep) {
                oOneViewExceptionHandler.Catch(Excep, "pHMeterCalibrationRecordsFacade.SaveDCRecords", xlatService);
            }
            finally {
                Status = null;
            }
        ...
        var Loadddl = function () {
            try {
                OneViewConsole.Debug("Loadddl Start", "pHMeterCalibrationRecordsFacade.Loadddl");

                OneViewAdvAutoCompleteEvent = OneViewAdvAutoCompleteClick;
                AutoCompleteCloseEvent = AutoCompleteCloseClick;

               // var oEquipmentNameddl = new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'AddlEquipmentNameControlId', 'DataSourceModelName': 'EquipmentName', 'DisplayElementModelName': 'NewDCModel.AddlEquipmentNameControlId', 'DATEntityTypeId': DATEntityType.RCOMaster_EquipmentName, 'xlatService': xlatService, 'ToasterService': '', 'AttributeNodeId': 655, 'SelectedIndexChangedEventHandler': oEquipmentNameSelectedIndexChanged });
                var oEquipmentNameddl = new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'AddlEquipmentNameControlId', 'DataSourceModelName': 'EquipmentName', 'DisplayElementModelName': 'NewDCModel.AddlEquipmentNameControlId', 'DATEntityTypeId': DATEntityType.RCOMaster_PhEquipment, 'IsDynamicElementCreationEnabled': false, 'xlatService': xlatService, 'MinCharToSearch': 0, 'ToasterService': '', 'AttributeNodeId': 655 });
                ...
                OneViewConsole.Debug("Loadddl End", "pHMeterCalibrationRecordsFacade.Loadddl");
            }
            catch (Excep) {
                throw Excep;
            }
        ...
        var oEquipmentNameSelectedIndexChanged = function (EventArgs) {
            try {
                ...
                if (EventArgs != null && EventArgs.NewValue.Id != null && EventArgs.NewValue.Id > 0) {                   
                    var oEquipmentNumberddl = new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'AddlEquipmentNumberControlId', 'DataSourceModelName': 'EquipmentNumber', 'DisplayElementModelName': 'NewDCModel.AddlEquipmentNumberControlId', 'DATEntityTypeId': DATEntityType.RCOMaster_EquipmentNumber, 'xlatService': xlatService, 'ToasterService': '', 'AttributeNodeId': 655 });
        ...
        this.Temperature_NgKeyUp = function (AttributeId, ControlId, RefreshcontrolId, IsNc, RefreshAttributeId) {
            try {
                ...
                OneViewConsole.Debug("Temperature_NgKeyUp Start", "pHMeterCalibrationRecordsFacade.Temperature_NgKeyUp");
                ...
                OneViewConsole.Debug("Temperature_NgKeyUp End", "pHMeterCalibrationRecordsFacade.Temperature_NgKeyUp");
            }
            catch (Excep) {
                $scope.DisableSave = false;
                $scope.DisableSaveSubmit = false;
                oOneViewExceptionHandler.Catch(Excep, "pHMeterCalibrationRecordsFacade.Temperature_NgKeyUp", xlatService);
            }
            finally {
                oDataCaptureBO = null;
            }
        ...
        var ValidateActionNC = function (AttributeId, ControlId) {
            try {
                ...
                OneViewConsole.Debug("ValidateActionNC Start", "pHMeterCalibrationRecordsFacade.ValidateActionNC");
                var ActionResponseList = EvaluateActionNCStatus(AttributeId);
                ...
                OneViewConsole.Debug("ValidateActionNC End", "pHMeterCalibrationRecordsFacade.ValidateActionNC");
            }
            catch (Excep) {
                throw Excep;
            }
        ...
        this.CheckActionNCEvent = function (AttributeId, ControlId, RefreshcontrolId) {
            try {
                ...
                OneViewConsole.Debug("CheckActionNCEvent Start", "pHMeterCalibrationRecordsFacade.CheckActionNCEvent");
                ValidateActionNC(AttributeId, ControlId);
                OneViewConsole.Debug("CheckActionNCEvent End", "pHMeterCalibrationRecordsFacade.CheckActionNCEvent");
            }
            catch (Excep) {
                oOneViewExceptionHandler.Catch(Excep, "pHMeterCalibrationRecordsFacade.CheckActionNCEvent", xlatService);
            }
            finally {
                oDataCaptureBO = null;
            }
        ...
        var EvaluateActionNCStatus = function (AttributeId) {
            try {
                OneViewConsole.Debug("ShowNCStatus Start", "pHMeterCalibrationRecordsFacade.EvaluateActionNCStatus");
                var ActionResponseList = _oDataCaptureBO.EvaluateActionNCStatus(AttributeId);
                return ActionResponseList;
                OneViewConsole.Debug("ShowNCStatus End", "pHMeterCalibrationRecordsFacade.EvaluateActionNCStatus");
            }
            catch (Excep) {
                throw Excep;
            }
        ...
        this.ShowNCFormAction = function (ControlId) {
            try {
                OneViewConsole.Debug("ShowNCFormAction Start", "pHMeterCalibrationRecordsFacade.ShowNCFormAction");



                OneViewConsole.Debug("ShowNCFormAction End", "pHMeterCalibrationRecordsFacade.ShowNCFormAction");
            }
            catch (Excep) {
                oOneViewExceptionHandler.Catch(Excep, "pHMeterCalibrationRecordsFacade.ShowNCFormAction", xlatService);
            }
            finally {
        ...
        var LoadAnswerModes = function () {
            try {
                OneViewConsole.Debug("LoadAnswerModes Start", "pHMeterCalibrationRecordsFacade.LoadAnswerModes");
                ...
                OneViewConsole.Debug("LoadAnswerModes End", "pHMeterCalibrationRecordsFacade.LoadAnswerModes");
            }
            catch (Excep) {
                throw Excep;
            }
        ...
        var CreateDynamicElements = function (_DcResultDetailsEntityLst) {
            try {
                ...
                OneViewConsole.Debug("CreateDynamicElements Start", "pHMeterCalibrationRecordsFacade.CreateDynamicElements");
                ...
                OneViewConsole.Debug("CreateDynamicElements End", "pHMeterCalibrationRecordsFacade.CreateDynamicElements");
            }
            catch (Excep) {
        ...
        this.ClearForm = function () {
            try {
                OneViewConsole.Debug("ClearForm Start", "pHMeterCalibrationRecordsFacade.ClearForm");
                ...
                OneViewConsole.Debug("ClearForm End", "pHMeterCalibrationRecordsFacade.ClearForm");
            }
            catch (Excep) {
                oOneViewExceptionHandler.Catch(Excep, "pHMeterCalibrationRecordsFacade.ClearForm", xlatService);
            }
        }

        var IsNCthereOrNot = function (RuleId, isNC) {
            try {
                OneViewConsole.Debug("IsNCthereOrNot Start", "pHMeterCalibrationRecordsFacade.IsNCthereOrNot");
                ...
                OneViewConsole.Debug("IsNCthereOrNot End", "pHMeterCalibrationRecordsFacade.IsNCthereOrNot");
                return ExistStatus;
            }
            catch (Excep) {
                throw Excep;
        ...
        var NormalizeNCEntityListData = function (DCNCMappingListData) {
            try {
                OneViewConsole.Debug("NormalizeNCEntityListData Start", "pHMeterCalibrationRecordsFacade.NormalizeNCEntityListData");
                ...
                OneViewConsole.Debug("NormalizeNCEntityListData End", "pHMeterCalibrationRecordsFacade.NormalizeNCEntityListData");
            }
            catch (Excep) {
                throw Excep;
            }
        ...
        this.PreControlEvents = function (AttributeId, ControlId, $event) {
            try {
                ...
                oOneViewExceptionHandler.Catch(Excep, "pHMeterCalibrationRecordsFacade.PreControlEvents", xlatService);
            }
        }
        ...
        this.ngChange_setDateTime = function (ControlId) {
            try {
                ...
                oOneViewExceptionHandler.Catch(Excep, "pHMeterCalibrationRecordsFacade.ngChange_setDateTime", xlatService);
            }
        }
        ...
        this.NCClick = function ($compile) {
            ...
            try {
                ...
                oOneViewExceptionHandler.Catch(Excep, "pHMeterCalibrationRecordsFacade.NgKeyUp", xlatService);
            }
            finally {
            }
        }
        ...
        this.NCTabClick = function ($compile) {
            ...
            try {
                ...
                oOneViewExceptionHandler.Catch(Excep, "pHMeterCalibrationRecordsFacade.AppendNCHtml", xlatService);
            }
            finally {
            }
        }
        ...
        this.ObservationTabClick = function ($compile) {
            ...
            try {
                ...
                oOneViewExceptionHandler.Catch(Excep, "pHMeterCalibrationRecordsFacade.AppendObservationHtml", xlatService);
            }
            finally {
            }
        }
        ...
        this.CustomNCClick = function () {
            ...
            try {
                ...
                oOneViewExceptionHandler.Catch(Excep, "pHMeterCalibrationRecordsFacade.CustomNCClick", xlatService);
            }
            finally {
            }
        }
        ...
        this.ProbeTesting = function () {
            try {
                ...
                oOneViewExceptionHandler.Catch(Excep, "pHMeterCalibrationRecordsFacade.ProbeTesting", xlatService);
            }
        }
        ...
        this.ClearReasons = function () {
            try {
                ...
                oOneViewExceptionHandler.Catch(Excep, "pHMeterCalibrationRecordsFacade.ClearReasons", xlatService);
            }
        }
        ...
        this.ClearComments = function () {
            try {
                ...
                oOneViewExceptionHandler.Catch(Excep, "pHMeterCalibrationRecordsFacade.ClearComments", xlatService);
            }
        }
        ...
        this.ngChange_SetObservedvalueDifference = function (ControlId, CorrectionControlId, UnitofReferenceControlId, DifferenceValue) {
            try {                
                ...
                oOneViewExceptionHandler.Catch(Excep, "pHMeterCalibrationRecordsFacade.ngChange_SetObservedvalueDifference", xlatService);
            }
        }
}
