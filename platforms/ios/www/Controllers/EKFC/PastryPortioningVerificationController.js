...
MyApp.controller('PastryPortioningVerificationController',
    function ($scope, $document, xlatService, $timeout, $location, $templateCache, snapRemote, $compile) {
        ...
        //   xlatService.setCurrentPage('PastryPortioningVerification');
    ...
    var oPastryPortioningVerificationFacade = new PastryPortioningVerificationFacade({ 'scope': $scope, 'document': $document, 'location': $location, 'xlatService': xlatService, 'toaster': '', 'SpinService': '', '$timeout': $timeout, 'compile': $compile });

    oPastryPortioningVerificationFacade.Init();
    oPastryPortioningVerificationFacade.PageLoad();
    ...
    $scope.ngChange_setIsManualFlag = function (ControlId) {
        oPastryPortioningVerificationFacade.ngChange_setIsManualFlag(ControlId);
    }
    ...
    $scope.ActionSignature = function () {
        oPastryPortioningVerificationFacade.ActionSignature();
    }
    ...
    $scope.Signature = function () {
        oPastryPortioningVerificationFacade.Signature();
    }

    $scope.SaveNCAction = function () {
        oPastryPortioningVerificationFacade.SetNCFormAction();
    }

    $scope.SetHygAvgrageReading = function () {
        oPastryPortioningVerificationFacade.SetHygAvgrageReading();
    }

    $scope.GetProbeStatus = function () {
        oPastryPortioningVerificationFacade.GetProbeStatus();
    };

    $scope.AddRecords = function () {
        oPastryPortioningVerificationFacade.SaveDCRecords();
    };
    
    $scope.SetSelectedTextBoxColor = function (ControlId) {
        oPastryPortioningVerificationFacade.SetSelectedTextBoxColor(ControlId);
    };
    ...
    $scope.SetAutoTemperatureListener = function (EventArg, TimeModelId) {
        oPastryPortioningVerificationFacade.SetAutoTemperatureListener(EventArg, TimeModelId);
    };
    ...
    ////    oPastryPortioningVerificationFacade.Temperature_NgKeyUp(AttributeId, ControlId, RefreshcontrolId, IsNc);
        ////}
    ...
    $scope.Temperature_NgKeyUp = function (AttributeId, ControlId, RefreshcontrolId, IsNc) {
        ...
        lastTimeOutId = $timeout(function () { oPastryPortioningVerificationFacade.Temperature_NgKeyUp(AttributeId, ControlId, RefreshcontrolId, IsNc); }, Timeout);
    }
    ...
    $scope.ClearForm = function () {
        oPastryPortioningVerificationFacade.ClearForm();
    }
    $scope.$on('$destroy', function () {
        ...
        scope = null;
       // ionicBackdrop = null;
        oPastryPortioningVerificationFacade = null;
        $scope = null;
    });

    $scope.SubmitRecords = function () {
        oPastryPortioningVerificationFacade.SaveDCRecords(true);
    }

    $scope.PreControlEvents = function (AttributeId, ControlId, $event) {
        oPastryPortioningVerificationFacade.PreControlEvents(AttributeId, ControlId, $event);
    }
    $scope.PostControlEvents = function (AttributeId, ControlId) {
        oPastryPortioningVerificationFacade.PostControlEvents(AttributeId, ControlId);
    }
    $scope.ngChange_setDateTime = function (ControlId) {
        oPastryPortioningVerificationFacade.ngChange_setDateTime(ControlId);
    }

    $scope.CustomNCClick = function () {
        oPastryPortioningVerificationFacade.CustomNCClick();
    }

    $scope.NCClick = function () {
        oPastryPortioningVerificationFacade.NCClick($compile);
    }

    $scope.ObservationTabClick = function () {
        oPastryPortioningVerificationFacade.ObservationTabClick($compile);
    }

    $scope.NCTabClick = function () {
        oPastryPortioningVerificationFacade.NCTabClick($compile);
    }

    $scope.CloseRightPanel = function () {
        oPastryPortioningVerificationFacade.CloseRightPanel();
    }

    $scope.ClearReasons = function () {
        oPastryPortioningVerificationFacade.ClearReasons();
    }

    $scope.ClearComments = function () {
        oPastryPortioningVerificationFacade.ClearComments();
    }

    $scope.ProbeTesting = function () {
        oPastryPortioningVerificationFacade.ProbeTesting();
    };
...
function PastryPortioningVerificationFacade(parm) {

    try {
        OneViewConsole.Debug("PastryPortioningVerificationFacade Start", "Facade.PastryPortioningVerificationFacade");
       ...
       // var SpinService = parm.SpinService;
        ...
        OneViewConsole.Debug("PastryPortioningVerificationFacade End", "Facade.PastryPortioningVerificationFacade");
    }
    catch (Excep) {
        oOneViewExceptionHandler.Catch(Excep, "Facade.PastryPortioningVerificationFacade", xlatService);
    }

        this.Init = function () {
            try {
                OneViewConsole.Debug("Init Start", "PastryPortioningVerificationFacade.Init");
                ...
                OneViewConsole.Debug("Init End", "PastryPortioningVerificationFacade.Init");
            }

            catch (Excep) {
                oOneViewExceptionHandler.Catch(Excep, "PastryPortioningVerificationFacade.Init", xlatService);
            }
        }
        ...
        this.PageLoad = function () {
            try {
                OneViewConsole.Debug("PageLoad Start", "PastryPortioningVerificationFacade.PageLoad");
                ...
                OneViewConsole.Debug("PageLoad End", "PastryPortioningVerificationFacade.PageLoad");
            }

            catch (Excep) {
                oOneViewExceptionHandler.Catch(Excep, "PastryPortioningVerificationFacade.PageLoad", xlatService);
            }
        }
        ...
        var LoadAnswerModes = function () {
            try {
                OneViewConsole.Debug("LoadAnswerModes Start", "PastryPortioningVerificationFacade.LoadAnswerModes");
                ...
                oDayMarker.AnswerModes(TemplateNodes, 407);
                ...
                oCookingShift.AnswerModes(TemplateNodes, 431);

                OneViewConsole.Debug("LoadAnswerModes End", "PastryPortioningVerificationFacade.LoadAnswerModes");
            }
            catch (Excep) {
                throw Excep;
            }
        ...
        this.SetSelectedTextBoxColor = function (ControlId) {
            try {
                OneViewConsole.Debug("SetSelectedTextBoxColor Start", "PastryPortioningVerificationFacade.SetSelectedTextBoxColor");

                SetSelectedTextBoxColor_Private(ControlId);

                OneViewConsole.Debug("SetSelectedTextBoxColor End", "PastryPortioningVerificationFacade.SetSelectedTextBoxColor");
            }
            catch (Excep) {
                oOneViewExceptionHandler.Catch(Excep, "PastryPortioningVerificationFacade.SetSelectedTextBoxColor", xlatService);
            }
        }

        var SetSelectedTextBoxColor_Private = function (ControlId) {
            try {
                OneViewConsole.Debug("SetSelectedTextBoxColor_Private Start", "PastryPortioningVerificationFacade.SetSelectedTextBoxColor_Private");
                ...
                OneViewConsole.Debug("SetSelectedTextBoxColor_Private End", "PastryPortioningVerificationFacade.SetSelectedTextBoxColor_Private");
            }
            catch (Excep) {
                throw Excep;
            }
        ...
        var BindNc = function (NcStatus, objRule, AttributeId, ControlId) {
            try {
                OneViewConsole.Debug("BindNc Start", "PastryPortioningVerificationFacade.BindNc");
                ...
                OneViewConsole.Debug("BindNc End", "PastryPortioningVerificationFacade.BindNc");
            }
            catch (Excep) {
                throw Excep;
            }
        ...
        this.GetProbeStatus = function () {
            try {
                OneViewConsole.Debug("GetProbeStatus Start", "PastryPortioningVerificationFacade.GetProbeStatus");
                               
                _oSettingsBO.ProbeStatus('', xlatService);

                OneViewConsole.Debug("GetProbeStatus End", "PastryPortioningVerificationFacade.GetProbeStatus");

            }
            catch (Excep) {
                oOneViewExceptionHandler.Catch(Excep, "PastryPortioningVerificationFacade.GetProbeStatus", xlatService);
            }
        }

        this.SetAutoTemperatureListener = function (EventArg, TimeControlId) {
            try {
                OneViewConsole.Debug("SetAutoTemperatureListener Start", "PastryPortioningVerificationFacade.SetAutoTemperatureListener");
                ...
                OneViewConsole.Debug("SetAutoTemperatureListener End", "PastryPortioningVerificationFacade.SetAutoTemperatureListener");
            }
            catch (Excep) {
                oOneViewExceptionHandler.Catch(Excep, "PastryPortioningVerificationFacade.SetAutoTemperatureListener", xlatService);
            }
            finally {
                modelName = null;
            }
        ...
        var BindNCLoadDatas = function () {
            try {
                OneViewConsole.Debug("BindNCLoadDatas Start", "PastryPortioningVerificationFacade.BindNCLoadDatas");
                ...
                OneViewConsole.Debug("BindNCLoadDatas End", "PastryPortioningVerificationFacade.BindNCLoadDatas");
            }
            catch (Excep) {
                throw Excep;
            }
        ...
        this.SaveDCRecords = function (IsSubmit) {
            oSetDefaultSpinner.Start();
            try {
                OneViewConsole.Debug("SaveDCRecords Start", "PastryPortioningVerificationFacade.SaveDCRecords");
                ...
                OneViewConsole.Debug("SaveDCRecords End", "PastryPortioningVerificationFacade.SaveDCRecords");
            }
            catch (Excep) {
                oOneViewExceptionHandler.Catch(Excep, "PastryPortioningVerificationFacade.SaveDCRecords", xlatService);
            }
            finally {
                Status = null;
            }
        ...
        var LoadddlOLD = function () {
            try {
                OneViewConsole.Debug("Loadddl Start", "PastryPortioningVerificationFacade.Loadddl");

                OneViewAdvAutoCompleteEvent = OneViewAdvAutoCompleteClick;
                AutoCompleteCloseEvent = AutoCompleteCloseClick;

                var oAirlinesddl = new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'AddlAirlineControlId', 'DataSourceModelName': 'Airlines', 'DisplayElementModelName': 'NewDCModel.AddlAirlineControlId', 'DATEntityTypeId': DATEntityType.RCOMaster_Flight, 'xlatService': xlatService, 'ToasterService': '', 'MinCharToSearch': 0, 'AttributeNodeId': 130 });
                ...
                OneViewConsole.Debug("Loadddl End", "PastryPortioningVerificationFacade.Loadddl");
            }
            catch (Excep) {
                throw Excep;
            }
        ...
        var Loadddl = function () {
            try {
                ...
                var oProductddl = new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'MealControlId', 'DataSourceModelName': 'Products', 'DisplayElementModelName': 'NewDCModel.MealControlId', 'DATEntityTypeId': DATEntityType.RCO_WorkOrder, 'xlatService': xlatService, 'ToasterService': '', 'AttributeNodeId': 129 });
                ...
                var oMealTypeddl = new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'MealMealTypeControlId', 'DataSourceModelName': 'MealType', 'DisplayElementModelName': 'NewDCModel.MealMealTypeControlId', 'DATEntityTypeId': DATEntityType.RCOMaster_MealsType, 'xlatService': xlatService, 'ToasterService': '', 'IsDynamicElementCreationEnabled': false, 'MinCharToSearch': 0, 'AttributeNodeId': 559 });
                ...
                var oSectorddl = new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'AddlSectorControlId', 'DataSourceModelName': 'Sectors', 'DisplayElementModelName': 'NewDCModel.AddlSectorControlId', 'DATEntityTypeId': DATEntityType.RCOMaster_Sector, 'xlatService': xlatService, 'ToasterService': '', 'MinCharToSearch': 0, 'AttributeNodeId': 409 });
                ...
                var oFAndBddl = new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'AddlFAndBControlId', 'DataSourceModelName': 'FAndB', 'DisplayElementModelName': 'NewDCModel.AddlFAndBControlId', 'DATEntityTypeId': DATEntityType.RCOMaster_FandBOutLet, 'xlatService': xlatService, 'ToasterService': '', 'MinCharToSearch': 0, 'AttributeNodeId': 410 });
                ...
                var oClassddl = new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'txtClassControlId', 'DataSourceModelName': 'Class', 'DisplayElementModelName': 'NewDCModel.txtClassControlId', 'DATEntityTypeId': DATEntityType.RCOMaster_Class, 'xlatService': xlatService, 'ToasterService': '', 'IsDynamicElementCreationEnabled': false, 'MinCharToSearch': 0, 'AttributeNodeId': 133 });
        ...
        var oFlightSelectedIndexChangedOLD = function (EventArgs) {
            try {
                OneViewConsole.Debug("oFlightSelectedIndexChanged Start", "PastryPortioningVerificationFacade.oFlightSelectedIndexChanged");
                ...
                OneViewConsole.Debug("oFlightSelectedIndexChanged End", "PastryPortioningVerificationFacade.oFlightSelectedIndexChanged");
            }
            catch (Excep) {
                throw Excep;
            }
        ...
        this.Temperature_NgKeyUp = function (AttributeId, ControlId, RefreshcontrolId, IsNc, RefreshAttributeId) {
            try {
                OneViewConsole.Debug("Temperature_NgKeyUp Start", "PastryPortioningVerificationFacade.Temperature_NgKeyUp");
                ...
                OneViewConsole.Debug("Temperature_NgKeyUp End", "PastryPortioningVerificationFacade.Temperature_NgKeyUp");
            }
            catch (Excep) {
                $scope.DisableSave = false;
                $scope.DisableSaveSubmit = false;
                oOneViewExceptionHandler.Catch(Excep, "PastryPortioningVerificationFacade.Temperature_NgKeyUp", xlatService);
            }
            finally {
                oDataCaptureBO = null;
            }
        ...
        var ValidateActionNC = function (AttributeId, ControlId) {
            try {
                ...
                OneViewConsole.Debug("ValidateActionNC Start", "PastryPortioningVerificationFacade.ValidateActionNC");
                var ActionResponseList = EvaluateActionNCStatus(AttributeId);
                ...
                OneViewConsole.Debug("ValidateActionNC End", "PastryPortioningVerificationFacade.ValidateActionNC");
            }
            catch (Excep) {
                throw Excep;
            }
        ...
        this.CheckActionNCEvent = function (AttributeId, ControlId, RefreshcontrolId) {
            try {
                ...
                OneViewConsole.Debug("CheckActionNCEvent Start", "PastryPortioningVerificationFacade.CheckActionNCEvent");
                ValidateActionNC(AttributeId, ControlId);
                OneViewConsole.Debug("CheckActionNCEvent End", "PastryPortioningVerificationFacade.CheckActionNCEvent");
            }
            catch (Excep) {
                oOneViewExceptionHandler.Catch(Excep, "PastryPortioningVerificationFacade.CheckActionNCEvent", xlatService);
            }
            finally {
                oDataCaptureBO = null;
            }
        ...
        var EvaluateActionNCStatus = function (AttributeId) {
            try {
                OneViewConsole.Debug("ShowNCStatus Start", "PastryPortioningVerificationFacade.EvaluateActionNCStatus");

                var ActionResponseList = _oDataCaptureBO.EvaluateActionNCStatus(AttributeId);
                return ActionResponseList;

                OneViewConsole.Debug("ShowNCStatus End", "PastryPortioningVerificationFacade.EvaluateActionNCStatus");
            }
            catch (Excep) {
                throw Excep;
            }
        ...
        this.ShowNCFormActionOLD = function (ControlId) {
            try {
                OneViewConsole.Debug("ShowNCFormAction Start", "PastryPortioningVerificationFacade.ShowNCFormAction");
                ...
                OneViewConsole.Debug("ShowNCFormAction End", "PastryPortioningVerificationFacade.ShowNCFormAction");
            }
            catch (Excep) {
                oOneViewExceptionHandler.Catch(Excep, "PastryPortioningVerificationFacade.ShowNCFormAction", xlatService);
            }
            finally {
                TempOutNCTemplate = null;
                _oNCDcDataCaptureBO = null;
        ...
        var CreateDynamicElements = function (_DcResultDetailsEntityLst) {
            try {
                OneViewConsole.Debug("CreateDynamicElements Start", "PastryPortioningVerificationFacade.CreateDynamicElements");
                    ...
                    for (var i = 0; i < _DcResultDetailsEntityLst.length; i++) {
                        if (_DcResultDetailsEntityLst[i].IsDynamicAnswer == 'true') {
                            ...
                            if (_DcResultDetailsEntityLst[i].AttributeNodeId == 129)//for product
                            {
                                Response = _oDynamicElementBO.AddDynamicOrder(_DcResultDetailsEntityLst[i], ParentNodeId, ParentDbElementType, ParentDbElementId, '', DATEntityType.RCO_WorkOrder, '92672');
                ...
                OneViewConsole.Debug("CreateDynamicElements End", "PastryPortioningVerificationFacade.CreateDynamicElements");
            }
        ...
        this.ClearForm = function () {
            try {
                ...
                oOneViewExceptionHandler.Catch(Excep, "PastryPortioningVerificationFacade.ClearForm", xlatService);
            }
        }
        ...
        this.SetHygAvgrageReading = function () {
            try {
                OneViewConsole.Debug("SetHygAvgrageReading Start", "PastryPortioningVerificationFacade.SetHygAvgrageReading");

                _oDataCaptureBO.SetHygAvgrageReading();

                OneViewConsole.Debug("SetHygAvgrageReading End", "PastryPortioningVerificationFacade.SetHygAvgrageReading");
            }
            catch (Excep) {
                oOneViewExceptionHandler.Catch(Excep, "PastryPortioningVerificationFacade.ShowNCButton", xlatService);
            }
        }
        ...
        this.SetNCFormAction = function () {
            try {
                OneViewConsole.Debug("SetNCFormAction Start", "PastryPortioningVerificationFacade.SetNCFormAction");
                ...
                OneViewConsole.Debug("SetNCFormAction End", "PastryPortioningVerificationFacade.SetNCFormAction");
            }
            catch (Excep) {
                oOneViewExceptionHandler.Catch(Excep, "PastryPortioningVerificationFacade.SetNCFormAction", xlatService);
            }
            finally {
                Status = null;
            }
        ...
        this.SaveSignature = function (ControlId, signaturePad, IsResolution) {
            try {
                OneViewConsole.Debug("SaveSignature Start", "PastryPortioningVerificationFacade.SaveSignature");
                ...
                OneViewConsole.Debug("SaveSignature End", "PastryPortioningVerificationFacade.SaveSignature");
            }
            catch (Excep) {
                oOneViewExceptionHandler.Catch(Excep, "PastryPortioningVerificationFacade.SaveSignature", xlatService);
            }
            finally {
                oDateTime = null;
        ...
        this.ClearSignature = function (ControlId) {
            try {
                OneViewConsole.Debug("ClearSignature Start", "PastryPortioningVerificationFacade.ClearSignature");

                $scope[ControlId + '_IsModified'] = false;
                $scope[ControlId + '_SignaturePad'] = '';
               
                OneViewConsole.Debug("ClearSignature End", "PastryPortioningVerificationFacade.ClearSignature");
            }
            catch (Excep) {
                oOneViewExceptionHandler.Catch(Excep, "PastryPortioningVerificationFacade.ClearSignature", xlatService);
            }
        }

        this.Signature = function () {
            try {
                OneViewConsole.Debug("Signature Start", "PastryPortioningVerificationFacade.Signature");
                ...
                OneViewConsole.Debug("Signature End", "PastryPortioningVerificationFacade.Signature");
            }
            catch (Excep) {
                oOneViewExceptionHandler.Catch(Excep, "PastryPortioningVerificationFacade.Signature", xlatService);
            }
        }

        var SignatureContent = function () {
            try {
                OneViewConsole.Debug("SignatureContent Start", "PastryPortioningVerificationFacade.SignatureContent");
                ...
                OneViewConsole.Debug("SignatureContent End", "PastryPortioningVerificationFacade.SignatureContent");
            }
            catch (Excep) {
                throw Excep;
            }
        ...
        this.ShowNCButton = function () {
            try {
                OneViewConsole.Debug("ShowNCButton Start", "PastryPortioningVerificationFacade.ShowNCButton");
                ...
                OneViewConsole.Debug("ShowNCButton End", "PastryPortioningVerificationFacade.ShowNCButton");
            }
            catch (Excep) {
                oOneViewExceptionHandler.Catch(Excep, "PastryPortioningVerificationFacade.ShowNCButton", xlatService);
            }
        ...
        this.ActionSignature = function () {
            try {
                OneViewConsole.Debug("ActionSignature Start", "PastryPortioningVerificationFacade.ActionSignature");
                ...
                OneViewConsole.Debug("ActionSignature End", "PastryPortioningVerificationFacade.ActionSignature");
            }
            catch (Excep) {
                oOneViewExceptionHandler.Catch(Excep, "PastryPortioningVerificationFacade.ActionSignature", xlatService);
            }
        }
        ...
        this.PreControlEvents = function (AttributeId, ControlId, $event) {
            try {
                ...
                oOneViewExceptionHandler.Catch(Excep, "PastryPortioningVerificationFacade.PreControlEvents", xlatService);
            }
        }
        ...
        this.PostControlEvents = function (AttributeId, ControlId) {
            try {
                ...
                oOneViewExceptionHandler.Catch(Excep, "PastryPortioningVerificationFacade.PostControlEvents", xlatService);
            }
        }
        ...
        this.ngChange_setDateTime = function (ControlId) {
            try {
                ...
                oOneViewExceptionHandler.Catch(Excep, "PastryPortioningVerificationFacade.ngChange_setDateTime", xlatService);
            }
        }
        ...
        this.NCClick = function ($compile) {
            ...
            try {
                ...
                oOneViewExceptionHandler.Catch(Excep, "PastryPortioningVerificationFacade.NgKeyUp", xlatService);
            }
            finally {
            }
        }
        ...
        this.NCTabClick = function ($compile) {
            ...
            try {
                ...
                oOneViewExceptionHandler.Catch(Excep, "PastryPortioningVerificationFacade.AppendNCHtml", xlatService);
            }
            finally {
            }
        }
        ...
        this.ObservationTabClick = function ($compile) {
            ...
            try {
                ...
                oOneViewExceptionHandler.Catch(Excep, "PastryPortioningVerificationFacade.AppendObservationHtml", xlatService);
            }
            finally {
            }
        }
        ...
        this.CustomNCClick = function () {
            ...
            try {
                ...
                oOneViewExceptionHandler.Catch(Excep, "PastryPortioningVerificationFacade.CustomNCClick", xlatService);
            }
            finally {
            }
        }
        ...
        this.ClearReasons = function () {
            try {
                ...
                oOneViewExceptionHandler.Catch(Excep, "PastryPortioningVerificationFacade.ClearReasons", xlatService);
            }
        }
        ...
        this.ClearComments = function () {
            try {
                ...
                oOneViewExceptionHandler.Catch(Excep, "PastryPortioningVerificationFacade.ClearComments", xlatService);
            }
        }
        ...
        this.ProbeTesting = function () {
            try {
                ...
                oOneViewExceptionHandler.Catch(Excep, "PastryPortioningVerificationFacade.ProbeTesting", xlatService);
            }
        }
