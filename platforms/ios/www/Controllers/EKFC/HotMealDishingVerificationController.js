...
MyApp.controller('HotMealDishingVerificationController',
    function ($scope, $document, xlatService, $timeout, $location, $templateCache, snapRemote, $compile) {
        ...
        // xlatService.setCurrentPage('HotMealDishingVerification');
    ...
    var oHotMealDishingVerificationFacade = new HotMealDishingVerificationFacade({ 'scope': $scope, 'document': $document, 'location': $location, 'xlatService': xlatService, 'toaster': '', 'SpinService': '', '$timeout': $timeout, 'compile': $compile });

    oHotMealDishingVerificationFacade.Init();
    oHotMealDishingVerificationFacade.PageLoad();
    ...
    $scope.Signature = function () {
        oHotMealDishingVerificationFacade.Signature();
    }

    $scope.SaveNCAction = function () {
        oHotMealDishingVerificationFacade.SetNCFormAction();
    }

    $scope.ActionSignature = function () {
        oHotMealDishingVerificationFacade.ActionSignature();
    }

    $scope.SetHygAvgrageReading = function () {
        oHotMealDishingVerificationFacade.SetHygAvgrageReading();
    }

    $scope.GetProbeStatus = function () {
        oHotMealDishingVerificationFacade.GetProbeStatus();
    };

    $scope.AddRecords = function () {
        oHotMealDishingVerificationFacade.SaveDCRecords();
    };
    
    $scope.SetSelectedTextBoxColor = function (ControlId) {
        oHotMealDishingVerificationFacade.SetSelectedTextBoxColor(ControlId);
    };
    ...
    $scope.SetAutoTemperatureListener = function (EventArg, TimeModelId) {
        oHotMealDishingVerificationFacade.SetAutoTemperatureListener(EventArg, TimeModelId);
    };
    ...
    $scope.Temperature_NgKeyUp = function (AttributeId, ControlId, RefreshcontrolId, IsNc, RefreshAttributeId) {
        ...
        lastTimeOutId = $timeout(function () { oHotMealDishingVerificationFacade.Temperature_NgKeyUp(AttributeId, ControlId, RefreshcontrolId, IsNc, RefreshAttributeId); }, Timeout);
    }
    ...
    $scope.ClearForm = function () {
        oHotMealDishingVerificationFacade.ClearForm();
    }
    $scope.$on('$destroy', function () {
        scope = null;
       // ionicBackdrop = null;
        oHotMealDishingVerificationFacade = null;
        $scope = null;
    ...
    $scope.CustomNCClick = function () {
        oHotMealDishingVerificationFacade.CustomNCClick();
    }

    $scope.NCClick = function () {
        oHotMealDishingVerificationFacade.NCClick($compile);
    }

    $scope.ObservationTabClick = function () {
        oHotMealDishingVerificationFacade.ObservationTabClick($compile);
    }

    $scope.NCTabClick = function () {
        oHotMealDishingVerificationFacade.NCTabClick($compile);
    }

    $scope.CloseRightPanel = function () {
        oHotMealDishingVerificationFacade.CloseRightPanel();
    }

    $scope.PreControlEvents = function (AttributeId, ControlId, $event) {
        oHotMealDishingVerificationFacade.PreControlEvents(AttributeId, ControlId, $event);
    }
    $scope.PostControlEvents = function (AttributeId, ControlId) {

        oHotMealDishingVerificationFacade.PostControlEvents(AttributeId, ControlId);
    }
    $scope.ngChange_setDateTime = function (ControlId) {
        oHotMealDishingVerificationFacade.ngChange_setDateTime(ControlId);
    }

    $scope.SubmitRecords = function () {
        oHotMealDishingVerificationFacade.SaveDCRecords(true);
    }

    $scope.ClearReasons = function () {
        oHotMealDishingVerificationFacade.ClearReasons();
    }

    $scope.ClearComments = function () {
        oHotMealDishingVerificationFacade.ClearComments();
    }

    $scope.ProbeTesting = function () {
        oHotMealDishingVerificationFacade.ProbeTesting();
    };
...
function HotMealDishingVerificationFacade(parm) {

    try {
        OneViewConsole.Debug("HotMealDishingVerificationFacade Start", "Facade.HotMealDishingVerificationFacade");
        ...
        OneViewConsole.Debug("HotMealDishingVerificationFacade End", "Facade.HotMealDishingVerificationFacade");
    }
    catch (Excep) {
        oOneViewExceptionHandler.Catch(Excep, "Facade.HotMealDishingVerificationFacade", xlatService);
    }

    this.Init = function () {
        try {
            OneViewConsole.Debug("Init Start", "HotMealDishingVerificationFacade.Init");
            ...
            OneViewConsole.Debug("Init End", "HotMealDishingVerificationFacade.Init");
        }

        catch (Excep) {
            oOneViewExceptionHandler.Catch(Excep, "HotMealDishingVerificationFacade.Init", xlatService);
        }
    }
    ...
    this.PageLoad = function () {
        try {
            OneViewConsole.Debug("PageLoad Start", "HotMealDishingVerificationFacade.PageLoad");
            ...
            OneViewConsole.Debug("PageLoad End", "HotMealDishingVerificationFacade.PageLoad");
        }

        catch (Excep) {
            oOneViewExceptionHandler.Catch(Excep, "HotMealDishingVerificationFacade.PageLoad", xlatService);
        }
    }

    this.SetSelectedTextBoxColor = function (ControlId) {
        try {
            OneViewConsole.Debug("SetSelectedTextBoxColor Start", "HotMealDishingVerificationFacade.SetSelectedTextBoxColor");

            SetSelectedTextBoxColor_Private(ControlId);

            OneViewConsole.Debug("SetSelectedTextBoxColor End", "HotMealDishingVerificationFacade.SetSelectedTextBoxColor");
        }
        catch (Excep) {
            oOneViewExceptionHandler.Catch(Excep, "HotMealDishingVerificationFacade.SetSelectedTextBoxColor", xlatService);
        }
    }

    var SetSelectedTextBoxColor_Private = function (ControlId) {
        try {
            OneViewConsole.Debug("SetSelectedTextBoxColor_Private Start", "HotMealDishingVerificationFacade.SetSelectedTextBoxColor_Private");
            ...
            OneViewConsole.Debug("SetSelectedTextBoxColor_Private End", "HotMealDishingVerificationFacade.SetSelectedTextBoxColor_Private");
        }
        catch (Excep) {
            throw Excep;
        }
    ...
    var BindNc = function (NcStatus, objRule, AttributeId, ControlId) {
        try {
            OneViewConsole.Debug("BindNc Start", "HotMealDishingVerificationFacade.BindNc");
            ...
            OneViewConsole.Debug("BindNc End", "HotMealDishingVerificationFacade.BindNc");
        }
        catch (Excep) {
            throw Excep;
        }
    ...
    this.GetProbeStatus = function () {
        try {
            OneViewConsole.Debug("GetProbeStatus Start", "HotMealDishingVerificationFacade.GetProbeStatus");

            _oSettingsBO.ProbeStatus('', xlatService);

            OneViewConsole.Debug("GetProbeStatus End", "HotMealDishingVerificationFacade.GetProbeStatus");

        }
        catch (Excep) {
            oOneViewExceptionHandler.Catch(Excep, "HotMealDishingVerificationFacade.GetProbeStatus", xlatService);
        }
    }

    this.SetAutoTemperatureListener = function (EventArg, TimeControlId) {
        try {
            OneViewConsole.Debug("SetAutoTemperatureListener Start", "HotMealDishingVerificationFacade.SetAutoTemperatureListener");
            ...
            OneViewConsole.Debug("SetAutoTemperatureListener End", "HotMealDishingVerificationFacade.SetAutoTemperatureListener");
        }
        catch (Excep) {
            oOneViewExceptionHandler.Catch(Excep, "HotMealDishingVerificationFacade.SetAutoTemperatureListener", xlatService);
        }
        finally {
            modelName = null;
        }
    ...
    this.SaveDCRecords = function (IsSubmit) {
        oSetDefaultSpinner.Start();
        try {
            OneViewConsole.Debug("SaveDCRecords Start", "HotMealDishingVerificationFacade.SaveDCRecords");
            ...
            OneViewConsole.Debug("SaveDCRecords End", "HotMealDishingVerificationFacade.SaveDCRecords");
        }
        catch (Excep) {
            oOneViewExceptionHandler.Catch(Excep, "HotMealDishingVerificationFacade.SaveDCRecords", xlatService);
        }
        finally {
            Status = null;
        }
    ...
    var Loadddl = function () {
        try {
            ...
            var oAirlinesddl = new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'AddlAirlineControlId', 'DataSourceModelName': 'Airlines', 'DisplayElementModelName': 'NewDCModel.AddlAirlineControlId', 'DATEntityTypeId': DATEntityType.RCOMaster_Flight, 'xlatService': xlatService, 'ToasterService': '', 'MinCharToSearch': 0, 'AttributeNodeId': 142 });
            ...
            var oProductddl = new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'MealControlId', 'DataSourceModelName': 'Products', 'DisplayElementModelName': 'NewDCModel.MealControlId', 'DATEntityTypeId': DATEntityType.RCO_WorkOrder, 'xlatService': xlatService, 'ToasterService': '', 'AttributeNodeId': 141 });
            oProductddl.SetDataSourceWithWorkOrder(DcPlaceId, DATEntityType.RCO_WorkOrder, _TableNamesEnum.OrganizationAssetsNode, SectionCodesConfig.Hotmeal);

            var oMealTypeddl = new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'MealMealTypeControlId', 'DataSourceModelName': 'MealType', 'DisplayElementModelName': 'NewDCModel.MealMealTypeControlId', 'DATEntityTypeId': DATEntityType.RCOMaster_MealsType, 'xlatService': xlatService, 'ToasterService': '', 'MinCharToSearch': 0, 'IsDynamicElementCreationEnabled': false, 'AttributeNodeId': 560 });
            ...
            var oSectorddl = new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'AddlSectorControlId', 'DataSourceModelName': 'Sectors', 'DisplayElementModelName': 'NewDCModel.AddlSectorControlId', 'DATEntityTypeId': DATEntityType.RCOMaster_Sector, 'xlatService': xlatService, 'ToasterService': '', 'MinCharToSearch': 0, 'AttributeNodeId': 376 });
            ...
            var oFAndBddl = new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'AddlFAndBControlId', 'DataSourceModelName': 'FAndB', 'DisplayElementModelName': 'NewDCModel.AddlFAndBControlId', 'DATEntityTypeId': DATEntityType.RCOMaster_FandBOutLet, 'xlatService': xlatService, 'ToasterService': '', 'MinCharToSearch': 0, 'AttributeNodeId': 377 });
            ...
            var oClassddl = new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'txtClassControlId', 'DataSourceModelName': 'Class', 'DisplayElementModelName': 'NewDCModel.txtClassControlId', 'DATEntityTypeId': DATEntityType.RCOMaster_Class, 'xlatService': xlatService, 'ToasterService': '', 'IsDynamicElementCreationEnabled': false, 'MinCharToSearch': 0, 'AttributeNodeId': 145 });
            ...
            var oProcessddl = new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'txtProcessControlId', 'DataSourceModelName': 'Process', 'DisplayElementModelName': 'NewDCModel.txtProcessControlId', 'DATEntityTypeId': DATEntityType.RCOMaster_Process, 'xlatService': xlatService, 'ToasterService': '', 'IsDynamicElementCreationEnabled': false, 'MinCharToSearch': 0, 'AttributeNodeId': 428 });
            ...
            OneViewConsole.Debug("Loadddl End", "HotMealDishingVerificationFacade.Loadddl");
        }
        catch (Excep) {
            throw Excep;
        }
    ...
    var oFlightSelectedIndexChangedOLD = function (EventArgs) {
        try {
            OneViewConsole.Debug("oFlightSelectedIndexChanged Start", "HotMealDishingVerificationFacade.oFlightSelectedIndexChanged");
            ...
            OneViewConsole.Debug("oFlightSelectedIndexChanged End", "HotMealDishingVerificationFacade.oFlightSelectedIndexChanged");
        }
        catch (Excep) {
            throw Excep;
        }
    ...
    this.Temperature_NgKeyUp = function (AttributeId, ControlId, RefreshcontrolId, IsNc, RefreshAttributeId) {
        try {
            OneViewConsole.Debug("Temperature_NgKeyUp Start", "HotMealDishingVerificationFacade.Temperature_NgKeyUp");
            ...
            OneViewConsole.Debug("Temperature_NgKeyUp End", "HotMealDishingVerificationFacade.Temperature_NgKeyUp");
        }
        catch (Excep) {
            $scope.DisableSave = false;
            $scope.DisableSaveSubmit = false;
            oOneViewExceptionHandler.Catch(Excep, "HotMealDishingVerificationFacade.Temperature_NgKeyUp", xlatService);
        }
        finally {
            oDataCaptureBO = null;
        }
    ...
    var ValidateActionNC = function (AttributeId, ControlId) {
        try {
            ...
            OneViewConsole.Debug("ValidateActionNC Start", "HotMealDishingVerificationFacade.ValidateActionNC");
            var ActionResponseList = EvaluateActionNCStatus(AttributeId);
            ...
            OneViewConsole.Debug("ValidateActionNC End", "HotMealDishingVerificationFacade.ValidateActionNC");
        }
        catch (Excep) {
            throw Excep;
        }
    ...
    this.CheckActionNCEvent = function (AttributeId, ControlId, RefreshcontrolId) {
        try {
            ...
            OneViewConsole.Debug("CheckActionNCEvent Start", "HotMealDishingVerificationFacade.CheckActionNCEvent");
            ValidateActionNC(AttributeId, ControlId);
            OneViewConsole.Debug("CheckActionNCEvent End", "HotMealDishingVerificationFacade.CheckActionNCEvent");
        }
        catch (Excep) {
            oOneViewExceptionHandler.Catch(Excep, "HotMealDishingVerificationFacade.CheckActionNCEvent", xlatService);
        }
        finally {
            oDataCaptureBO = null;
        }
    ...
    var EvaluateActionNCStatus = function (AttributeId) {
        try {
            OneViewConsole.Debug("ShowNCStatus Start", "HotMealDishingVerificationFacade.EvaluateActionNCStatus");

            var ActionResponseList = _oDataCaptureBO.EvaluateActionNCStatus(AttributeId);
            return ActionResponseList;

            OneViewConsole.Debug("ShowNCStatus End", "HotMealDishingVerificationFacade.EvaluateActionNCStatus");
        }
        catch (Excep) {
            throw Excep;
        }
    ...
    this.ShowNCFormAction = function (ControlId) {
        try {
            OneViewConsole.Debug("ShowNCFormAction Start", "HotMealDishingVerificationFacade.ShowNCFormAction");           
           ...
           //Save case
            ...
            OneViewConsole.Debug("ShowNCFormAction End", "HotMealDishingVerificationFacade.ShowNCFormAction");
        }
        catch (Excep) {
            oOneViewExceptionHandler.Catch(Excep, "HotMealDishingVerificationFacade.ShowNCFormAction", xlatService);
        }
        finally {
    ...
    var LoadAnswerModes = function () {
        try {
            ...
            oDayMarker.AnswerModes(TemplateNodes, 322);
            ...
            oCookingShift.AnswerModes(TemplateNodes, 432);
    ...
    var CreateDynamicElements = function (_DcResultDetailsEntityLst) {
        try {
            OneViewConsole.Debug("CreateDynamicElements Start", "HotMealDishingVerificationFacade.CreateDynamicElements");
            ...
            for (var i = 0; i < _DcResultDetailsEntityLst.length; i++) {
                if (_DcResultDetailsEntityLst[i].IsDynamicAnswer == 'true') {
                    ...
                    if (_DcResultDetailsEntityLst[i].AttributeNodeId == 141)//for product
                    {
                        Response = _oDynamicElementBO.AddDynamicOrder(_DcResultDetailsEntityLst[i], ParentNodeId, ParentDbElementType, ParentDbElementId, LabelId, DATEntityType.RCO_WorkOrder, '92907');
            ...
            OneViewConsole.Debug("CreateDynamicElements End", "HotMealDishingVerificationFacade.CreateDynamicElements");
        }
    ...
    this.ClearForm = function () {
        try {
            ...
            oOneViewExceptionHandler.Catch(Excep, "HotMealDishingVerificationFacade.ClearForm", xlatService);
        }
    }
    ...
    this.NCClick = function ($compile) {
        ...
        try {
            ...
            oOneViewExceptionHandler.Catch(Excep, "HotMealDishingVerificationFacade.NgKeyUp", xlatService);
        }
        finally {
        }
    }
    ...
    this.NCTabClick = function ($compile) {
        ...
        try {
            ...
            oOneViewExceptionHandler.Catch(Excep, "HotMealDishingVerificationFacade.AppendNCHtml", xlatService);
        }
        finally {
        }
    }
    ...
    this.ObservationTabClick = function ($compile) {
        ...
        try {
            ...
            oOneViewExceptionHandler.Catch(Excep, "HotMealDishingVerificationFacade.AppendObservationHtml", xlatService);
        }
        finally {
        }
    }
    ...
    this.CustomNCClick = function () {
        ...
        try {
            ...
            oOneViewExceptionHandler.Catch(Excep, "HotMealDishingVerificationFacade.CustomNCClick", xlatService);
        }
        finally {
        }
    }
    ...
    this.PreControlEvents = function (AttributeId, ControlId, $event) {
        try {
            ...
            oOneViewExceptionHandler.Catch(Excep, "HotMealDishingVerificationFacade.PreControlEvents", xlatService);
        }
    }
    ...
    this.PostControlEvents = function (AttributeId, ControlId) {
        try {
            ...
            oOneViewExceptionHandler.Catch(Excep, "HotMealDishingVerificationFacade.PostControlEvents", xlatService);
        }
    }
    ...
    this.ngChange_setDateTime = function (ControlId) {
        try {
            ...
            oOneViewExceptionHandler.Catch(Excep, "HotMealDishingVerificationFacade.ngChange_setDateTime", xlatService);
        }
    }
    ...
    this.ClearReasons = function () {
        try {
            ...
            oOneViewExceptionHandler.Catch(Excep, "HotMealDishingVerificationFacade.ClearReasons", xlatService);
        }
    }
    ...
    this.ClearComments = function () {
        try {
            ...
            oOneViewExceptionHandler.Catch(Excep, "HotMealDishingVerificationFacade.ClearComments", xlatService);
        }
    }
