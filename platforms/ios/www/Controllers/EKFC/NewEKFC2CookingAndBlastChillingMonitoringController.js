...
MyApp.controller('NewCookingAndBlastChillingMonitoringControllerEKFC2',
    function ($scope, $document, xlatService, $timeout, $location, $templateCache, snapRemote, $compile) {
      ...
      //  oSetDefaultSpinner.Start();
        ...
        var oCookingAndBlastChillingMonitoringFacade =
            new NewCookingAndBlastChillingMonitoringEKFC2Facade({ 'scope': $scope, 'document': $document, 'location': $location, 'xlatService': xlatService, 'toaster': '', 'SpinService': '', '$timeout': $timeout, 'compile': $compile });
...
function NewCookingAndBlastChillingMonitoringEKFC2Facade(parm) {
      ...
      //  }
        ...
        var Loadddl_OneViewAdv = function () {
            try {
                ...
                var oProductddl = new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'AddlProductControlId', 'DataSourceModelName': 'Products', 'DisplayElementModelName': 'NewDCModel.AddlProductControlId', 'DATEntityTypeId': DATEntityType.RCO_WorkOrder, 'xlatService': xlatService, 'ToasterService': '', 'AttributeNodeId': 8315 });
            ...
            try {
                ...
                for (var i = 0; i < _DcResultDetailsEntityLst.length; i++) {
                    if (_DcResultDetailsEntityLst[i].IsDynamicAnswer == 'true') {
                        ...
                        if (_DcResultDetailsEntityLst[i].AttributeNodeId == 8315)//for product
                        {
