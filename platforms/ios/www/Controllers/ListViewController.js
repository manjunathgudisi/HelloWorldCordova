        ...
        var LVDcReStartDate = "";
        var LVDcStopDate = "";
        var LVGlobalAttrActionNCDetails = null;

        var LVExcludedAttriuteList = null;
        var LVExcludeIncludeAttributeInEditForFirstTime = false;
        var LVIsNonMandatoryActionNCRuleViolated = false;
        ...
        MyApp.controller('ListViewController', function ($scope, xlatService, $location, snapRemote, $compile, $rootScope, $timeout) {
            ...
            $scope.Back = function () {
                oLVPageComponent.BackButtonClick();
            }
            ...
            $scope.AddCustomAction = function (CustomAction, RuleId, IsNC, IsObservation, IsManualRule, TemplateNodeIds, IsActionNotMandatory) {
                oLVPageComponent.AddCustomAction(CustomAction, RuleId, IsNC, IsObservation, IsManualRule, TemplateNodeIds,IsActionNotMandatory);
            }
            ...
            snapRemote.getSnapper().then(function (snapper) {
                snapper.on('close', function () {
                    oLVPageComponent.SnapRemoteClose(true);
                });
            });

            $scope.Submit = function () {
                oLVPageComponent.Submit();
            }

            $scope.PopUpExcludedAttributeDetailshow = function () {
                try {
                    var DcComments = "";
                    var _oDcComments = document.getElementById('DcComments');
                    if (_oDcComments != null) {
                    ...
                    $rootScope.PopUpExcludedAttributeDetails = true;
                    var _LVExcludeIncludeAttributeComponent = new LVExcludeIncludeAttributeComponent($scope,xlatService, $rootScope);
                    _LVExcludeIncludeAttributeComponent.GenerateExculdedAttributeHtml();
            ...
            $rootScope.PopExcludedAttributeCommentBoxHide = function () {
                $rootScope.PopUpExcludedAttributeDetails = false;
            }

            $rootScope.BtnUpdateIncludedAttribute = function () {
                var _LVExcludeIncludeAttributeComponent = new LVExcludeIncludeAttributeComponent($scope,xlatService,$rootScope);
                _LVExcludeIncludeAttributeComponent.IncludeAttribute();
            }
        ...
        function LVPageComponent($scope, xlatService, $location, snapRemote, $compile, $timeout) {
            ...
            this.OneViewCordovaDialogsAlert= "OneViewCordovaDialogsAlert";
 				...
 				// Todo(Added by Sangeeta Bhatt(19-05-2017) : Need to change, temporarily enabled for Elcita Services for different predefined action loading)
                   ...
                   // document.getElementById('PageTitle').innerHTML = xlatService.xlat('PageTitle_' + OneViewSessionStorage.Get("TemplateId"));
                    ...
                    if (OneViewSessionStorage.Get("ServiceId") == 1) {
                        ...
                        LVBandDetailsCacheDict[1000] = [
                            { 'Id': 3, 'Name': "EAST WING", "Value": 0, 'Sequence': 1, 'ColourCode': '#00ff00' },
                            { 'Id': 4, 'Name': "EKFC 2", "Value": 1, 'Sequence': 2, 'ColourCode': '#00ff00' },
                            { 'Id': 458405, 'Name': "WEST WING", "Value": 2, 'Sequence': 2, 'ColourCode': '#00ff00' }
                        ]
                    }
                   ...
                   // SetCurrentShift();
                    ...
                    if (OneViewSessionStorage.Get("DcId") == null) {
                        var _LVExcludeIncludeAttributeComponent = new LVExcludeIncludeAttributeComponent($scope, xlatService);
                        var _LVExcludedAttriuteList = _LVExcludeIncludeAttributeComponent.GetExcludedAttributeList();
                        if (_LVExcludedAttriuteList!=null &&_LVExcludedAttriuteList.length > 0) {
                            $scope.ShowExcludeAttributeLstBtn = true;
                        }
                        else {
                            $scope.ShowExcludeAttributeLstBtn = false;
                        }
                    }
                ...
                try {
                    ...
                    // New DC
                        ...
                        if (LVTemplateConfigMetaData != null && LVTemplateConfigMetaData != undefined) {
                            ...
                            var _oDefaultValueComponentForLV = new DefaultValueComponentForLV();
                            _oDefaultValueComponentForLV.setDefaultValue();
                            ...
                            if (LVExcludeIncludeAttributeInEditForFirstTime == true) {
                                var _LVExcludeIncludeAttributeComponent = new LVExcludeIncludeAttributeComponent($scope, xlatService);
                                _LVExcludeIncludeAttributeComponent.CreatemodelForExculdedAttribute();
                                LVExcludeIncludeAttributeInEditForFirstTime = false;
                                this.PageLoad();
                            }
                        }
                    }
            ...
            this.Destroy = function () {
                ...
                try {
                    ...
                    LVDefaultValueDic = null;

                    LVExcludedAttriuteList = null;
                    LVExcludeIncludeAttributeInEditForFirstTime = false;
            ...
            this.Save = function (IsGoBack,IsSubmit) {

                try {
                    OneViewConsole.Debug("Save Start", "LVPageComponent.Save");

                    var _oLVDataCaptureBO = new LVDataCaptureBO();
                    var DCSummary = _oLVDataCaptureBO.GetDCSummary();
                    var EnteredCount = DCSummary.CompletedAttributeCount;

                    if (LVExcludedAttriuteList != null && LVExcludedAttriuteList.length > 0) {
                        var ExcludedCompletedAttributeCount = 0;
                        for (var i = 0; i < LVExcludedAttriuteList.length; i++) {
                            var AttributeId = LVExcludedAttriuteList[i];
                            if (LVTemplateResult[AttributeId] != undefined) {
                                ExcludedCompletedAttributeCount += 1;
                            }
                        }

                        EnteredCount = DCSummary.CompletedAttributeCount - ExcludedCompletedAttributeCount;
                    }
                    ...
                    LVDcStopDate = "";
                        ...
                        if (IsSubmit != true && IsSubmit != 'true') {
                            alert(LVxlatService.xlat("Please complete atleast one field"));
                        }
                }
            ...
            var Save = function (IsSubmit) {
                ...
                try {
                    ...
                    if (LVIsOnlineSave == false) {
                        ...
                        var ValidationResponse = _oLVDataCaptureBO.IsValidationSuccess(LVTemplateResult, IsSubmit);
                        ...
                        if (ValidationResponse.IsSaveValidationSuccess == true) {
                            ...
                            if (LVIsEdit == false) {
                                ...
                                var DcActionInfo = _oLVDataCaptureBO.Save(LVTemplateResult, LVDcStartDate, ValidationResponse.IsSubmitValidationSuccess, LVDCSummary);
                                ...
                                var Result = _oLVDataCaptureBO.Update(LVTemplateResult, LVDataCaptureId, LVDcResultsId, LVIsEdit, ValidationResponse.IsSubmitValidationSuccess, LVDCSummary);
            ...
            this.Edit = function (DcId) {
                ...
                try {
                    ...
                    if (IsSuccess == true) {
                        ...
                        var _LVExcludeIncludeAttributeComponent = new LVExcludeIncludeAttributeComponent($scope, xlatService);
                        var _LVExcludedAttriuteList = _LVExcludeIncludeAttributeComponent.GetExcludedAttributeListInEdit();
                        if (_LVExcludedAttriuteList != null && _LVExcludedAttriuteList.length > 0) {
                            LVExcludeIncludeAttributeInEditForFirstTime = true;
                            $scope.ShowExcludeAttributeLstBtn = true;
                        }
                        else {
                            $scope.ShowExcludeAttributeLstBtn = false;
            ...
            this.BackButtonClick = function () {
                ...
                try {
                    OneViewConsole.Debug("BackButtonClick Start", "LVPageComponent.BackButtonClick");

                    //alert('BackButtonClick');
                    if (LVBreadCrumbDetails.length > 0) {
                        MyInstance.Back();
                    }
                    else {                        
                        var Title = "Confirm";
                        var Message = "Unsaved data will be cleared off. Do you want to go back?";
                        ...
                        oOneViewCordovaPlugin.DefaultConfirmBox(Title, Message, function (ConfirmationId) {
                            ...
                            if (ConfirmationId == '2') {
                                if (LVPreviousPageId == 2) {
                                    ...
                                    if (OneViewSessionStorage.Get("ServiceId") == 1 || OneViewSessionStorage.Get("ServiceId") == 2 || OneViewSessionStorage.Get("ServiceId") == 24) {
                                        $location.url('/newdc');
                                    }
                                    else {
                    ...
                    OneViewConsole.Debug("BackButtonClick End", "LVPageComponent.BackButtonClick");
                }
                catch (Excep) {
                    oOneViewExceptionHandler.Catch(Excep, "LVPageComponent.BackButtonClick", xlatService);
                }
            }
                        ...
                        if (TemplateNodes[itrTemplateNode] != undefined) {
                            ...
                            if (TemplateNodes[itrTemplateNode].IsAttributeGroup == false) {
                                ...
                                if (TemplateNodes[itrTemplateNode].Childs.length > 0) {
                                    ...
                                    if (LVExcludedAttriuteList != null && LVExcludedAttriuteList.length > 0) {
                                        var _LVExcludeIncludeAttributeComponent = new LVExcludeIncludeAttributeComponent(LVscope, LVxlatService);
                             
                                        var _GettotalCountOfAttributeGroupResponse = _LVExcludeIncludeAttributeComponent.GettotalCountOfAttributeGroup(TemplateNodes[itrTemplateNode]);     
                                        if (AttributeAnswerStatus.CompletedCount > 0) {

                                            var _CompletedCount = parseInt(AttributeAnswerStatus.TotalCount) - parseInt(_GettotalCountOfAttributeGroupResponse.TotalCount);
                                            AttributeAnswerStatus.CompletedCount -= _CompletedCount;
                                        }

                                        AttributeAnswerStatus.TotalCount = _GettotalCountOfAttributeGroupResponse.TotalCount;
                                       // alert(JSON.stringify(_GettotalCountOfAttributeGroupResponse));
                                    }
                            ...
                            if (TemplateNodes[itrTemplateNode].IsAttributeGroup == false) {
                                ...
                                var IsAttributeGroupBlockRequired = true;

                                if (LVExcludedAttriuteList != null && LVExcludedAttriuteList.length > 0) {
                                    var _LVExcludeIncludeAttributeComponent = new LVExcludeIncludeAttributeComponent();
                                    IsAttributeGroupBlockRequired = _LVExcludeIncludeAttributeComponent.IsAttributeGroupBlockRequiredBasedOnExpiredAttribute(TemplateNodes[itrTemplateNode]);
                                }

                                if (IsAttributeGroupBlockRequired == true) {
            ...
            var MakeAttributeBlock = function (ImageHtml, AttributeHtml, NAHtml, AnswerModeHtml, TemplateNodeId, ControlId, AttributeName) {
                ...
                try {
                    ...
                    var _LVExcludeIncludeAttributeComponent = new LVExcludeIncludeAttributeComponent($scope, xlatService);
                    var IsTemplateNodeExcluded = _LVExcludeIncludeAttributeComponent.IsAttributeExcluded({ TemplateNodeId: TemplateNodeId });
                    if (IsTemplateNodeExcluded == true) {
                        Style = "display: none;";
                    }
                    ...
                    //alert("LVTemplateResult => " + JSON.stringify(LVTemplateResult[TemplateNodeId]));
                    
                    if (IsTemplateNodeExcluded == true) {
                        if (LVTemplateResult[TemplateNodeId] != undefined) {
                            if ((LVTemplateResult[TemplateNodeId].NA) == false) {
                                var _LVDefaultNAComponent = new LVDefaultNAComponent();
                                _LVDefaultNAComponent.UpdateModel(TemplateNodeId, "", true);
                            }
                        }
                        else {
                            var _LVDefaultNAComponent = new LVDefaultNAComponent();
            ...
            this.OpenRightPanel = function (TemplateNodeId, FirstControlId, HeaderId) {
                try {
                    ...
                    if (LVTemplateResult[TemplateNodeId] != undefined && LVTemplateResult[TemplateNodeId].NA != true) {
                       ...
                       // if (LVIsNonMandatoryActionNCRuleViolated == true) {
                     
                            _oLVFactory = new LVFactory();
                            var _oActionNCComponent = _oLVFactory.GetActionNCComponent("LVActionNCComponent");
                            ActionNCConfigList = _oActionNCComponent.CheckActionNC(LVCurrentAttributeId, false);
                            if (LVIsNonMandatoryActionNCRuleViolated == true) {
                                HeaderId = 2;
                            }
                        //}
            ...
            this.CloseRightPanel = function () {
                try {
                    ...
                    LVGlobalAttrActionNCDetails = null;
                ...
                try {  
                    ...
                    if (LVActionResult[Action.RuleId] == undefined) {
                        LVActionResult[Action.RuleId] = {
                            ...
                            "IsActionNotMandatory": Action.IsActionNotMandatory,
                            "ActionClientId": "",
                            "ActionClientGuid": "",
                            "DCNCMappingClientId": "",
            ...
            this.AddCustomAction = function (CustomAction, RuleId, IsNC, IsObservation, IsManualRule, TemplateNodeIds, IsActionNotMandatory) {
                try {
                    ...
                    if (CustomAction != "" && CustomAction != null && CustomAction != undefined) {
                        ...
                        var ActionResponsibleFor = "";
                        var IsCustomActionActionResponsibleForIsValid = true;

                        if (LVscope.CustomActionResponsibleConfigLst != undefined && LVscope.CustomActionResponsibleConfigLst.length > 0) {
                            ActionResponsibleFor = MyInstance.GetSelectedValueOfCustomActionResponsibleConfig();
                            if (LVscope.ActionResponsibleConfig.CustomActionResponsibleConfig.IsCutsomActionMandatory != undefined && LVscope.ActionResponsibleConfig.CustomActionResponsibleConfig.IsCutsomActionMandatory == true) {
                                if (ActionResponsibleFor == "" || ActionResponsibleFor == null) {
                                    IsCustomActionActionResponsibleForIsValid = false;
                                }
                            }
                        }

                        if (IsCustomActionActionResponsibleForIsValid == true) {
                            var _oLVDataCaptureBO = new LVDataCaptureBO();
                            var GeoLocationResponse = _oLVDataCaptureBO.GetLatitudeAndLongitude();
                            ...
                            if (LVActionResult[RuleId] == undefined) {
                                LVActionResult[RuleId] = {
                                    ...
                                    "IsActionNotMandatory": IsActionNotMandatory,
                                    "ActionClientId": "",
                                    "ActionClientGuid": "",
                                    "DCNCMappingClientId": "",
                                    "DNNCMappimgServerId": 0,
                                    ...
                                    "Actions": [
                                        {
                                            ...
                                            "Latitude": GeoLocationResponse.Latitude,
                                            "Longitude": GeoLocationResponse.Longitude,
                                            "ActionResponsibleFor": ActionResponsibleFor,
                                        }
                                    ],
                            ...
                            if (IsValid == true) {
                                if (LVscope.CustomActionResponsibleConfigLst != undefined && LVscope.CustomActionResponsibleConfigLst.length > 0) {
                                    ...
                                    var LabelName = CustomAction;
                                    if (ActionResponsibleFor != "") {
                                        LabelName += " - " + ActionResponsibleFor;
                                    }


                                    LVscope.CustomActions.push({ "RuleId": RuleId, "label": CustomAction, "CustomActionResponsibleValue": ActionResponsibleFor, "LabelName": LabelName });
                            ...
                            oNotificationComponent.Notify(LVxlatService.xlat("MN-RQ-LVI-001 :: Please enter Action Responsibility Team"), MyInstance.DefaultJavaScriptAlert);
                        }
                    }
                    else {
            ...
            this.ShowHelpDocument = function (TemplateNodeId) {
                ...
                try {
                    ...
                    if(OneViewGlobalServiceTypeEnum[OneViewGlobalServiceType] ==36){
                        var HelpDocumentTitle=HelpDocument.Name;
                        HelpDocumentTitle = (HelpDocumentTitle != "" && HelpDocumentTitle != null ) ? HelpDocumentTitle : "Info";
                        var HelpDocumentString=HelpDocument.HelpDocString;
                        var ReqObj={Title:HelpDocumentTitle};                
                        _oNotificationComponent.Notify(HelpDocumentString, this.OneViewCordovaDialogsAlert,ReqObj);
                    }
                    else{
            ...
            this.SnapRemoteClose = function (IsCloasingFromOutside) {
                try {
                    OneViewConsole.Debug("SnapRemoteClose Start", "LVPageComponent.SnapRemoteClose");

                    var _oRightPanelComponent = oLVFactory.GetRightPanelComponent(MyInstance.RightPanelComponentKey);
                    _oRightPanelComponent.SnapRemoteClose(IsCloasingFromOutside);
            ...
            this.Submit = function (IsGoBack) {

                try {
                    OneViewConsole.Debug("Submit Start", "LVPageComponent.Submit");
                    var IsSubmit = true;
                    var _oLVDataCaptureBO = new LVDataCaptureBO();
                    var ValidationResponse = _oLVDataCaptureBO.IsValidationSuccess(LVTemplateResult, IsSubmit);
                    //alert(JSON.stringify(ValidationResponse));
                    ...
                    if (ValidationResponse.IsSaveValidationSuccess == true) {
                        ...
                        var DCSummary = _oLVDataCaptureBO.GetDCSummary();
                        //alert('DCSummary : ' + JSON.stringify(DCSummary));

                        var IsCompleted = false;
                        if (ValidationResponse.IsSubmitValidationSuccess == false && LVTemplateMandatoryValidationMetaData == null) {
                            IsCompleted = (DCSummary.CompletedCount == DCSummary.TotalCount) ? true : false;
                        }
                        else if(LVTemplateMandatoryValidationMetaData !=null){
                            IsCompleted = ValidationResponse.IsSubmitValidationSuccess;
                        }

                        //alert('LVTemplateMandatoryValidationMetaData : ' + LVTemplateMandatoryValidationMetaData + ', LVDataCaptureClientGuid : ' + LVDataCaptureClientGuid + ', IsCompleted : ' + IsCompleted + ', OneViewSessionStorage.Get("IsDcCompletedBeforeEdit") : ' + OneViewSessionStorage.Get("IsDcCompletedBeforeEdit"));
                        if (IsCompleted != true) {
                            alert(LVxlatService.xlat("Please complete the Data Capture to Submit"));
                        }
                        else if (IsCompleted == true || (LVDataCaptureClientGuid != "" && OneViewSessionStorage.Get("IsDcCompletedBeforeEdit") == "true")) {
                            MyInstance.Save(IsGoBack, IsSubmit);
                        }                        
                    ...
                    OneViewConsole.Debug("Submit End", "LVPageComponent.Submit");
                }
                catch (Excep) {
                    oOneViewExceptionHandler.Catch(Excep, "LVPageComponent.Submit", xlatService);
                }
            }
            ...
            this.AddNC = function () {
                try {
                    ...
                    if (LVGlobalAttrActionNCDetails != null && LVGlobalAttrActionNCDetails.IsActionNotMandatory == true) { //

                        if (LVActionResult[LVGlobalAttrActionNCDetails.RuleId] == undefined) {
                            LVActionResult[LVGlobalAttrActionNCDetails.RuleId] = {
                                "IsDisable": false,
                                "IsNC": LVGlobalAttrActionNCDetails.IsNC,
                                "IsObservation": LVGlobalAttrActionNCDetails.IsObservation,
                                "IsManualRule": LVGlobalAttrActionNCDetails.IsManualRule,
                                "IsActionNotMandatory" : LVGlobalAttrActionNCDetails.IsActionNotMandatory,
                                "ActionClientId": "",
                                "ActionClientGuid": "",
                                "DCNCMappingClientId": "",
                                "DNNCMappimgServerId": 0,
                                "TemplateNodeIds": LVGlobalAttrActionNCDetails.TemplateNodeIds,// "'" + LVGlobalAttrActionNCDetails.TemplateNodeIds + "'",
                                "Actions": [],
                                "MultimediaSubElements": []
                            };
                        }
            ...
            this.GetSelectedValueOfCustomActionResponsibleConfig = function () {
                ...
                try {
                    ...
                    if (document.getElementsByName('CustomActionResponsibleValue') != null) {
                        var _CustomActionResponsibleValue = document.getElementsByName('CustomActionResponsibleValue');

                        for (i = 0; i < _CustomActionResponsibleValue.length; i++) {

                            if (_CustomActionResponsibleValue[i].checked) {
                                SelectedValue = _CustomActionResponsibleValue[i].value;
                                _CustomActionResponsibleValue[i].checked = false;
                            }
        ...
        function LVDefaultRightPanelComponent() {
            ...
            this.Open = function (HeaderId, IsTabClick) {
                try {
                    ...
                    if (HeaderId == 1) {
                        ...
                        else if (ActionNCConfigList[0].IsNonMandatoryActionNCRuleViolated != undefined && ActionNCConfigList[0].IsNonMandatoryActionNCRuleViolated == true) {
                            IsOpenRightPanel = false;
                            LVIsNonMandatoryActionNCRuleViolated = true;                           
                        }
                    }
                    else if (HeaderId == 3) {
                        LoadInnerContent(HeaderId);
            ...
            this.Close = function () {
                try {
                    ...
                    var IsSuccess = MyInstance.SnapRemoteClose();
                    if (IsSuccess == true) {
                        var _oOneViewSidePanel = new OneViewSidePanel(LVsnapRemote);
                        _oOneViewSidePanel.Toggle(LVsnapRemote);
                    }                  
                ...
                try {
                    ...
                    // Action Tab Html
                        ...
                        if (ActionNCConfigList.length > 1) {
                            ...
                            LVGlobalAttrActionNCDetails = ActionNCConfigList[0];
                                               ...
                                               '<div class="item no-padding">' +
                                                   '<div class="cus-action">' +
                                                     ...
                                                     '<div class="item item-input-inset">' +
                                                       ...
                                                       '<a class="button button-calm" ng-click="AddCustomAction(CustomAction,' + ActionNCConfigList[0].RuleId + ',' + ActionNCConfigList[0].IsNC + ',' + ActionNCConfigList[0].IsObservation + ',' + ActionNCConfigList[0].IsManual + ',' + TemplateNodeIds + ',' + ActionNCConfigList[0].IsActionNotMandatory + ')"><i class="icon icon-plus"></i> {{"Add" | xlat}}</a>' +
                                                     '</div>' +
                                                   '</div>' +
                                               '</div>' +
                                             '</div>';
                            ...
                            _oLVFactory = new LVFactory();
                            var _oActionNCComponent = oLVFactory.GetActionNCComponent(MyInstance.ActionNCComponentKey);                           
                            if (_oActionNCComponent.IsActionResponsibleConfigExist(ActionNCConfigList[0])) {
                                    var CustomActionlabel=
                                    CustomHtml = "";
                                    CustomHtml = '<div class="list">' +
                                              '<div class="item item-divider item-icon-left">' +
                                                  '<i class="icon icon-edit"></i> {{"Custom Actions" | xlat}}' +
                                              '</div>' +
                                              '<div class="item no-padding">' +
                                                  '<div class="cus-action">' +
                                                    ...
                                                    '<div class="item item-input-inset">' +
                                                      ...
                                                      '<textarea msd-elastic="/n/n" ng-model="CustomAction"></textarea><br/>' +
                                                      '</label><br/>' +

                                                    '</div>' +
                                                    //'<tick-list multiple="true" selected-icon="icon-check">' +
                                                   '<div class="item item-divider item-icon-left">' +
                                                       '<i class="icon icon-edit"></i> {{"Action Responsible For" | xlat}}' +
                                                   '</div>' +
                                                   '  <div class="list no-margin">' +

                                                   '  <div class="item item-button-right ng-binding ng-scope" ng-repeat="ActionResponsible in CustomActionResponsibleConfigLst"  style="text-overflow: inherit;white-space: normal;overflow: inherit;"> ' +
                                                   ' <input type="radio" name="CustomActionResponsibleValue"  selected="{{ActionResponsible.selected}}" value="{{ActionResponsible.Name}}" style="margin-right: 3px"> {{ActionResponsible.Name}}</div>' +
                                                   '</div>' +
            ...
            this.SnapRemoteClose = function (ClosingFromOutSide) {
                try {
                    OneViewConsole.Debug("SnapRemoteClose Start", "LVPageComponent.SnapRemoteClose");

                    var IsActionaddedSuccess = true;
                    ...
                    if (oActionNCConfigList != null && oActionNCConfigList != undefined) {
                        ...
                        for (var i = 0; i < oActionNCConfigList.length; i++) {
                            ...
                            if (oActionNCConfigList[i].IsRuleViolated == true) {
                                ...
                                var _oActionNCMetaDataComponent = new ActionNCMetaDataComponent();
                                var IsImageMandatory = _oActionNCMetaDataComponent.IsActionImageMandatory();

                                if (ActionResult != undefined) {
                                    if (IsImageMandatory == true) {
                                        var _oMultimediaSubElements = ActionResult.MultimediaSubElements;
                                        if (_oMultimediaSubElements.length == 0) {
                                            IsImageAdded = false;
                                            IsActionaddedSuccess = false;
                                        }
                                    }
                                }
                                ...
                                if (IsImageAdded == true) {
                                    if (ActionResult != undefined) {
                                        ...
                                        if (oActionNCConfigList[i].IsActionNotMandatory == true || oActionNCConfigList[i].IsActionNotMandatory == "true") { //  if (oActionNCConfigList[i].IsActionNotMandatory != true) {// 
                                            //don't clear if action not mandatory
                                    ...
                                    if (ClosingFromOutSide != undefined) {
                                        if (ClosingFromOutSide == true && IsImageMandatory == true) {
                                            ...
                                            if (LVActionResult[oActionNCConfigList[0].RuleId] != undefined) {
                                                if (LVActionResult[oActionNCConfigList[0].RuleId].DCNCMappingClientId == "") {
                                                    delete LVActionResult[oActionNCConfigList[0].RuleId];
                                                }
                                                else {
                                                    LVActionResult[oActionNCConfigList[0].RuleId].IsDisable = true;
                                                    LVActionResult[oActionNCConfigList[0].RuleId].IsNC = false;
                                                    for (var k = 0; k < LVActionResult[oActionNCConfigList[0].RuleId].Actions.length; k++) {
                                                        LVActionResult[oActionNCConfigList[0].RuleId].Actions[k].IsDisable = true;
                                                    }
                                                }
                                            }
                                        ...
                                        alert(LVxlatService.xlat("IN-MG-LVI-002 :: Please capture atleast one image"));
                                    }
                                }
                            }//Rule Violated end here
                        }
                    }
                    ...
                    for (var i = 0; i < TemplateNode.AnswerModes.length; i++) {
                        ...
                        if (LVTemplateResult[TemplateNode.Id] != undefined) {
                            ...
                            if (oDefaultValue.Answer != "NA" && oDefaultValue.Answer == "") {
                                ...
                                if (LVDefaultValueDic != null) {
                                    if (oDefaultValue.Answer == "" && oDefaultValue.AnswerValue == "") {
                                        var AttributeId = TemplateNode.Id;
                                        var ControlId = TemplateNode.AnswerModes[i].ControlId;
                                        if (LVDefaultValueDic[AttributeId] != undefined) {
                                            if (LVDefaultValueDic[AttributeId][ControlId] != undefined) {
                                                //return _LVDefaultValueDic[AttributeId][ControlId];
                                                Answer = LVDefaultValueDic[AttributeId][ControlId].Answer;
                                                AnswerValue = LVDefaultValueDic[AttributeId][ControlId].AnswerValue;
                                            }
                                        }
                                    }
                                }
        ...
        function LVDefaultBandControl() {
                    ...
                    for (var i = 0; i < BandDetailsEntityList.length; i++) {
                        ...
                        for (var j = 0; j < Answerlst.length; j++) {
                            if (Answerlst[j].Answer == BandDetail.Id) {
                                ...
                                Style += ';color:white';
                                //if (OneViewSessionStorage.Get("DcId") == null) {
                                    MyInstance.UpdateAnswerModel(TemplateNodeId, AnswerMode.ControlId, BandDetail.Id, BandDetail.Name, Id, BandDetail.ColourCode, AnswerMode.SelectionType, BandDetail.Value,true);
                                //}                               
                                break;
                            }
                        }                        
            ...
            this.UpdateAnswerModel = function (TemplateNodeId, ControlId, Answer, AnswerValue, TagId, ColourCode, SelectionType, Value,ForDefaultValue) {
        ...
        function LVDefaultNotificationComponent() {
            ...
            this.Notify = function (Msg, Type,Req) {
                ...
                try {
                    ...
                    else if (Type == "OneViewCordovaDialogsAlert") {
                        ShowCordovaDialogsAlert(Msg,Req);
                    }
                    else {
            ...
            var ShowDefaultNativeToast = function (Msg) {
               ...
               /// <summary>
            /// ShowCordovaDialogsAlert
            /// </summary>
            /// <param name="Msg">Msg</param>        
            var ShowCordovaDialogsAlert = function (Msg,Req) {

                try {
                    OneViewConsole.Debug("Notify Start", "LVDefaultNotificationComponent.ShowCordovaDialogsAlert");
                    ...
                    OneViewConsole.Debug("Notify End", "LVDefaultNotificationComponent.ShowCordovaDialogsAlert");
                }
                catch (Excep) {
                    oOneViewExceptionHandler.Catch(Excep, "LVDefaultNotificationComponent.ShowCordovaDialogsAlert", LVxlatService);
                }
            }
        }
        ...
        function LVDataCaptureBO() {
            ...
            this.IsValidationSuccess = function (LVTemplateResult, IsSubmit) {
            ...
            this.Update = function (LVTemplateResult, LVDataCaptureId, LVDcResultsId, LVIsEdit, IsVallidationSuccess, LVDCSummary) {
                    ...
                    try{
                        ...
                        for (var itrLVActionResult in LVActionResult) {
                            ...
                            if (LVActionResult[itrLVActionResult].DCNCMappingClientId == "") {                             
                                ...
                                //  if (LVActionResult[itrLVActionResult].DCNCMappingClientId != "" && LVActionResult[itrLVActionResult].IsDisable != true) {     // if (LVActionResult[itrLVActionResult].IsActionNotMandatory == true) {
                                if (LVActionResult[itrLVActionResult].ActionClientGuid == "" && (LVActionResult[itrLVActionResult].IsActionNotMandatory == true || LVActionResult[itrLVActionResult].IsActionNotMandatory == "true")) {
                                    var oAction = GetAction(DataCaptureRequest, LVDataCaptureClientGuid, LVDcResultsClientGuid, itrLVActionResult, "", LVActionResult[itrLVActionResult]);
                                    Actions[itrLVActionResult] = oAction;
                                    //alert(JSON.stringify(oAction));
                                }
            ...
            this.Save = function (LVTemplateResult, LVDcStartDate, IsVallidationSuccess, LVDCSummary) {
            ...
            var GetAction = function (DataCaptureRequest, DataCaptureClientGuid, DcResultsClientGuid, NCRuleId, DcResultDetailsClientGuid, ActionResultItem) {
                ...
                try {
                    ...
                    var _oActionEntity = null;
                    if (ActionResultItem.Actions != null && ActionResultItem.Actions != undefined && ActionResultItem.Actions.length > 0) {
                        _oActionEntity = new ActionEntity();
                    ...
                    var ActionClientGuid = "";
                    if (_oActionEntity != undefined && _oActionEntity != null) {
                        ActionClientGuid = _oActionEntity.ClientGuid;
                    }
                    var _oDCNCMapping = null;                  
                    if (ActionResultItem.DCNCMappingClientId == "") {
                        _oDCNCMapping = GetDCNCMapping(DataCaptureRequest, DataCaptureClientGuid, DcResultsClientGuid, NCRuleId, DcResultDetailsClientGuid, ActionClientGuid, ActionResultItem);
                    }
                    else if (_oActionEntity != null) {
                        var _oActionDAO = new ActionDAO();
                        _oActionDAO.UpdateActionIdInDCNCMapping(_oActionEntity.ClientGuid, ActionResultItem.DCNCMappingClientId);
                    }
                    var MultiMediaSubElements = new Array();
                    for (var i = 0; i < ActionResultItem.MultimediaSubElements.length; i++) {
                        ActionResultItem.MultimediaSubElements[i].MappedEntityClientGuid = ActionClientGuid;
            ...
            var GetActionDetailsEntity = function (DataCaptureRequest, ActionClientGuid, DataCaptureClientGuid, Action) {
                ...
                try {
                    ...
                    if (Action.ActionResponsibleFor != undefined) {
                        _oActionDetailsEntity.ActionResponsibleFor = Action.ActionResponsibleFor;
                    }
            ...
            var GetDCNCMapping = function (DataCaptureRequest, DataCaptureClientGuid, DcResultsClientGuid, NCRuleId, DcResultDetailsClientGuid, ActionClientGuid, ActionResultItem) {
                ...
                try {
                    ...
                    _oDCNCMapping.IsActionNotMandatory = ActionResultItem.IsActionNotMandatory;
            ...
            this.LoadTemplateResult = function (DcId, DcUserId, AnswerModeLoadType) {
                ...
                try {
                    ...
                    var DCNCMappings = _oActionDAO.GetNCsWithoutActions(LVDataCaptureClientGuid);
                    ActionDCNCMappings = ActionDCNCMappings.concat(DCNCMappings);
                    //alert(JSON.stringify(ActionDCNCMappings));
                                   
                    for (var i = 0; i < ActionDCNCMappings.length; i++) {
                       
                        //Case 1 : Actions available
                        if (ActionDCNCMappings[i] != undefined && (ActionDCNCMappings[i].ActionClientGuid != undefined && ActionDCNCMappings[i].ActionClientGuid != null && ActionDCNCMappings[i].ActionClientGuid != "")) {
                            if (LVActionResult[ActionDCNCMappings[i].RuleId] != undefined) {
                                LVActionResult[ActionDCNCMappings[i].RuleId].Actions.push({
                                    ...
                                    "ActionResponsibleFor": ActionDCNCMappings[i].ActionResponsibleFor,
                                });                                                                  
                            }
                            else {
                                LVActionResult[ActionDCNCMappings[i].RuleId] = {
                                    ...
                                    "IsActionNotMandatory": ActionDCNCMappings[i].IsActionNotMandatory,
                            ...
                            //Case 2 : Only NC , Actions not available
        ...
        function LVActionNCComponent() {
                            ...
                            if (oActionNCConfig.length > 1) {
                                ...
                                if (oActionNCConfig[0].IsRuleViolated == true) {
                                    ...
                                    if (oActionNCConfig[0].IsNC == true && oActionNCConfig[0].IsActionEnable == true) {
                                        ...
                                        if (IsTabClick == false && oActionNCConfig[0].CriteriaDisplayLabelKey != "" && oActionNCConfig[0].IsManual == false) {
                                            var _oLVFactory = new LVFactory();
                                            var _oNotificationComponent = _oLVFactory.GetNotificationComponent(this.LVDefaultNotificationComponentKey);
                                    ...
                                    if (oActionNCConfig[0].IsNonMandatoryActionNCRuleViolated != undefined && oActionNCConfig[0].IsNonMandatoryActionNCRuleViolated == true) {
                                        return oActionNCConfig;
                                    }
                                    else {
                                ...
                                else if (oActionNCConfig[0].IsNonMandatoryActionNCRuleViolated != undefined && oActionNCConfig[0].IsNonMandatoryActionNCRuleViolated == true) {
                                    return oActionNCConfig;
                                }
                            }
                        }
                ...
                try {
                    ...
                    if(AttributeWiseActionNCConfigList == undefined){
                        ...
                        for (var i = 0; i < AttributeWiseActionNCConfigList.length; i++) {
                            ...
                            if (LVIsNonMandatoryActionNCRuleViolated == true) {
                                AttributeWiseActionNCConfigList[i]['IsRuleViolated'] = true;
                            }

                            //if (AttributeWiseActionNCConfigList[i]['IsRuleViolated'] != true) {

                               // AttributeWiseActionNCConfigList[i].NonMandatoryActionNCConfig = { FinalJavaScriptEquation: "Model[#BandControlId_535#] == #3#" };
                                if (AttributeWiseActionNCConfigList[i].NonMandatoryActionNCConfig != undefined) {
                                    if (AttributeWiseActionNCConfigList[i].NonMandatoryActionNCConfig.FinalJavaScriptEquation != null && AttributeWiseActionNCConfigList[i].NonMandatoryActionNCConfig.FinalJavaScriptEquation != undefined && AttributeWiseActionNCConfigList[i].NonMandatoryActionNCConfig.FinalJavaScriptEquation != "") {
                                        AttributeWiseActionNCConfigList[i]['IsNonMandatoryActionNCRuleViolated'] = ValidateRule(AttributeWiseActionNCConfigList[i].NonMandatoryActionNCConfig.FinalJavaScriptEquation, TemplateNodeId);
                                        if (AttributeWiseActionNCConfigList[i]['IsNonMandatoryActionNCRuleViolated'] == true) {
                                            LVIsNonMandatoryActionNCRuleViolated = true;
                                        }
                                        else {
                                            LVIsNonMandatoryActionNCRuleViolated = false;
            ...
            /// <summary>
            /// IsActionResponsibleConfigExist
            /// </summary>
            /// <param name="ActionNCConfig">ActionNCConfig</param>   
            /// <returns>true or false</returns> 
            this.IsActionResponsibleConfigExist = function (oActionNCConfig) {
                try {
                    OneViewConsole.Debug("IsActionResponsibleConfigExist Start", "LVDefaultRightPanelComponent.IsActionResponsibleConfigExist");

                    var IsExist = false;

                    if (oActionNCConfig.ActionResponsibleConfig != undefined && oActionNCConfig.ActionResponsibleConfig != null) {

                        if (oActionNCConfig.ActionResponsibleConfig.ActionResponsibleList != undefined && oActionNCConfig.ActionResponsibleConfig.ActionResponsibleList != null && oActionNCConfig.ActionResponsibleConfig.ActionResponsibleList != "" && oActionNCConfig.ActionResponsibleConfig.ActionResponsibleList != "null") {
                            var ActionResponsibleList = oActionNCConfig.ActionResponsibleConfig.ActionResponsibleList;

                            if (ActionResponsibleList.length > 0) {
                    ...
                    OneViewConsole.Debug("IsActionResponsibleConfigExist End", "LVDefaultRightPanelComponent.IsActionResponsibleConfigExist");
                    return IsExist;
                }
                catch (Excep) {
                    throw oOneViewExceptionHandler.Create("Framework", "LVDefaultRightPanelComponent.IsActionResponsibleConfigExist", Excep);
                }
            }
        }
        ...
        function LVDefaultActionPageComponent() {
            ...
            this.Load = function (oActionNCConfig, TemplateNodeId, ControlId) {
                ...
                try {
                    ...
                    LVscope.ActionResponsibleConfig = {};
                    LVscope.CustomActionResponsibleConfigLst = [];                    
                    ...
                    if (oActionNCConfig != undefined && oActionNCConfig.length > 0) {
                        if (oActionNCConfig.length > 1) {
                            ...
                            LoadActionResponsibleConfig(oActionNCConfig[0]);
                    ...
                    if (LVActionResult[oActionNCConfig.RuleId] != undefined && LVActionResult[oActionNCConfig.RuleId].IsDisable == false) {
                        for (var i = 0; i < LVActionResult[oActionNCConfig.RuleId].Actions.length; i++) {
                            if (LVActionResult[oActionNCConfig.RuleId].Actions[i].IsDisable == false && LVActionResult[oActionNCConfig.RuleId].Actions[i].ActionType == LVActionType.CustomAction) {
                                ...
                                var _oLVFactory = new LVFactory();
                                var _oActionNCComponent = _oLVFactory.GetActionNCComponent("LVActionNCComponent");
                                if (_oActionNCComponent.IsActionResponsibleConfigExist(oActionNCConfig)) {                                    
                                    var LabelName = LVActionResult[oActionNCConfig.RuleId].Actions[i].Name;
                                    var ActionResponsibleFor = LVActionResult[oActionNCConfig.RuleId].Actions[i].ActionResponsibleFor;
                                    if (ActionResponsibleFor != "") {
                                        LabelName += " - " + ActionResponsibleFor;
                                    }
                                    LVscope.CustomActions.push({ "RuleId": oActionNCConfig.RuleId, "label": LVActionResult[oActionNCConfig.RuleId].Actions[i].Name, "CustomActionResponsibleValue": LVActionResult[oActionNCConfig.RuleId].Actions[i].ActionResponsibleFor, "LabelName": LabelName });                               
                                }
                                else {
            ...
            var LoadActionResponsibleConfig = function ( oActionNCConfig) {
                try {
                    OneViewConsole.Debug("LoadPredefinedActionsForElcitaClient Start", "LVActionNCComponent.LoadPredefinedActionsForElcitaClient");
                    ...
                    if (oActionNCConfig.ActionResponsibleConfig != undefined && oActionNCConfig.ActionResponsibleConfig != null) {
                        ...
                        if (oActionNCConfig.ActionResponsibleConfig.ActionResponsibleList != undefined && oActionNCConfig.ActionResponsibleConfig.ActionResponsibleList != null && oActionNCConfig.ActionResponsibleConfig.ActionResponsibleList != "" && oActionNCConfig.ActionResponsibleConfig.ActionResponsibleList != "null") {
                            ...
                            if (ActionResponsibleList.length > 0) {
                                ...
                                for (var i = 0; i < ActionResponsibleList.length ; i++) {

                                    if (ActionResponsibleList[i].ActionResponsibleDiamension === "CustomActionResponsibleConfig") {

                                        if (LVscope.ActionResponsibleConfig["CustomActionResponsibleConfig"] == undefined) {
                                            LVscope.ActionResponsibleConfig["CustomActionResponsibleConfig"] = { IsCutsomActionMandatory: false,CustomActionResponsibleConfigLst:[{ "Name": ActionResponsibleList[i].ActionResponsibleDetails, 'selected': ''}]};
                                        }
                                        else {
                                            LVscope.ActionResponsibleConfig["CustomActionResponsibleConfig"].CustomActionResponsibleConfigLst.push({ "Name": ActionResponsibleList[i].ActionResponsibleDetails, 'selected': '' });
                                        }
                                    }
                                }
                                LVscope.CustomActionResponsibleConfigLst = LVscope.ActionResponsibleConfig.CustomActionResponsibleConfig.CustomActionResponsibleConfigLst;

                                LVscope.ActionResponsibleConfig["CustomActionResponsibleConfig"].IsCutsomActionMandatory = oActionNCConfig.ActionResponsibleConfig.IsCustomActionResponsibleMandatory;
                ...
                try {
                    ...
                    if (LVTemplateConfigMetaData != null) {
                        ...
                        if (LVExcludedAttriuteList != null && LVExcludedAttriuteList.length > 0) {
                            ...
                            var oCompletedAttributeCount = parseInt(TemplateSummary.CompletedAttributeCount) - parseInt(ExcludedCompletedAttributeCount);
                            var oTotalAttributeCount = parseInt(TemplateSummary.TotalAttributeCount) - parseInt(LVExcludedAttriuteList.length);

                            TemplateSummaryHtml = oCompletedAttributeCount + "/" + oTotalAttributeCount;
                        }
        ...
        function DefaultValueComponentForLV() {

            var MyInstance = this;

            this.setDefaultValue = function () {
                try {
                    OneViewConsole.Debug("setDefaultValue start", "DefaultValueComponentForLV.setDefaultValue");
                    ...
                    var TemplateMetadata= MyInstance.FormatLVFormattedTemplateMetadata({ "LVFormattedTemplateMetadata": LVFormattedTemplateMetadata });
                   
                    LVDefaultValueDic = oDefaultValueComponent.GetDefaultValueExtended(TemplateMetadata, TemplateId);
                  ...
                  //  MyInstance.DCDetailFromDBList = null;
                    OneViewConsole.Debug("setDefaultValue end", "DefaultValueComponentForLV.setDefaultValue");

                } catch (Excep) {
                    throw oOneViewExceptionHandler.Create("BO", "DefaultValueComponentForLV.setDefaultValue", Excep);
                }
                finally {
            ...
            this.FormatLVFormattedTemplateMetadata = function (Req) {
                try {
                    OneViewConsole.Debug("setDefaultValue start", "DefaultValueComponentForLV.setDefaultValue");              

                    var LVFormattedTemplateMetadata = Req.LVFormattedTemplateMetadata;
                    var TemplateMetadata = {};

                    for (var itrAttributeNodeId in LVFormattedTemplateMetadata) {
                        if (LVFormattedTemplateMetadata[itrAttributeNodeId].IsAttributeGroup == false) {
                            var Id=LVFormattedTemplateMetadata[itrAttributeNodeId].Id;
                            TemplateMetadata[Id] = LVFormattedTemplateMetadata[itrAttributeNodeId];
                            TemplateMetadata[Id].DATEntityType = 8;
                            TemplateMetadata[Id].AnswerMode = LVFormattedTemplateMetadata[itrAttributeNodeId].AnswerModes;
                        }
                    }              
        ...
        function LVExcludeIncludeAttributeComponent($scope, xlatService, $rootScope) {

            var MyInstance = this;

            var IsExcludedAttributeFeatureRequired = function () {
                try {
                    ...
                    throw oOneViewExceptionHandler.Create("BO", "LVExcludeIncludeAttributeComponent.GetExcludedAttributeList", Excep);
                }
            }

            this.GetExcludedAttributeList = function () {
                try {
                    OneViewConsole.Debug("GetExcludedAttributeList start", "LVExcludeIncludeAttributeComponent.GetExcludedAttributeList");
                    

                    if (IsExcludedAttributeFeatureRequired() == true) {
                        MyInstance.GetExcludedAttributeListFromDAO();

                        if (LVExcludedAttriuteList != null && LVExcludedAttriuteList.length > 0) {

                            for (var i = 0; i < LVExcludedAttriuteList.length; i++) {
                                CreatemodelForExculdedAttribute(LVExcludedAttriuteList[i]);
                            }
                        }
                    }
                    else {
                        LVExcludedAttriuteList = [];
                    }
                  

                    OneViewConsole.Debug("GetExcludedAttributeList end", "LVExcludeIncludeAttributeComponent.GetExcludedAttributeList");

                    return LVExcludedAttriuteList;
            ...
            this.GetExcludedAttributeListFromDAO = function () {
                try {
                    OneViewConsole.Debug("GetExcludedAttributeList start", "LVExcludeIncludeAttributeComponent.GetExcludedAttributeList");

                   // LVExcludedAttriuteList = [6, 7];

                    var ServiceId=OneViewSessionStorage.Get("ServiceId");
                    var TemplateNodeId=OneViewSessionStorage.Get("TemplateId");
                    var PlaceId = OneViewSessionStorage.Get("DcPlaceId");
                    var _ExcludedAttributeMetadataDAO = new ExcludedAttributeMetadataDAO();
                    var ExcludedAttributeMetadataResponse = _ExcludedAttributeMetadataDAO.GetMetaData(ServiceId, TemplateNodeId, PlaceId);

                    if (ExcludedAttributeMetadataResponse != null) {
                        var AttributeIdLst = ExcludedAttributeMetadataResponse.AttributeIdLst;

                        LVExcludedAttriuteList = AttributeIdLst;
                    }
                    else {
                        LVExcludedAttriuteList = [];
                    }
            ...
            this.GetExcludedAttributeListInEdit = function () {
                try {
                    OneViewConsole.Debug("GetExcludedAttributeList start", "LVExcludeIncludeAttributeComponent.GetExcludedAttributeList");
                    ...
                    if (IsExcludedAttributeFeatureRequired() == true) {
                        ...
                        if (LVExcludedAttriuteList != null && LVExcludedAttriuteList.length > 0) {
                            ...
                            var IncludeAttributeLst = [];

                            for (var i = 0; i < LVExcludedAttriuteList.length; i++) {
                                var TemplateNodeId = LVExcludedAttriuteList[i];

                                if (LVTemplateResult[TemplateNodeId] != undefined) {

                                    if (LVTemplateResult[TemplateNodeId].NA != true) {
                                        IncludeAttributeLst.push(TemplateNodeId);
                                    }
                                }
                            }

                            if (IncludeAttributeLst.length > 0) {

                                for (var j = 0; j < IncludeAttributeLst.length; j++) {
                                    RemoveAttributeFromExcludedLst({ AttributeId: IncludeAttributeLst[j] });
                                }

                                if (LVExcludedAttriuteList.length == 0) {
                                    $scope.ShowExcludeAttributeLstBtn = false;
                                }
                            }
            ...
            this.CreatemodelForExculdedAttribute = function () {
                try {
                    OneViewConsole.Debug("GetExcludedAttributeList start", "LVExcludeIncludeAttributeComponent.GetExcludedAttributeList");
            ...
            var CreatemodelForExculdedAttribute = function (TemplateNodeId) {

                try {

                    if (LVFormattedTemplateMetadata[TemplateNodeId] != undefined) {

                        var TemplateNodeName = LVFormattedTemplateMetadata[TemplateNodeId].Name;
                        var TemplateNode = LVFormattedTemplateMetadata[TemplateNodeId];                     
                        ...
                        for (var i = 0; i < TemplateNode.AnswerModes.length; i++) {
                            ...
                            CreatemodelForParentExculdedAttribute(TemplateNodeId);

                            var _oLVDefaultAnswerModeComponent = new LVDefaultAnswerModeComponent();
                            _oLVDefaultAnswerModeComponent.CreateModel(TemplateNodeId, TemplateNodeName, ControlId, Answer, AnswerValue, AnswerFKType, AnswerDataType, AnswerModeType);
            ...
            var CreatemodelForParentExculdedAttribute = function (TemplateNodeId) {

                try {
            
                    var TemplateId = OneViewSessionStorage.Get("TemplateId");

                    if (parseInt(TemplateNodeId) !== parseInt(TemplateId)) {

                        if (LVFormattedTemplateMetadata[TemplateNodeId].Parent != undefined) {

                            var IsAttributeGroup = LVFormattedTemplateMetadata[TemplateNodeId].Parent.IsAttributeGroup;

                            if (IsAttributeGroup === true) {
                                var AttributeGroupId = LVFormattedTemplateMetadata[TemplateNodeId].Parent.Id;
                                var AttributeGroupName = LVFormattedTemplateMetadata[TemplateNodeId].Parent.Name;
                                var AttributeGroupControlId = "ControlId" + AttributeGroupId;

                                if (parseInt(AttributeGroupId) !== parseInt(TemplateId)) {
                                    var _oLVDefaultAttributeGroupComponent = new LVDefaultAttributeGroupComponent();
                                    _oLVDefaultAttributeGroupComponent.CreateModel(AttributeGroupId, AttributeGroupName, AttributeGroupControlId)
                                }

                                CreatemodelForParentExculdedAttribute(AttributeGroupId);
            ...
            this.IsAttributeExcluded = function (Req) {
                try {
                    OneViewConsole.Debug("IsAttributeExcluded start", "LVExcludeIncludeAttributeComponent.IsAttributeExcluded");

                    var IsExcluded = false;
                    var Id = Req.TemplateNodeId;
                 
                    //if (LVExcludedAttriuteList!=null &&LVExcludedAttriuteList.length > 0) {
                    //    for (var i = 0; i < LVExcludedAttriuteList.length ; i++) {
                    //        if (TemplateNodeId == LVExcludedAttriuteList[i]) {
                    //            IsExcluded = true;
                    //            break;
                    //        }
                    //    }
                    //}
                    if (LVExcludedAttriuteList != null && LVExcludedAttriuteList.length > 0) {
                        IsExcluded = IsValueExistInarray(Id, LVExcludedAttriuteList);
                    }

                    OneViewConsole.Debug("IsAttributeExcluded end", "LVExcludeIncludeAttributeComponent.IsAttributeExcluded");

                    return IsExcluded;

                } catch (Excep) {
                    throw oOneViewExceptionHandler.Create("BO", "LVExcludeIncludeAttributeComponent.IsAttributeExcluded", Excep);
                }
                finally {
                    _oDefaultValueComponent = null;
                    DefaultValueMetaData = null;
            ...
            this.GenerateExculdedAttributeHtml = function () {
                try {
                    OneViewConsole.Debug("GenerateExculdedAttributeHtml start", "LVExcludeIncludeAttributeComponent.GenerateExculdedAttributeHtml");

                    var Html = "";
              
                    Html += GetHtmlForExculdedAttributeList({ LVExcludedAttriuteList: LVExcludedAttriuteList });

                    var oDOM = new DOM();
                    oDOM.RemoveInnerHtml("DivIncludeAttribute");
                    oDOM.Append("DivIncludeAttribute", Html);

                    OneViewConsole.Debug("GenerateExculdedAttributeHtml end", "LVExcludeIncludeAttributeComponent.GenerateExculdedAttributeHtml");

                    return Html;

                } catch (Excep) {
                    throw oOneViewExceptionHandler.Create("BO", "LVExcludeIncludeAttributeComponent.GenerateExculdedAttributeHtml", Excep);
                }
                finally {
                    _oDefaultValueComponent = null;
                    DefaultValueMetaData = null;
            ...
            var GetHtmlForExculdedAttributeList = function (Req) {
                try {
                    OneViewConsole.Debug("GenerateExculdedAttributeHtml start", "LVExcludeIncludeAttributeComponent.GenerateExculdedAttributeHtml");

                    var Html = "";
                    var LVExcludedAttriuteList = Req.LVExcludedAttriuteList;
                    ...
                    if (LVExcludedAttriuteList != null && LVExcludedAttriuteList.length > 0) {
                        ...
                        for (var i = 0; i < LVExcludedAttriuteList.length; i++) {
                            ...
                            if (LVFormattedTemplateMetadata[AttributeId] != undefined) {
                                var AttributeName = LVFormattedTemplateMetadata[AttributeId].Name;
                                var ParentName = LVFormattedTemplateMetadata[AttributeId].Parent.Name

                                var ExludedAttributeNameWithParent = ParentName + " - " + AttributeName;

                                Html += '<input style="margin-right: 10px;" type="checkbox" id="chk_' + AttributeId + '"  value=' + AttributeId + '/>' + ExludedAttributeNameWithParent + ' <br/>';
                            }
            ...
            this.IncludeAttribute = function () {
                try {
                    OneViewConsole.Debug("IsAttributeExcluded start", "LVExcludeIncludeAttributeComponent.IsAttributeExcluded");
                    ...
                    if (LVExcludedAttriuteList !=null && LVExcludedAttriuteList.length > 0) {
                        for (var i = 0; i < LVExcludedAttriuteList.length; i++) {
                           // alert(document.getElementById("chk_" + LVExcludedAttriuteList[i]).checked);
                            if (document.getElementById("chk_" + LVExcludedAttriuteList[i]).checked == true) {
                                var AttributeId=LVExcludedAttriuteList[i];
                                IncludeAttributeLst.push(AttributeId);
                             ...
                             //  
                                ...
                                if (LVTemplateResult[AttributeId] != undefined) {
                                    ...
                                    if ((LVTemplateResult[AttributeId].NA) == true) {
                                        var _LVDefaultNAComponent = new LVDefaultNAComponent();
                                        _LVDefaultNAComponent.UpdateModel(AttributeId, "", true);
                                    }
                                }
                            }
                        }
            ...
            var RemoveAttributeFromExcludedLst = function (Req) {
                try {
                    OneViewConsole.Debug("GenerateExculdedAttributeHtml start", "LVExcludeIncludeAttributeComponent.GenerateExculdedAttributeHtml");

                    var AttributeId = Req.AttributeId;
                    var index = LVExcludedAttriuteList.indexOf(AttributeId);
                    if (index > -1) {
                        LVExcludedAttriuteList.splice(index, 1);
                    }
            ...
            var UpdateUI = function () {
                try {
                    ...
                    // LVExcludedAttriuteListFromIncludeDetails
                    //$scope, xlatService, $location, snapRemote, $compile, $timeout
                    var oLVPageComponent = new LVPageComponent(LVscope, LVxlatService, LVlocation, LVsnapRemote, LVcompile,LVtimeout);
                    var _oLVExcludedAttriuteList = LVExcludedAttriuteList;//This is for testing purpose
                  //  oLVPageComponent.Destroy();
                   // oLVPageComponent.Init(_oLVExcludedAttriuteList);
                    LVExcludedAttriuteList = _oLVExcludedAttriuteList;//This is for testing purpose
                    oLVPageComponent.PageLoad();
            ...
            this.IsAttributeGroupBlockRequiredBasedOnExpiredAttribute = function (TemplateNodesChildList) {
                try {
                    OneViewConsole.Debug("IsAttributeGroupBlockRequiredBasedOnExpiredAttribute start", "LVExcludeIncludeAttributeComponent.IsAttributeGroupBlockRequiredBasedOnExpiredAttribute");

                    var IsBlockRequired = true;
                    //var ExcludedAttriuteCountInAttributeGroupBlock = 0;

                    //if (LVExcludedAttriuteList != null && LVExcludedAttriuteList.length > 0) {

                    //    if (TemplateNodesChildList.length > 0) {

                    //        for (var i = 0; i < TemplateNodesChildList.length ; i++) {
                    //            var AttributeId = TemplateNodesChildList[i].Id;

                               
                    //                for (var j = 0; j < LVExcludedAttriuteList.length; j++) {
                    //                    var ExcludedAttributeId = LVExcludedAttriuteList[j];

                    //                    if (AttributeId === ExcludedAttributeId) {
                    //                        ExcludedAttriuteCountInAttributeGroupBlock += 1;
                    ...
                    //        if (TemplateNodesChildList.length === ExcludedAttriuteCountInAttributeGroupBlock) {
                    //            IsBlockRequired = false;
                    //        }
                    //    }
                    //}
                    var Response = MyInstance.GettotalCountOfAttributeGroup(TemplateNodesChildList);
                    if (Response.TotalCount === 0) {
                        IsBlockRequired = false;
                    }


                    OneViewConsole.Debug("IsAttributeGroupBlockRequiredBasedOnExpiredAttribute end", "LVExcludeIncludeAttributeComponent.IsAttributeGroupBlockRequiredBasedOnExpiredAttribute");

                    return IsBlockRequired;

                } catch (Excep) {
                    throw oOneViewExceptionHandler.Create("BO", "LVExcludeIncludeAttributeComponent.IsAttributeGroupBlockRequiredBasedOnExpiredAttribute", Excep);
                }
                finally {
                    _oDefaultValueComponent = null;
                    DefaultValueMetaData = null;
            ...
            this.GettotalCountOfAttributeGroup = function (TemplateNode) {
                try {
                    OneViewConsole.Debug("GettotalCountOfAttributeGroup start", "LVExcludeIncludeAttributeComponent.GettotalCountOfAttributeGroup");
                    
                    var Response = {TotalCount:1,CompletedAttributeCount:0};

                    if (TemplateNode.Childs.length == 0) {

                        var Id = TemplateNode.Id;

                        if (LVTemplateResult[Id] == undefined) {
                            Response.CompletedAttributeCount = 1;
                        }
                 

                        var IsExist = IsValueExistInarray(Id, LVExcludedAttriuteList);                   
                        if (IsExist == true) {
                            Response.TotalCount = 0;
                            //Response.CompletedAttributeCount = 0;
                        }
                        ...
                        for (var i = 0; i < TemplateNode.Childs.length; i++) {
                            var SubTotal = MyInstance.GettotalCountOfAttributeGroup(TemplateNode.Childs[i]);
                            Response.CompletedAttributeCount += SubTotal.CompletedAttributeCount;

                            if (SubTotal.TotalCount === 0) {
                    ...
                    OneViewConsole.Debug("GettotalCountOfAttributeGroup end", "LVExcludeIncludeAttributeComponent.GettotalCountOfAttributeGroup");

                } catch (Excep) {
                    throw oOneViewExceptionHandler.Create("BO", "LVExcludeIncludeAttributeComponent.GettotalCountOfAttributeGroup", Excep);
                }
                finally {
                    _oDefaultValueComponent = null;
                    DefaultValueMetaData = null;
            ...
            var IsValueExistInarray = function (value, array) {
