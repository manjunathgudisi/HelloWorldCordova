            ...
            if (ObservationList.length > 0 || $scope.CustomObservationList.length > 0) {
                ...
                if (DcId != null) {
                    ...
                    if (Status != false) {                       
                        ...
                        $scope['CorrectiveAction'].push({ Id: 1, Name: "Yes", ControlId: "chkCoorectiveAction", 'ColourIndex': 'green' });
                        $scope['CorrectiveAction'].push({ Id: 2, Name: "NO", ControlId: "chkCoorectiveAction", 'ColourIndex': 'red' });
                        oCorrectiveAction.Set({ Id: 2, Name: "NO", ControlId: "chkCoorectiveAction", 'ColourIndex': 'red' });
            ...
            if (DataCaptureClientGuid != "") {
                ...
                if (DCNCMappingResult.length > 0) {
                    ...
                    if ($scope.CustomCorrectiveActionList.length > 0) {
                        ...
                        $scope['chkCoorectiveAction'].Set({ Id: 1, Name: "Yes", ControlId: "chkCoorectiveAction", 'ColourIndex': 'green' });
                        $scope.CustomCorrectiveAction = true;
                    }
                    else {
                        $scope['chkCoorectiveAction'].Set({ Id: 2, Name: "No", ControlId: "chkCoorectiveAction", 'ColourIndex': 'red' });
                        $scope.CustomCorrectiveAction = false;
                    }
                }
            }
    ...
    var oDepartmentSelectedIndexChanged = function (EventArgs) {
        try {
            ...
            if (EventArgs != null && EventArgs.NewValue.Id != null && EventArgs.NewValue.Id > 0) {
                ...
                var oLocationddl = new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'AddlLocationControlId', 'DataSourceModelName': 'Location', 'DisplayElementModelName': 'NewDCModel.AddlLocationControlId', 'DATEntityTypeId': DATEntityType.RCOMaster_Section, 'xlatService': xlatService, 'ToasterService': '', 'IsDynamicElementCreationEnabled': false, 'MinCharToSearch': 0, 'SelectedIndexChangedEventHandler': oLocationSelectedIndexChanged, 'AttributeNodeId': 487 });
    ...
    var oLocationSelectedIndexChanged = function (EventArgs) {
        try {
            ...
            if (EventArgs != null && EventArgs.NewValue.Id != null && EventArgs.NewValue.Id > 0) {
                ...
                var oSectionddl = new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'AddlSectionControlId', 'DataSourceModelName': 'Section', 'DisplayElementModelName': 'NewDCModel.AddlSectionControlId', 'DATEntityTypeId': DATEntityType.RCOMaster_Location, 'xlatService': xlatService, 'ToasterService': '', 'IsDynamicElementCreationEnabled': false, 'MinCharToSearch': 0, 'AttributeNodeId': 488 });
