...
- (void)application:(UIApplication *)application didRegisterForRemoteNotificationsWithDeviceToken:(NSData *)deviceToken {
	...
	//NSString* myString =  [[NSString alloc] initWithData:deviceToken encoding:NSUTF8StringEncoding];
	//NSLog(@"token is: \(myString) ");
	//Backend: rest end point
}
...
- (void)application:(UIApplication *)application didFailToRegisterForRemoteNotificationsWithError:(NSError *)error {
	...
	//http://10.20.25.6:8090/OneViewQA/Service/UserProfileFacedService.svc/RegisterDeviceInfo_json
	
//	public class DeviceRegistrationDTO
//	{
//		
//		public string Brand { get; set; } //samsung, redme, iphone11, iphone12, iphoneSE
//		
//		public string CordovaVersion { get; set; } //1.0.0
//		
...
//		
//		public string Model { get; set; } //samsung, redme, iphone11, iphone12, iphoneSE
//		
