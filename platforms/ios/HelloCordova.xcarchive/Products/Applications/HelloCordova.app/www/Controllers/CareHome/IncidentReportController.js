...
MyApp.controller('IncidentReportController',
    ...
    $scope.IncidentOccurChange = function () {
        oIncidentReportFacade.IncidentOccurChange();
    }
...
function IncidentReportFacade(parm) {
    ...
    try {
        ...
        OneViewSessionStorage.Save("TemplateId", "107");
    ...
    var Loadddl = function () {
        try {
            ...
            var oUnitddl = new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'AddlUnitControlId', 'DataSourceModelName': 'Unit', 'DisplayElementModelName': 'NewDCModel.AddlUnitControlId', 'DATEntityTypeId': DATEntityType.RCOMaster_Site, 'xlatService': xlatService, 'ToasterService': '', 'IsDynamicElementCreationEnabled': false, 'MinCharToSearch': 0, 'SelectedIndexChangedEventHandler': oUnitSelectedIndexChanged, 'AttributeNodeId': 110 });
            ...
            var oObservationTypeddl = new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'AddlObservationTypeControlId', 'DataSourceModelName': 'ObservationType', 'DisplayElementModelName': 'NewDCModel.AddlObservationTypeControlId', 'DATEntityTypeId': DATEntityType.IncidentType, 'xlatService': xlatService, 'ToasterService': '', 'IsDynamicElementCreationEnabled': false, 'MinCharToSearch': 0, 'SelectedIndexChangedEventHandler': oObservationTypeSelectedIndexChanged, 'AttributeNodeId': 115 });
            ...
            var oObservationddl = new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'AddlObservationControlId', 'DataSourceModelName': 'Observation', 'DisplayElementModelName': 'NewDCModel.AddlObservationControlId', 'DATEntityTypeId': DATEntityType.IncidentMaster, 'xlatService': xlatService, 'ToasterService': '', 'IsDynamicElementCreationEnabled': false, 'MinCharToSearch': 0, 'AttributeNodeId': 116 });
            //oObservationddl.SetDataSourceWithObservationMaster(EventArgs.NewValue.Id, DATEntityType.IncidentMaster, _TableNamesEnum.OrganizationAssetsNode);
    ...
    var oUnitSelectedIndexChanged = function (EventArgs) {
        try {
            ...
            var oDepartmentddl = new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'AddlDepartmentControlId', 'DataSourceModelName': 'Department', 'DisplayElementModelName': 'NewDCModel.AddlDepartmentControlId', 'DATEntityTypeId': DATEntityType.RCOMaster_Floor, 'xlatService': xlatService, 'ToasterService': '', 'IsDynamicElementCreationEnabled': false, 'MinCharToSearch': 0, 'SelectedIndexChangedEventHandler': oDepartmentSelectedIndexChanged, 'AttributeNodeId': 111 });
            oDepartmentddl.SetDataSourceFromTreeChildsWithType(DcPlaceId, DATEntityType.RCOMaster_Floor, _TableNamesEnum.OrganizationAssetsNode);
    ...
    var oDepartmentSelectedIndexChanged = function (EventArgs) {
        try {
            ...
            if (EventArgs != null && EventArgs.NewValue.Id != null && EventArgs.NewValue.Id > 0) {
                ...
                var oLocationddl = new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'AddlLocationControlId', 'DataSourceModelName': 'Location', 'DisplayElementModelName': 'NewDCModel.AddlLocationControlId', 'DATEntityTypeId': DATEntityType.RCOMaster_Room, 'xlatService': xlatService, 'ToasterService': '', 'IsDynamicElementCreationEnabled': false, 'MinCharToSearch': 0, 'AttributeNodeId': 112 });
                oLocationddl.SetDataSourceFromTreeChildsWithType(EventArgs.NewValue.Id, DATEntityType.RCOMaster_Room, _TableNamesEnum.OrganizationAssetsNode);
                ...
                var oLocationddl = new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'AddlLocationControlId', 'DataSourceModelName': 'Location', 'DisplayElementModelName': 'NewDCModel.AddlLocationControlId', 'DATEntityTypeId': DATEntityType.RCOMaster_Room, 'xlatService': xlatService, 'ToasterService': '', 'IsDynamicElementCreationEnabled': false, 'MinCharToSearch': 0, 'AttributeNodeId': 112 });
                oLocationddl.SetDataSourceFromTreeChildsWithType(DcPlaceId, DATEntityType.RCOMaster_Room, _TableNamesEnum.OrganizationAssetsNode);
            }
    ...
    var oObservationTypeSelectedIndexChanged = function (EventArgs) {
        try {
            ...
            if (EventArgs != null && EventArgs.NewValue.Id != null && EventArgs.NewValue.Id > 0) {
                ...
                var oObservationddl = new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'AddlObservationControlId', 'DataSourceModelName': 'Observation', 'DisplayElementModelName': 'NewDCModel.AddlObservationControlId', 'DATEntityTypeId': DATEntityType.IncidentMaster, 'xlatService': xlatService, 'ToasterService': '', 'IsDynamicElementCreationEnabled': false, 'MinCharToSearch': 0, 'AttributeNodeId': 491 });
                oObservationddl.SetDataSourceWithObservationMaster(EventArgs.NewValue.Id, DATEntityType.IncidentMaster, _TableNamesEnum.OrganizationAssetsNode);

                if (DcId == null || IsFirstTimeEdit == false) {
                    oObservationddl.Clear();
                }
                ...
                //alert("ObservationList" + JSON.stringify($scope.ObservationList))
                //MyInstance.SetAutoCompleteData('Category', $scope.ObservationList);
                ...
                $scope['AddlObservationControlId'].Clear();
            }
    ...
    this.Temperature_NgKeyUp = function (AttributeId, ControlId, RefreshcontrolId, IsNc) {
        ...
        if (ControlId == "chkIncidentOccursOn") {
                var $scope = scope;               
            //alert(option.ControlId + "  -  " + JSON.stringify(option));
                //alert('chkIncidentOccursOn');
                SelectIncidentOccursOn();
    ...
    var LoadAnswerModes = function () {
        try {
            ...
            var oIncidentOccursOn = new AnswerModeUserControl({ 'Scope': $scope, 'ControlId': 'chkIncidentOccursOn', 'DataSourceModelName': 'IncidentOccursOns', 'DisplayElementModelName': 'NewDCModel.chkIncidentOccursOn' });
            oIncidentOccursOn.AnswerModes(TemplateNodes, 109);
            ...
            oRefrigeratorStatus.AnswerModes(TemplateNodes, 117);
    ...
    var SelectIncidentOccursOn = function () {
        try {
            OneViewConsole.Debug("SelectIncidentOccursOn Start", "IncidentReportFacade.SelectIncidentOccursOn");
            //alert('$scope["chkIncidentOccursOn"].GetSelectedValue()' + "----" + $scope["chkIncidentOccursOn"].GetSelectedText());
            if ($scope["chkIncidentOccursOn"].GetSelectedText() != undefined && $scope["chkIncidentOccursOn"].GetSelectedText() != "") {

                if ($scope["chkIncidentOccursOn"].GetSelectedText() == "Site") {
                    $scope.Div_AddlSiteControlId = true;

                    $scope.Div_WR = false;
                    $scope.Div_AddlFloorControlId = false;
                    $scope.Div_AddlRoomControlId = false;

                    $scope.Div_txtOtherControlId = false;
                }
                else if ($scope["chkIncidentOccursOn"].GetSelectedText() == "Floor") {
                    $scope.Div_AddlSiteControlId = true;
                    $scope.Div_WR = true;
                    $scope.Div_AddlFloorControlId = true;
                    $scope.Div_AddlRoomControlId = false;

                    $scope.Div_txtOtherControlId = false;
                }
                else if ($scope["chkIncidentOccursOn"].GetSelectedText() == "Room") {
                    $scope.Div_AddlSiteControlId = true;
                    $scope.Div_WR = true;
                    $scope.Div_AddlFloorControlId = true;
                    $scope.Div_AddlRoomControlId = true;

                    $scope.Div_txtOtherControlId = false;
                }
                else if ($scope["chkIncidentOccursOn"].GetSelectedText() == "Other") {
                    $scope.Div_txtOtherControlId = true;

                    $scope.Div_AddlSiteControlId = false;
                    $scope.Div_WR = false;
                    $scope.Div_AddlFloorControlId = false;
                    $scope.Div_AddlRoomControlId = false;
                }
            ...
            OneViewConsole.Debug("SelectIncidentOccursOn End", "IncidentReportFacade.SelectIncidentOccursOn");
        }
        catch (Excep) {
            throw Excep;
        }
    ...
    var LoadIncidentOccursOn = function () {
        try {
            OneViewConsole.Debug("LoadIncidentOccursOn Start", "IncidentReportFacade.LoadIncidentOccursOn");
            //alert('$scope["chkIncidentOccursOn"].GetSelectedValue()' + $scope["chkIncidentOccursOn"].GetSelectedValue() + "----" + $scope["chkIncidentOccursOn"].GetSelectedText());
            if ($scope["chkIncidentOccursOn"].GetSelectedValue() != undefined && $scope["chkIncidentOccursOn"].GetSelectedValue() != "") {
                
                if ($scope["chkIncidentOccursOn"].GetSelectedValue() == "Site") {
                    $scope.Div_AddlSiteControlId = true;
                ...
                else if ($scope["chkIncidentOccursOn"].GetSelectedValue() == "Floor") {
                    $scope.Div_AddlSiteControlId = true;
                    $scope.Div_WR = true;
                    $scope.Div_AddlFloorControlId = true;
                    $scope.Div_AddlRoomControlId = false;
                ...
                else if ($scope["chkIncidentOccursOn"].GetSelectedValue() == "Room") {
                    $scope.Div_AddlSiteControlId = true;
                    $scope.Div_WR = true;
                    $scope.Div_AddlFloorControlId = true;
                    $scope.Div_AddlRoomControlId = true;
                ...
                else if ($scope["chkIncidentOccursOn"].GetSelectedValue() == "Other") {
                    $scope.Div_txtOtherControlId = true;
            ...
            OneViewConsole.Debug("LoadIncidentOccursOn End", "IncidentReportFacade.LoadIncidentOccursOn");
        }
        catch (Excep) {
            throw Excep;
        }
    ...
    this.IncidentOccurChange = function () {
        try {

            OneViewConsole.Debug("IncidentOccurChange Start", "IncidentReportFacade.IncidentOccurChange");

            //alert("You selected :" + $scope.DDlIncidentOccursOn.id);

            if ($scope.DDlIncidentOccursOn.id == "Site") {
                $scope.Div_AddlSiteControlId = true;
            ...
            else if ($scope.DDlIncidentOccursOn.id == "Floor") {
                $scope.Div_AddlSiteControlId = true;
                $scope.Div_WR = true;
                $scope.Div_AddlFloorControlId = true;
                $scope.Div_AddlRoomControlId = false;
            ...
            else if ($scope.DDlIncidentOccursOn.id == "Room") {
                $scope.Div_AddlSiteControlId = true;
                $scope.Div_WR = true;
                $scope.Div_AddlFloorControlId = true;
                $scope.Div_AddlRoomControlId = true;
            ...
            else if ($scope.DDlIncidentOccursOn.id == "Other") {
                $scope.Div_txtOtherControlId = true;
            ...
            OneViewConsole.Debug("IncidentOccurChange End", "IncidentReportFacade.IncidentOccurChange");
    ...
    var LoadObservation_Edit = function (DCId) {
