...
MyApp.controller('VictoryEquipmentSanitizerEKFC1Controller',
	...
	var oVictoryEquipmentSanitizerEKFC1ControllerFacade = new VictoryEquipmentSanitizerEKFC1ControllerFacade({ 'scope': $scope, 'document': $document, 'Mylocation': $location, 'xlatService': xlatService, 'toaster': '', 'SpinService': '', 'compile': $compile, '$timeout': $timeout });

    oVictoryEquipmentSanitizerEKFC1ControllerFacade.Init();
    oVictoryEquipmentSanitizerEKFC1ControllerFacade.PageLoad();
	//oSetDefaultSpinner.Stop();
  
    $scope.ngChange_setIsManualFlag = function (ControlId) {
        oVictoryEquipmentSanitizerEKFC1ControllerFacade.ngChange_setIsManualFlag(ControlId);
    }
    ...
    $scope.GetProbeStatus = function () {
        oVictoryEquipmentSanitizerEKFC1ControllerFacade.GetProbeStatus();
    };

    $scope.AddRecords = function () {
        oVictoryEquipmentSanitizerEKFC1ControllerFacade.SaveDCRecords();
    };
    
    $scope.SetSelectedTextBoxColor = function (ControlId) {
        oVictoryEquipmentSanitizerEKFC1ControllerFacade.SetSelectedTextBoxColor(ControlId);
    };
    ...
    $scope.SetAutoTemperatureListener = function (EventArg, TimeModelId) {
        oVictoryEquipmentSanitizerEKFC1ControllerFacade.SetAutoTemperatureListener(EventArg, TimeModelId);
    };
    ...
    ////    oVictoryEquipmentSanitizerEKFC1ControllerFacade.Temperature_NgKeyUp(AttributeId, ControlId, RefreshcontrolId, IsNc);
        ////}
    ...
    $scope.Temperature_NgKeyUp = function (AttributeId, ControlId, RefreshcontrolId, IsNc, RefreshAttributeId) {
        ...
        lastTimeOutId = $timeout(function () { oVictoryEquipmentSanitizerEKFC1ControllerFacade.Temperature_NgKeyUp(AttributeId, ControlId, RefreshcontrolId, IsNc, RefreshAttributeId); }, Timeout);
    }
    ...
    $scope.ClearForm = function () {
        oVictoryEquipmentSanitizerEKFC1ControllerFacade.ClearForm();
    }
    $scope.$on('$destroy', function () {
        ...
        scope = null;
        ionicBackdrop = null;
        oVictoryEquipmentSanitizerEKFC1ControllerFacade = null;
        $scope = null;
    });

    $scope.PreControlEvents = function (AttributeId, ControlId, $event) {
        oVictoryEquipmentSanitizerEKFC1ControllerFacade.PreControlEvents(AttributeId, ControlId, $event);
    }

    $scope.PostControlEvents = function (AttributeId, ControlId) {

        oVictoryEquipmentSanitizerEKFC1ControllerFacade.PostControlEvents(AttributeId, ControlId);
    }

    $scope.ngChange_setDateTime = function (ControlId) {
        oVictoryEquipmentSanitizerEKFC1ControllerFacade.ngChange_setDateTime(ControlId);
    }

    $scope.SubmitRecords = function () {
        oVictoryEquipmentSanitizerEKFC1ControllerFacade.SaveDCRecords(true);
    }



    $scope.CustomNCClick = function () {
        oVictoryEquipmentSanitizerEKFC1ControllerFacade.CustomNCClick();
    }

    $scope.NCClick = function () {
        oVictoryEquipmentSanitizerEKFC1ControllerFacade.NCClick($compile);
    }

    $scope.ObservationTabClick = function () {
        oVictoryEquipmentSanitizerEKFC1ControllerFacade.ObservationTabClick($compile);
    }

    $scope.NCTabClick = function () {
        oVictoryEquipmentSanitizerEKFC1ControllerFacade.NCTabClick($compile);
    }

    $scope.CloseRightPanel = function () {
        oVictoryEquipmentSanitizerEKFC1ControllerFacade.CloseRightPanel();
    }

    $scope.ProbeTesting = function () {
        oVictoryEquipmentSanitizerEKFC1ControllerFacade.ProbeTesting();
    };
        
    $scope.ClearReasons = function () {
        oVictoryEquipmentSanitizerEKFC1ControllerFacade.ClearReasons();
    }

    $scope.ClearComments = function () {
        oVictoryEquipmentSanitizerEKFC1ControllerFacade.ClearComments();
    }
...
function VictoryEquipmentSanitizerEKFC1ControllerFacade(parm) {

    try {
        OneViewConsole.Debug("VictoryEquipmentSanitizerEKFC1ControllerFacade Start", "Facade.VictoryEquipmentSanitizerEKFC1ControllerFacade");
      ...
      //  var _oNCComponent = new NCComponent($scope, TemplateNodes, '', xlatService);
        ...
        OneViewConsole.Debug("VictoryEquipmentSanitizerEKFC1ControllerFacade End", "Facade.VictoryEquipmentSanitizerEKFC1ControllerFacade");
    }
    catch (Excep) {
        oOneViewExceptionHandler.Catch(Excep, "Facade.VictoryEquipmentSanitizerEKFC1ControllerFacade", xlatService);
    }

        this.Init = function () {
            try {
                OneViewConsole.Debug("Init Start", "VictoryEquipmentSanitizerEKFC1ControllerFacade.Init");
                    ...
                    OneViewConsole.Debug("Init End", "VictoryEquipmentSanitizerEKFC1ControllerFacade.Init");
            }

            catch (Excep) {
                oOneViewExceptionHandler.Catch(Excep, "VictoryEquipmentSanitizerEKFC1ControllerFacade.Init", xlatService);
            }
        }

        this.ngChange_setIsManualFlag = function (ControlId) {
            try {
                OneViewConsole.Debug("ngChange_setIsManualFlag Start", "VictoryEquipmentSanitizerEKFC1ControllerFacade.ngChange_setIsManualFlag");

                _oDataCaptureBO.setIsManualFlag(ControlId);

                OneViewConsole.Debug("ngChange_setIsManualFlag End", "VictoryEquipmentSanitizerEKFC1ControllerFacade.ngChange_setIsManualFlag");
            }
            catch (Excep) {
                oOneViewExceptionHandler.Catch(Excep, "VictoryEquipmentSanitizerEKFC1ControllerFacade.ngChange_setIsManualFlag", xlatService);
            }
        ...
        this.PageLoad = function () {
            try {
                OneViewConsole.Debug("PageLoad Start", "VictoryEquipmentSanitizerEKFC1ControllerFacade.PageLoad");
                   ...
                   // _oNCComponent.BindNCSummaryHandler = BindNc;
                    ...
                    OneViewConsole.Debug("PageLoad End", "VictoryEquipmentSanitizerEKFC1ControllerFacade.PageLoad");
            }

            catch (Excep) {
                oOneViewExceptionHandler.Catch(Excep, "VictoryEquipmentSanitizerEKFC1ControllerFacade.PageLoad", xlatService);
            }
        }

        this.SetSelectedTextBoxColor = function (ControlId) {
            try {
                OneViewConsole.Debug("SetSelectedTextBoxColor Start", "VictoryEquipmentSanitizerEKFC1ControllerFacade.SetSelectedTextBoxColor");

                SetSelectedTextBoxColor_Private(ControlId);

                OneViewConsole.Debug("SetSelectedTextBoxColor End", "VictoryEquipmentSanitizerEKFC1ControllerFacade.SetSelectedTextBoxColor");
            }
            catch (Excep) {
                oOneViewExceptionHandler.Catch(Excep, "VictoryEquipmentSanitizerEKFC1ControllerFacade.SetSelectedTextBoxColor", xlatService);
            }
        }

        var SetSelectedTextBoxColor_Private = function (ControlId) {
            try {
                OneViewConsole.Debug("SetSelectedTextBoxColor_Private Start", "VictoryEquipmentSanitizerEKFC1ControllerFacade.SetSelectedTextBoxColor_Private");

                if (ControlId == 'txtTempControlId') {
                    $scope.txtTempControlId = 'highlight';
                }

                OneViewConsole.Debug("SetSelectedTextBoxColor_Private End", "VictoryEquipmentSanitizerEKFC1ControllerFacade.SetSelectedTextBoxColor_Private");
            }
            catch (Excep) {
                throw Excep;
            }
        ...
        var BindNc = function (NcStatus, objRule, AttributeId, ControlId) {
            try {
                OneViewConsole.Debug("BindNc Start", "VictoryEquipmentSanitizerEKFC1ControllerFacade.BindNc");
                    ...
                    OneViewConsole.Debug("BindNc End", "VictoryEquipmentSanitizerEKFC1ControllerFacade.BindNc");
            }
            catch (Excep) {
                throw Excep;
            }
        ...
        this.GetProbeStatus = function () {
            try {
                OneViewConsole.Debug("GetProbeStatus Start", "VictoryEquipmentSanitizerEKFC1ControllerFacade.GetProbeStatus");
                               
                _oSettingsBO.ProbeStatus('', xlatService);

                OneViewConsole.Debug("GetProbeStatus End", "VictoryEquipmentSanitizerEKFC1ControllerFacade.GetProbeStatus");

            }
            catch (Excep) {
                oOneViewExceptionHandler.Catch(Excep, "VictoryEquipmentSanitizerEKFC1ControllerFacade.GetProbeStatus", xlatService);
            }
        }

        this.SetAutoTemperatureListener = function (EventArg, TimeControlId) {
            try {
                OneViewConsole.Debug("SetAutoTemperatureListener Start", "VictoryEquipmentSanitizerEKFC1ControllerFacade.SetAutoTemperatureListener");
                ...
                OneViewConsole.Debug("SetAutoTemperatureListener End", "VictoryEquipmentSanitizerEKFC1ControllerFacade.SetAutoTemperatureListener");
            }
            catch (Excep) {
                oOneViewExceptionHandler.Catch(Excep, "VictoryEquipmentSanitizerEKFC1ControllerFacade.SetAutoTemperatureListener", xlatService);
            }
            finally {
                modelName = null;
            }
        ...
        this.SaveDCRecords = function (IsSubmit) {
            oSetDefaultSpinner.Start();
            try {
                OneViewConsole.Debug("SaveDCRecords Start", "VictoryEquipmentSanitizerEKFC1ControllerFacade.SaveDCRecords");
                ...
                OneViewConsole.Debug("SaveDCRecords End", "VictoryEquipmentSanitizerEKFC1ControllerFacade.SaveDCRecords");
            }
            catch (Excep) {
                oOneViewExceptionHandler.Catch(Excep, "VictoryEquipmentSanitizerEKFC1ControllerFacade.SaveDCRecords", xlatService);
            }
            finally {
                Status = null;
            }
        ...
        this.Temperature_NgKeyUp = function (AttributeId, ControlId, RefreshcontrolId, IsNc, RefreshAttributeId) {
            try {
                OneViewConsole.Debug("Temperature_NgKeyUp Start", "VictoryEquipmentSanitizerEKFC1ControllerFacade.Temperature_NgKeyUp");
                ...
                OneViewConsole.Debug("Temperature_NgKeyUp End", "VictoryEquipmentSanitizerEKFC1ControllerFacade.Temperature_NgKeyUp");
            }
            catch (Excep) {
                $scope.DisableSave = false;
                $scope.DisableSaveSubmit = false;
                oOneViewExceptionHandler.Catch(Excep, "VictoryEquipmentSanitizerEKFC1ControllerFacade.Temperature_NgKeyUp", xlatService);
            }
            finally {
                oDataCaptureBO = null;
            }
        ...
        var ValidateActionNC = function (AttributeId, ControlId) {
            try {
                ...
                OneViewConsole.Debug("ValidateActionNC Start", "VictoryEquipmentSanitizerEKFC1ControllerFacade.ValidateActionNC");
                var ActionResponseList = EvaluateActionNCStatus(AttributeId);
                ...
                OneViewConsole.Debug("ValidateActionNC End", "VictoryEquipmentSanitizerEKFC1ControllerFacade.ValidateActionNC");
            }
            catch (Excep) {
                throw Excep;
            }
        ...
        this.CheckActionNCEvent = function (AttributeId, ControlId, RefreshcontrolId) {
            try {
                ...
                OneViewConsole.Debug("CheckActionNCEvent Start", "VictoryEquipmentSanitizerEKFC1ControllerFacade.CheckActionNCEvent");
                ValidateActionNC(AttributeId, ControlId);
                OneViewConsole.Debug("CheckActionNCEvent End", "VictoryEquipmentSanitizerEKFC1ControllerFacade.CheckActionNCEvent");
            }
            catch (Excep) {
                oOneViewExceptionHandler.Catch(Excep, "VictoryEquipmentSanitizerEKFC1ControllerFacade.CheckActionNCEvent", xlatService);
            }
            finally {
                oDataCaptureBO = null;
            }
        ...
        var EvaluateActionNCStatus = function (AttributeId) {
            try {
                OneViewConsole.Debug("ShowNCStatus Start", "VictoryEquipmentSanitizerEKFC1ControllerFacade.EvaluateActionNCStatus");
                var ActionResponseList = _oDataCaptureBO.EvaluateActionNCStatus(AttributeId);
                return ActionResponseList;
                OneViewConsole.Debug("ShowNCStatus End", "VictoryEquipmentSanitizerEKFC1ControllerFacade.EvaluateActionNCStatus");
            }
            catch (Excep) {
                throw Excep;
            }
        ...
        this.ShowNCFormAction = function (ControlId) {
            try {
                OneViewConsole.Debug("ShowNCFormAction Start", "VictoryEquipmentSanitizerEKFC1ControllerFacade.ShowNCFormAction");
                ...
                OneViewConsole.Debug("ShowNCFormAction End", "VictoryEquipmentSanitizerEKFC1ControllerFacade.ShowNCFormAction");
            }
            catch (Excep) {
                oOneViewExceptionHandler.Catch(Excep, "VictoryEquipmentSanitizerEKFC1ControllerFacade.ShowNCFormAction", xlatService);
            }
            finally {
        ...
        var LoadAnswerModes = function () {
            try {
                OneViewConsole.Debug("LoadAnswerModes Start", "VictoryEquipmentSanitizerEKFC1ControllerFacade.LoadAnswerModes");
                ...
                oThermometerStatus.AnswerModes(TemplateNodes, 11598);
                ...
                OneViewConsole.Debug("LoadAnswerModes End", "VictoryEquipmentSanitizerEKFC1ControllerFacade.LoadAnswerModes");
            }
            catch (Excep) {
                throw Excep;
            }
        ...
        var CreateDynamicElements = function (_DcResultDetailsEntityLst) {
            try {
                ...
                OneViewConsole.Debug("CreateDynamicElements Start", "VictoryEquipmentSanitizerEKFC1ControllerFacade.CreateDynamicElements");
                ...
                OneViewConsole.Debug("CreateDynamicElements End", "VictoryEquipmentSanitizerEKFC1ControllerFacade.CreateDynamicElements");
            }
            catch (Excep) {
        ...
        var ShowNCStatusOLD = function (AttributeId, ControlId) {
            try {
                OneViewConsole.Debug("ShowNCStatus Start", "VictoryEquipmentSanitizerEKFC1ControllerFacade.ShowNCStatus");
                ...
                OneViewConsole.Debug("ShowNCStatus End", "VictoryEquipmentSanitizerEKFC1ControllerFacade.ShowNCStatus");
            }
            catch (Excep) {
                throw Excep;
            }
        ...
        this.ClearForm = function () {
            try {
                OneViewConsole.Debug("ClearForm Start", "VictoryEquipmentSanitizerEKFC1ControllerFacade.ClearForm");
                ...
                OneViewConsole.Debug("ClearForm End", "VictoryEquipmentSanitizerEKFC1ControllerFacade.ClearForm");
            }
            catch (Excep) {
                oOneViewExceptionHandler.Catch(Excep, "VictoryEquipmentSanitizerEKFC1ControllerFacade.ClearForm", xlatService);
            }
        }

        var IsNCthereOrNot = function (RuleId, isNC) {
            try {
                OneViewConsole.Debug("IsNCthereOrNot Start", "VictoryEquipmentSanitizerEKFC1ControllerFacade.IsNCthereOrNot");
                ...
                OneViewConsole.Debug("IsNCthereOrNot End", "VictoryEquipmentSanitizerEKFC1ControllerFacade.IsNCthereOrNot");
                return ExistStatus;
            }
            catch (Excep) {
                throw Excep;
        ...
        var NormalizeNCEntityListData = function (DCNCMappingListData) {
            try {
                OneViewConsole.Debug("NormalizeNCEntityListData Start", "VictoryEquipmentSanitizerEKFC1ControllerFacade.NormalizeNCEntityListData");
                ...
                OneViewConsole.Debug("NormalizeNCEntityListData End", "VictoryEquipmentSanitizerEKFC1ControllerFacade.NormalizeNCEntityListData");
            }
            catch (Excep) {
                throw Excep;
            }
        ...
        this.PreControlEvents = function (AttributeId, ControlId, $event) {
            try {
                ...
                oOneViewExceptionHandler.Catch(Excep, "VictoryEquipmentSanitizerEKFC1ControllerFacade.PreControlEvents", xlatService);
            }
        }
        ...
        this.ngChange_setDateTime = function (ControlId) {
            try {
                ...
                oOneViewExceptionHandler.Catch(Excep, "VictoryEquipmentSanitizerEKFC1ControllerFacade.ngChange_setDateTime", xlatService);
            }
        }
        ...
        this.NCClick = function ($compile) {
            ...
            try {
                ...
                oOneViewExceptionHandler.Catch(Excep, "VictoryEquipmentSanitizerEKFC1ControllerFacade.NgKeyUp", xlatService);
            }
            finally {
            }
        }
        ...
        this.NCTabClick = function ($compile) {
            ...
            try {
                ...
                oOneViewExceptionHandler.Catch(Excep, "VictoryEquipmentSanitizerEKFC1ControllerFacade.AppendNCHtml", xlatService);
            }
            finally {
            }
        }
        ...
        this.ObservationTabClick = function ($compile) {
            ...
            try {
                ...
                oOneViewExceptionHandler.Catch(Excep, "VictoryEquipmentSanitizerEKFC1ControllerFacade.AppendObservationHtml", xlatService);
            }
            finally {
            }
        }
        ...
        this.CustomNCClick = function () {
            ...
            try {
                ...
                oOneViewExceptionHandler.Catch(Excep, "VictoryEquipmentSanitizerEKFC1ControllerFacade.CustomNCClick", xlatService);
            }
            finally {
            }
        }
        ...
        this.ClearReasons = function () {
            try {
                ...
                oOneViewExceptionHandler.Catch(Excep, "VictoryEquipmentSanitizerEKFC1ControllerFacade.ClearReasons", xlatService);
            }
        }
