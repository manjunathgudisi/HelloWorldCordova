...
MyApp.controller('DispatchTemperatureVerification',
    function ($scope, $document, xlatService, $timeout, $location, $templateCache, snapRemote, $compile) {
    //oSetDefaultSpinner.Start();
        // xlatService.setCurrentPage('DispatchTemperatureVerification');
	...
	var oDispatchTemperatureVerification = new DispatchTemperatureVerificationFacade({ 'scope': $scope, 'document': $document, 'Mylocation': $location, 'xlatService': xlatService, 'toaster': '', 'SpinService': '', 'compile': $compile, '$timeout': $timeout });

    oDispatchTemperatureVerification.Init();
    oDispatchTemperatureVerification.PageLoad();
	//oSetDefaultSpinner.Stop();
  
    $scope.ngChange_setIsManualFlag = function (ControlId) {
        oDispatchTemperatureVerification.ngChange_setIsManualFlag(ControlId);
    }

    $scope.$on('$destroy', function () {
        var oOneViewSidePanel = new OneViewSidePanel();
        oOneViewSidePanel.Clear();
        oDispatchTemperatureVerification.Destroy();

        xlatService.RemoveCurrentPageMetadata(currentPage);
    });

    $scope.GetProbeStatus = function () {
        oDispatchTemperatureVerification.GetProbeStatus();
    };

    $scope.AddRecords = function () {
        oDispatchTemperatureVerification.SaveDCRecords();
    };
    
    $scope.SetSelectedTextBoxColor = function (ControlId) {
        oDispatchTemperatureVerification.SetSelectedTextBoxColor(ControlId);
    };
    ...
    $scope.SetAutoTemperatureListener = function (EventArg, TimeModelId) {
        oDispatchTemperatureVerification.SetAutoTemperatureListener(EventArg, TimeModelId);
    };
    ...
    ////    oDispatchTemperatureVerification.Temperature_NgKeyUp(AttributeId, ControlId, RefreshcontrolId, IsNc);
        ////}
    ...
    $scope.Temperature_NgKeyUp = function (AttributeId, ControlId, RefreshcontrolId, IsNc) {
        ...
        lastTimeOutId = $timeout(function () { oDispatchTemperatureVerification.Temperature_NgKeyUp(AttributeId, ControlId, RefreshcontrolId, IsNc); }, Timeout);
    }
    ...
    $scope.ClearForm = function () {
        oDispatchTemperatureVerification.ClearForm();
    }
    $scope.$on('$destroy', function () {
        ...
        scope = null;
        ionicBackdrop = null;
        oDispatchTemperatureVerification = null;
        $scope = null;
    });

    $scope.PreControlEvents = function (AttributeId, ControlId, $event) {
        oDispatchTemperatureVerification.PreControlEvents(AttributeId, ControlId, $event);
    }

    $scope.PostControlEvents = function (AttributeId, ControlId) {

        oDispatchTemperatureVerification.PostControlEvents(AttributeId, ControlId);
    }

    $scope.ngChange_setDateTime = function (ControlId) {
        oDispatchTemperatureVerification.ngChange_setDateTime(ControlId);
    }

    $scope.SubmitRecords = function () {
        oDispatchTemperatureVerification.SaveDCRecords(true);
    }



    $scope.CustomNCClick = function () {
        oDispatchTemperatureVerification.CustomNCClick();
    }

    $scope.NCClick = function () {
        oDispatchTemperatureVerification.NCClick($compile);
    }

    $scope.ObservationTabClick = function () {
        oDispatchTemperatureVerification.ObservationTabClick($compile);
    }

    $scope.NCTabClick = function () {
        oDispatchTemperatureVerification.NCTabClick($compile);
    }

    $scope.CloseRightPanel = function () {
        oDispatchTemperatureVerification.CloseRightPanel();
    }

    $scope.ProbeTesting = function () {
        oDispatchTemperatureVerification.ProbeTesting();
    };
    $scope.ClearReasons = function () {
        oDispatchTemperatureVerification.ClearReasons();
    }

    $scope.ClearComments = function () {
        oDispatchTemperatureVerification.ClearComments();
    }
...
function DispatchTemperatureVerificationFacade(parm) {

    try {
        OneViewConsole.Debug("oDispatchTemperatureVerification Start", "Facade.ThawingVerificationFacade");
      ...
      //  var _oNCComponent = new NCComponent($scope, TemplateNodes, '', xlatService);
        ...
        OneViewConsole.Debug("oDispatchTemperatureVerification End", "Facade.ThawingVerificationFacade");
    }
    catch (Excep) {
        oOneViewExceptionHandler.Catch(Excep, "Facade.oDispatchTemperatureVerification", xlatService);
    }

        this.Init = function () {
            try {
                OneViewConsole.Debug("Init Start", "oDispatchTemperatureVerification.Init");
                ...
                OneViewConsole.Debug("Init End", "oDispatchTemperatureVerification.Init");
            }

            catch (Excep) {
                oOneViewExceptionHandler.Catch(Excep, "oDispatchTemperatureVerification.Init", xlatService);
            }
        }

        this.ngChange_setIsManualFlag = function (ControlId) {
            try {
                OneViewConsole.Debug("ngChange_setIsManualFlag Start", "oDispatchTemperatureVerification.ngChange_setIsManualFlag");

                _oDataCaptureBO.setIsManualFlag(ControlId);

                OneViewConsole.Debug("ngChange_setIsManualFlag End", "oDispatchTemperatureVerification.ngChange_setIsManualFlag");
            }
            catch (Excep) {
                oOneViewExceptionHandler.Catch(Excep, "oDispatchTemperatureVerification.ngChange_setIsManualFlag", xlatService);
            }
        ...
        this.PageLoad = function () {
            try {
                OneViewConsole.Debug("PageLoad Start", "oDispatchTemperatureVerification.PageLoad");
                   ...
                   // todo : check with pallav and solve document,getelementbyid page load issue
                    ...
                    _oDataCaptureBO.ModelIdForAutoTemperatureUpdation = 'NewDCModel.ATLoadingTempControlId';
                    _oDataCaptureBO.ModelIdForAutoTimeUpdation = 'NewDCModel.DTLoadingTimeControlId';
                   // _oNCComponent.Init();
                    _oCPActionNCComponent.Init();

                    SetSelectedTextBoxColor_Private('ATLoadingTempControlId');
                ...
                OneViewConsole.Debug("PageLoad End", "oDispatchTemperatureVerification.PageLoad");
            }

            catch (Excep) {
                oOneViewExceptionHandler.Catch(Excep, "oDispatchTemperatureVerification.PageLoad", xlatService);
            }
        }

        this.SetSelectedTextBoxColor = function (ControlId) {
            try {
                OneViewConsole.Debug("SetSelectedTextBoxColor Start", "oDispatchTemperatureVerification.SetSelectedTextBoxColor");

                SetSelectedTextBoxColor_Private(ControlId);

                OneViewConsole.Debug("SetSelectedTextBoxColor End", "oDispatchTemperatureVerification.SetSelectedTextBoxColor");
            }
            catch (Excep) {
                oOneViewExceptionHandler.Catch(Excep, "oDispatchTemperatureVerification.SetSelectedTextBoxColor", xlatService);
            }
        }

        var SetSelectedTextBoxColor_Private = function (ControlId) {
            try {
                OneViewConsole.Debug("SetSelectedTextBoxColor_Private Start", "oDispatchTemperatureVerification.SetSelectedTextBoxColor_Private");

                if (ControlId == 'ATLoadingTempControlId') {
                    $scope.ATLoadingTempControlId = 'highlight';
                    $scope.ATVehicleTempControlId = '';
                    $scope.ATOffLoadingTempControlId = '';
                }
                else if (ControlId == 'ATVehicleTempControlId') {
                    $scope.ATLoadingTempControlId = '';
                    $scope.ATVehicleTempControlId = 'highlight';
                    $scope.ATOffLoadingTempControlId = '';
                }
                else if (ControlId == 'ATOffLoadingTempControlId') {
                    $scope.ATLoadingTempControlId = '';
                    $scope.ATVehicleTempControlId = '';
                    $scope.ATOffLoadingTempControlId = 'highlight';
                }

                OneViewConsole.Debug("SetSelectedTextBoxColor_Private End", "oDispatchTemperatureVerification.SetSelectedTextBoxColor_Private");
            }
            catch (Excep) {
                throw Excep;
            }
        ...
        var BindNc = function (NcStatus, objRule, AttributeId, ControlId) {
            try {
                OneViewConsole.Debug("BindNc Start", "oDispatchTemperatureVerification.BindNc");
                ...
                OneViewConsole.Debug("BindNc End", "oDispatchTemperatureVerification.BindNc");
            }
            catch (Excep) {
                throw Excep;
            }
        ...
        this.GetProbeStatus = function () {
            try {
                OneViewConsole.Debug("GetProbeStatus Start", "oDispatchTemperatureVerification.GetProbeStatus");
                               
                _oSettingsBO.ProbeStatus('', xlatService);

                OneViewConsole.Debug("GetProbeStatus End", "oDispatchTemperatureVerification.GetProbeStatus");

            }
            catch (Excep) {
                oOneViewExceptionHandler.Catch(Excep, "oDispatchTemperatureVerification.GetProbeStatus", xlatService);
            }
        }

        this.SetAutoTemperatureListener = function (EventArg, TimeControlId) {
            try {
                OneViewConsole.Debug("SetAutoTemperatureListener Start", "oDispatchTemperatureVerification.SetAutoTemperatureListener");
                ...
                OneViewConsole.Debug("SetAutoTemperatureListener End", "oDispatchTemperatureVerification.SetAutoTemperatureListener");
            }
            catch (Excep) {
                oOneViewExceptionHandler.Catch(Excep, "oDispatchTemperatureVerification.SetAutoTemperatureListener", xlatService);
            }
            finally {
                modelName = null;
            }
        ...
        this.SaveDCRecords = function (IsSubmit) {
            oSetDefaultSpinner.Start();
            try {
                OneViewConsole.Debug("SaveDCRecords Start", "oDispatchTemperatureVerification.SaveDCRecords");
                ...
                OneViewConsole.Debug("SaveDCRecords End", "oDispatchTemperatureVerification.SaveDCRecords");
            }
            catch (Excep) {
                oOneViewExceptionHandler.Catch(Excep, "oDispatchTemperatureVerification.SaveDCRecords", xlatService);
            }
            finally {
                Status = null;
            }
        ...
        var Loadddl = function () {
            try {
                ...
                OneViewConsole.Debug("Loadddl Start", "oDispatchTemperatureVerification.Loadddl");

                OneViewAdvAutoCompleteEvent = OneViewAdvAutoCompleteClick;
                AutoCompleteCloseEvent = AutoCompleteCloseClick;

                var oLocationddl = new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'AddlLocation', 'DataSourceModelName': 'Location', 'DisplayElementModelName': 'NewDCModel.AddlLocation', 'DATEntityTypeId': DATEntityType.RCOMaster_Location, 'xlatService': xlatService, 'ToasterService': '', 'AttributeNodeId': 465 });
                ...
                OneViewConsole.Debug("Loadddl End", "oDispatchTemperatureVerification.Loadddl");
            }
            catch (Excep) {
                throw Excep;
            }
        ...
        this.Temperature_NgKeyUp = function (AttributeId, ControlId, RefreshcontrolId, IsNc, RefreshAttributeId) {
            try {
                OneViewConsole.Debug("Temperature_NgKeyUp Start", "oDispatchTemperatureVerification.Temperature_NgKeyUp");
                ...
                OneViewConsole.Debug("Temperature_NgKeyUp End", "oDispatchTemperatureVerification.Temperature_NgKeyUp");
            }
            catch (Excep) {
                $scope.DisableSave = false;
                $scope.DisableSaveSubmit = false;
                oOneViewExceptionHandler.Catch(Excep, "oDispatchTemperatureVerification.Temperature_NgKeyUp", xlatService);
            }
            finally {
                oDataCaptureBO = null;
            }
        ...
        var ValidateActionNC = function (AttributeId, ControlId) {
            try {
                ...
                OneViewConsole.Debug("ValidateActionNC Start", "oDispatchTemperatureVerification.ValidateActionNC");
                var ActionResponseList = EvaluateActionNCStatus(AttributeId);
                ...
                OneViewConsole.Debug("ValidateActionNC End", "oDispatchTemperatureVerification.ValidateActionNC");
            }
            catch (Excep) {
                throw Excep;
            }
        ...
        this.CheckActionNCEvent = function (AttributeId, ControlId, RefreshcontrolId) {
            try {
                ...
                OneViewConsole.Debug("CheckActionNCEvent Start", "oDispatchTemperatureVerification.CheckActionNCEvent");
                ValidateActionNC(AttributeId, ControlId);
                OneViewConsole.Debug("CheckActionNCEvent End", "oDispatchTemperatureVerification.CheckActionNCEvent");
            }
            catch (Excep) {
                oOneViewExceptionHandler.Catch(Excep, "oDispatchTemperatureVerification.CheckActionNCEvent", xlatService);
            }
            finally {
                oDataCaptureBO = null;
            }
        ...
        var EvaluateActionNCStatus = function (AttributeId) {
            try {
                OneViewConsole.Debug("ShowNCStatus Start", "oDispatchTemperatureVerification.EvaluateActionNCStatus");
                var ActionResponseList = _oDataCaptureBO.EvaluateActionNCStatus(AttributeId);
                return ActionResponseList;
                OneViewConsole.Debug("ShowNCStatus End", "oDispatchTemperatureVerification.EvaluateActionNCStatus");
            }
            catch (Excep) {
                throw Excep;
            }
        ...
        this.ShowNCFormAction = function (ControlId) {
            try {
                OneViewConsole.Debug("ShowNCFormAction Start", "oDispatchTemperatureVerification.ShowNCFormAction");
                ...
                OneViewConsole.Debug("ShowNCFormAction End", "oDispatchTemperatureVerification.ShowNCFormAction");
            }
            catch (Excep) {
                oOneViewExceptionHandler.Catch(Excep, "oDispatchTemperatureVerification.ShowNCFormAction", xlatService);
            }
            finally {
        ...
        var LoadAnswerModes = function () {
            try {
                OneViewConsole.Debug("LoadAnswerModes Start", "oDispatchTemperatureVerification.LoadAnswerModes");

                AnswerModeNCActionEvent = OnAnswerModeSelect;

                var oMeals = new AnswerModeUserControl({ 'Scope': $scope, 'ControlId': 'chkRefrigerationStatus', 'DataSourceModelName': 'WorkingStatus', 'DisplayElementModelName': 'NewDCModel.chkRefrigerationStatus' });
                oMeals.AnswerModes(TemplateNodes, 458);
                ...
                OneViewConsole.Debug("LoadAnswerModes End", "oDispatchTemperatureVerification.LoadAnswerModes");
            }
            catch (Excep) {
                throw Excep;
            }
        ...
        var CreateDynamicElements = function (_DcResultDetailsEntityLst) {
            try {
                ...
                OneViewConsole.Debug("CreateDynamicElements Start", "oDispatchTemperatureVerification.CreateDynamicElements");
                ...
                OneViewConsole.Debug("CreateDynamicElements End", "oDispatchTemperatureVerification.CreateDynamicElements");
            }
            catch (Excep) {
        ...
        var ShowNCStatusOLD = function (AttributeId, ControlId) {
            try {
                OneViewConsole.Debug("ShowNCStatus Start", "oDispatchTemperatureVerification.ShowNCStatus");
                ...
                OneViewConsole.Debug("ShowNCStatus End", "oDispatchTemperatureVerification.ShowNCStatus");
            }
            catch (Excep) {
                throw Excep;
            }
        ...
        this.ClearForm = function () {
            try {
                OneViewConsole.Debug("ClearForm Start", "oDispatchTemperatureVerification.ClearForm");
                ...
                OneViewConsole.Debug("ClearForm End", "oDispatchTemperatureVerification.ClearForm");
            }
            catch (Excep) {
                oOneViewExceptionHandler.Catch(Excep, "oDispatchTemperatureVerification.ClearForm", xlatService);
            }
        }

        var IsNCthereOrNot = function (RuleId, isNC) {
            try {
                OneViewConsole.Debug("IsNCthereOrNot Start", "oDispatchTemperatureVerification.IsNCthereOrNot");
                ...
                OneViewConsole.Debug("IsNCthereOrNot End", "oDispatchTemperatureVerification.IsNCthereOrNot");
                return ExistStatus;
            }
            catch (Excep) {
                throw Excep;
        ...
        var NormalizeNCEntityListData = function (DCNCMappingListData) {
            try {
                OneViewConsole.Debug("NormalizeNCEntityListData Start", "oDispatchTemperatureVerification.NormalizeNCEntityListData");
                ...
                OneViewConsole.Debug("NormalizeNCEntityListData End", "oDispatchTemperatureVerification.NormalizeNCEntityListData");
            }
            catch (Excep) {
                throw Excep;
            }
        ...
        this.PreControlEvents = function (AttributeId, ControlId, $event) {
            try {
                ...
                oOneViewExceptionHandler.Catch(Excep, "oDispatchTemperatureVerification.PreControlEvents", xlatService);
            }
        }
        ...
        this.ngChange_setDateTime = function (ControlId) {
            try {
                ...
                oOneViewExceptionHandler.Catch(Excep, "oDispatchTemperatureVerification.ngChange_setDateTime", xlatService);
            }
        }
        ...
        this.NCClick = function ($compile) {
            ...
            try {
                ...
                oOneViewExceptionHandler.Catch(Excep, "oDispatchTemperatureVerification.NgKeyUp", xlatService);
            }
            finally {
            }
        }
        ...
        this.NCTabClick = function ($compile) {
            ...
            try {
                ...
                oOneViewExceptionHandler.Catch(Excep, "oDispatchTemperatureVerification.AppendNCHtml", xlatService);
            }
            finally {
            }
        }
        ...
        this.ObservationTabClick = function ($compile) {
            ...
            try {
                ...
                oOneViewExceptionHandler.Catch(Excep, "oDispatchTemperatureVerification.AppendObservationHtml", xlatService);
            }
            finally {
            }
        }
        ...
        this.CustomNCClick = function () {
            ...
            try {
                ...
                oOneViewExceptionHandler.Catch(Excep, "oDispatchTemperatureVerification.CustomNCClick", xlatService);
            }
            finally {
            }
        }
        ...
        this.ProbeTesting = function () {
            try {
                ...
                oOneViewExceptionHandler.Catch(Excep, "oDispatchTemperatureVerification.ProbeTesting", xlatService);
            }
        }
        ...
        this.ClearReasons = function () {
            try {
                ...
                oOneViewExceptionHandler.Catch(Excep, "oDispatchTemperatureVerification.ClearReasons", xlatService);
            }
        }
        ...
        this.ClearComments = function () {
            try {
                ...
                oOneViewExceptionHandler.Catch(Excep, "oDispatchTemperatureVerification.ClearComments", xlatService);
            }
        }
