...
MyApp.controller('MonthlyVerificationofProbeThermometerController',
    function ($scope, $document, xlatService, $timeout, $location, $templateCache, snapRemote, $compile) {
    //oSetDefaultSpinner.Start();
        // xlatService.setCurrentPage('MonthlyVerificationofProbeThermometer');
	...
	var oYearlyVerificationFacade = new MonthlyVerificationofProbeThermometerVerificationFacade({ 'scope': $scope, 'document': $document, 'Mylocation': $location, 'xlatService': xlatService, 'toaster': '', 'SpinService': '', 'compile': $compile, '$timeout': $timeout });
...
function MonthlyVerificationofProbeThermometerVerificationFacade(parm) {
      ...
      //  var _oNCComponent = new NCComponent($scope, TemplateNodes, '', xlatService);
              ...
              new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'AddlDepartment1ControlId', 'DataSourceModelName': 'Departments', 'DisplayElementModelName': 'NewDCModel.AddlDepartment1ControlId', 'DATEntityTypeId': DATEntityType.RCOMaster_MicrobiologyDepartment, 'xlatService': xlatService, 'ToasterService': '', 'MinCharToSearch': 0, 'AttributeNodeId': 10358, 'IsDynamicElementCreationEnabled': false });
               // oDepartment1ddl.SetDataSourceFromTreeChildsWithType(OrganizationId, DATEntityType.RCOMaster_MicrobiologyDepartment, _TableNamesEnum.OrganizationAssetsNode);
                ...
                var oThermometerCodeddl =
                  new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'AddlThermometerCodeControlId', 'DataSourceModelName': 'ThermometerCodes', 'DisplayElementModelName': 'NewDCModel.AddlThermometerCodeControlId', 'IsDynamicElementCreationEnabled': false, 'DATEntityTypeId': DATEntityType.RCOMaster_ProbeThermometer, 'xlatService': xlatService, 'ToasterService': '', 'MinCharToSearch': 0, 'AttributeNodeId': 929 });
               ...
               // oThermometerCodeddl.SetDataSourceFromTreeChildsWithType(OrganizationId, DATEntityType.RCOMaster_ProbeThermometer, _TableNamesEnum.OrganizationAssetsNode);
                ...
                var oTestCap1RefNoddl = new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'txtTestCap1RefNoControlId', 'DataSourceModelName': 'TestCapRefNos', 'DisplayElementModelName': 'NewDCModel.txtTestCap1RefNoControlId', 'DATEntityTypeId': DATEntityType.RCOMaster_TestCap3RefNo, 'xlatService': xlatService, 'ToasterService': '', 'MinCharToSearch': 0, 'IsDynamicElementCreationEnabled': false, 'AttributeNodeId': 933 });
                oTestCap1RefNoddl.SetDataSourceFromTreeChildsWithType(OrganizationId, DATEntityType.RCOMaster_TestCap3RefNo, _TableNamesEnum.OrganizationAssetsNode);
        ...
        var LoadAnswerModes = function () {
            try {
                ...
                oThermometerStatus.AnswerModes(TemplateNodes, 10428);
