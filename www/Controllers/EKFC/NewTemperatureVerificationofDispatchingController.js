...
MyApp.controller('NewTemperatureVerificationofDispatchingController',
    ...
    var oTemperatureVerificationofDispatchingFacade = new NewTemperatureVerificationofDispatchingController({ 'scope': $scope, 'document': $document, 'location': $location, 'xlatService': xlatService, 'toaster': '', 'SpinService': '', '$timeout': $timeout, 'compile': $compile });
...
function NewTemperatureVerificationofDispatchingController(parm) {
    ...
    var SetSelectedTextBoxColor_Private = function (ControlId) {
        try {
            ...
            else if (ControlId == 'ATDeliveryTempControlId') {
                $scope.ATHiLoaderTempControlId = '';
                $scope.ATDeliveryTempControlId = 'highlight';
                $scope.ATDispatchTempControlId = '';
                $scope.ATDeliveryAmbientTempControlId = "";
                $scope.ATDispatchAmbientTempControlId = "";
            }
    ...
    this.SaveDCRecords = function (IsSubmit, $rootScope) {
        ...
        try {
            ...
            //alert("TemperatureVerificationofDispatchingFacade.SaveDCRecords Excep : " + Excep + JSON.stringify(Excep));
    ...
    var UpdateDCNCMappingForRuleDescription = function () {
        try {
            ...
            if (DCClientGuid != "" && DCClientGuid != undefined) {
                ...
                var DcId = OneViewSessionStorage.Get("DcId");
                //get LAtest Answer for 12230
                var DispatchOutTempResultQuery = "Select * from DcResultDetailsEntity where DataCaptureId =" + DcId + " and AttributeNodeId =12230";
                ...
                //get LAtest Answer for 12226
                var DelveryOutTempResultQuery = "Select * from DcResultDetailsEntity where DataCaptureId ='" + DcId + "' and AttributeNodeId =12226";
    ...
    var GetDcResult = function () {
        try {
            ...
            var Query = "Select * from DcResultDetailsEntity where DataCaptureId ='" + DcId + "' and AttributeNodeId in (12230,12226)";
    ...
    var Loadddl = function () {
        try {
            ...
            var oAirlinesddl = new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'AddlAirlineControlId', 'DataSourceModelName': 'Airlines', 'DisplayElementModelName': 'NewDCModel.AddlAirlineControlId', 'DATEntityTypeId': DATEntityType.RCOMaster_Flight, 'xlatService': xlatService, 'ToasterService': '', 'MinCharToSearch': 0, 'AttributeNodeId': 12212 });
            ...
            var oSectorddl = new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'AddlSectorControlId', 'DataSourceModelName': 'Sectors', 'DisplayElementModelName': 'NewDCModel.AddlSectorControlId', 'DATEntityTypeId': DATEntityType.RCOMaster_Sector, 'xlatService': xlatService, 'ToasterService': '', 'MinCharToSearch': 0, 'AttributeNodeId': 12210 });
            ...
            var oFAndBddl = new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'AddlFAndBControlId', 'DataSourceModelName': 'FAndB', 'DisplayElementModelName': 'NewDCModel.AddlFAndBControlId', 'DATEntityTypeId': DATEntityType.RCOMaster_FandBOutLet, 'xlatService': xlatService, 'ToasterService': '', 'MinCharToSearch': 0, 'AttributeNodeId': 12213 });
            ...
            var oClassddl = new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'txtClassControlId', 'DataSourceModelName': 'Class', 'DisplayElementModelName': 'NewDCModel.txtClassControlId', 'DATEntityTypeId': DATEntityType.RCOMaster_Class, 'xlatService': xlatService, 'ToasterService': '', 'IsDynamicElementCreationEnabled': true, 'MinCharToSearch': 0, 'AttributeNodeId': 12217 });
    ...
    var oFlightSelectedIndexChanged = function (EventArgs) {
        try {
           ...
           // alert('oFlightSelectedIndexChanged Excep :' + JSON.stringify(Excep));
            throw Excep;
        }
        finally {
            oAirlinesddl = null;
                ...
                if (ActionResponseList.length > 1) {
                    ...
                    for (var i = 0; i < ActionResponseList.length; i++) {
                        if ((ActionResponseList[i].IsFormAction == true || ActionResponseList[i].IsFormAction == 'true') && (ActionResponseList[i].IsRuleViolated == true || ActionResponseList[i].IsRuleViolated == 'true')) {
                            if (ControlId == 'ATDispatchTempControlId' && $scope.NewDCModel.ATDispatchTempControlId > 8) //dispatch temp
                            {
                            ...
                            else if (ControlId == 'ATDeliveryTempControlId' && $scope.NewDCModel.ATDeliveryTempControlId > 6) // Delivery temp
                            {
    ...
    var EvaluateActionNCStatusOLD = function (AttributeId) {
        try {
        ...
        try {
            ...
            _oDataCaptureBO.DisplayNCMessage = function (CriteriaDisplayLabelKey) {
                try {
                    ...
                    if (AttributeId == 12230 && $scope.NewDCModel.ATDispatchTempControlId > 8) //dispatch temp
                        alert('NC-CP-NTD-018 :: Dispatch Temp should be below or equal to 8\u2103');

                    if (AttributeId == 12226 && $scope.NewDCModel.ATDeliveryTempControlId > 6) // Delivery temp
                        alert('NC-CP-NTD-018 :: Delivery Temp should be below or equal to 6\u2103');
    ...
    this.ShowNCFormActionOLD22 = function (ControlId) {
        try {
    ...
    var NCFormLoad = function (ControlId) {
        try {
            OneViewConsole.Debug("NCFormLoad Start", "TraySettingVerificationFacade.NCFormLoad");
            ...
            MyInstance.SetCurrentTimeInNCRForm();

            $scope.$apply();

            OneViewConsole.Debug("NCFormLoad End", "TraySettingVerificationFacade.NCFormLoad");
        }
        catch (Excep) {
            throw Excep;
        }
    ...
    var LoadNCddl = function () {
        try {
            ...
            var oMealTypeddl = new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'MealMealTypeControlId', 'DataSourceModelName': 'MealType', 'DisplayElementModelName': 'NewDCModel.MealMealTypeControlId', 'DATEntityTypeId': DATEntityType.RCOMaster_MealsType, 'xlatService': xlatService, 'ToasterService': '', 'IsDynamicElementCreationEnabled': true, 'MinCharToSearch': 0, 'AttributeNodeId': 317 });
           ...
           // alert('LoadNCddl Excep :' + JSON.stringify(Excep));
            throw Excep;
        }
        finally {
            oProductddl = null;
    ...
    var oDepartmentSelectedIndexChanged = function (EventArgs) {
        try {
           ...
           // alert('oDepartmentSelectedIndexChanged Excep :' + JSON.stringify(Excep));
            throw Excep;
        }
        finally {
            oSectionddl = null;
    ...
    var LoadAnswerModes = function () {
        try {
            ...
            oRefrigeratorCondition.AnswerModes(TemplateNodes, 12238);
            ...
            oRefrigeratorStatus.AnswerModes(TemplateNodes, 12239);
            ...
            oMealsinOvens.AnswerModes(TemplateNodes, 12241);
            ...
            oDryIceAddeds.AnswerModes(TemplateNodes, 12242);
    ...
    var BindNCLoadDatas = function () {
        try {
           ...
           // alert('BindNCLoadDatas Excep :' + Excep + JSON.stringify(Excep));
            throw Excep;
        }
        finally {
            TempOutNCTemplate = null;
    ...
    var GetBoutNCDataCaptureBO = function (ConstrParm) {
        try {
           ...
           // alert('GetBoutNCDataCaptureBO Excep :' + JSON.stringify(Excep));
            throw Excep;
        }
        finally {
    ...
    var ActionSignatureContent = function () {
        try {
           ...
           // alert('ActionSignatureContent Excep : ' + JSON.stringify(Excep));
            throw Excep;
        }
        finally {
            wrapper = null;
    ...
    this.SetCurrentTimeInNCRForm = function () {
        try {
            ...
            scope.NewDCModel["DTTimeInspectedControlId"] = new Date(_oDateTime.GetYear(), (_oDateTime.GetMonth()-1), _oDateTime.GetDay(), _oDateTime.GetHours(), _oDateTime.GetMinutes());//"09:21";//
