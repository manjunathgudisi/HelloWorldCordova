...
MyApp.controller('YearlyVerificationCertificateforProbeThermometerController',
    function ($scope, $document, xlatService, $timeout, $location, $templateCache, snapRemote, $compile) {
    //oSetDefaultSpinner.Start();
        //  xlatService.setCurrentPage('YearlyVerificationCertificateforProbeThermometer');
	...
	var oYearlyVerificationFacade = new YearlyVerificationFacade({ 'scope': $scope, 'document': $document, 'Mylocation': $location, 'xlatService': xlatService, 'toaster': '', 'SpinService': '', 'compile': $compile, '$timeout': $timeout });
...
function YearlyVerificationFacade(parm) {
    ...
    try {
      ...
      //  var _oNCComponent = new NCComponent($scope, TemplateNodes, '', xlatService);
        ...
        var Loadddl = function () {
            ...
            new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'AddlDepartment1ControlId', 'DataSourceModelName': 'Departments', 'DisplayElementModelName': 'NewDCModel.AddlDepartment1ControlId', 'DATEntityTypeId': DATEntityType.RCOMaster_MicrobiologyDepartment, 'xlatService': xlatService, 'ToasterService': '', 'MinCharToSearch': 0, 'AttributeNodeId': 10422, 'IsDynamicElementCreationEnabled': false });
                ...
                var oThermometerCodeddl =
                  new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'AddlThermometerCodeControlId', 'DataSourceModelName': 'ThermometerCodes', 'DisplayElementModelName': 'NewDCModel.AddlThermometerCodeControlId', 'DATEntityTypeId': DATEntityType.RCOMaster_ProbeThermometer, 'xlatService': xlatService, 'IsDynamicElementCreationEnabled': false, 'ToasterService': '', 'MinCharToSearch': 0, 'AttributeNodeId': 745 });
                oThermometerCodeddl.DefaultRefreshJobs.push({ Type: 'DefaultTextboxRefreshJob', ControlId: 'AddlThermometerSerialNoControlId', ColumnNames: ['Column1'], Seperater: '-' });
                oThermometerCodeddl.DefaultRefreshJobs.push({ Type: 'DefaultTextboxRefreshJob', ControlId: 'AddlThermometerModelNoControlId', ColumnNames: ['Column2'], Seperater: '-' });
                ...
                //oThermometerCodeddl.SetDataSourceFromTreeChildsWithType(OrganizationId, DATEntityType.RCOMaster_ProbeThermometer, _TableNamesEnum.OrganizationAssetsNode);

                //var oIRThermometerCodeddl =
                //  new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'AddlIRThermometerCodeControlId', 'DataSourceModelName': 'IRThermometerCodes', 'DisplayElementModelName': 'NewDCModel.AddlIRThermometerCodeControlId', 'DATEntityTypeId': DATEntityType.RCOMaster_IRThermometer, 'xlatService': xlatService, 'IsDynamicElementCreationEnabled': false, 'ToasterService': '', 'MinCharToSearch': 0, 'AttributeNodeId': 972 });
                //oIRThermometerCodeddl.DefaultRefreshJobs.push({ Type: 'DefaultTextboxRefreshJob', ControlId: 'AddlThermometerSerialNoControlId', ColumnNames: ['Column1'], Seperater: '-' });
                //oIRThermometerCodeddl.DefaultRefreshJobs.push({ Type: 'DefaultTextboxRefreshJob', ControlId: 'AddlThermometerModelNoControlId', ColumnNames: ['Column2'], Seperater: '-' });
                //oIRThermometerCodeddl.DefaultRefreshJobs.push({ Type: 'DefaultTextboxRefreshJob', ControlId: 'txtSectionControlId', ColumnNames: ['Column3'], Seperater: '-' });
                //oIRThermometerCodeddl.DefaultRefreshJobs.push({ Type: 'DefaultTextboxRefreshJob', ControlId: 'txtAllocationControlId', ColumnNames: ['Column4'], Seperater: '-' });

                //oIRThermometerCodeddl.SetDataSourceFromTreeChildsWithType(OrganizationId, DATEntityType.RCOMaster_IRThermometer, _TableNamesEnum.OrganizationAssetsNode);

                var oTestCap1RefNoddl = new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'txtTestCap1RefNoControlId', 'DataSourceModelName': 'TestCapRef0Nos', 'DisplayElementModelName': 'NewDCModel.txtTestCap1RefNoControlId', 'DATEntityTypeId': DATEntityType.RCOMaster_TestCap0RefNo, 'xlatService': xlatService, 'ToasterService': '', 'MinCharToSearch': 0, 'IsDynamicElementCreationEnabled': false, 'AttributeNodeId': 758 });
                oTestCap1RefNoddl.SetDataSourceFromTreeChildsWithType(OrganizationId, DATEntityType.RCOMaster_TestCap0RefNo, _TableNamesEnum.OrganizationAssetsNode);

                var oTestCap2RefNoddl = new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'txtTestCap2RefNoControlId', 'DataSourceModelName': 'TestCapRef3Nos', 'DisplayElementModelName': 'NewDCModel.txtTestCap2RefNoControlId', 'DATEntityTypeId': DATEntityType.RCOMaster_TestCap3RefNo, 'xlatService': xlatService, 'ToasterService': '', 'MinCharToSearch': 0, 'IsDynamicElementCreationEnabled': false, 'AttributeNodeId': 763 });
                oTestCap2RefNoddl.SetDataSourceFromTreeChildsWithType(OrganizationId, DATEntityType.RCOMaster_TestCap3RefNo, _TableNamesEnum.OrganizationAssetsNode);

                var oTestCap3RefNoddl = new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'txtTestCap3RefNoControlId', 'DataSourceModelName': 'TestCapRef18Nos', 'DisplayElementModelName': 'NewDCModel.txtTestCap3RefNoControlId', 'DATEntityTypeId': DATEntityType.RCOMaster_TestCap18RefNo, 'xlatService': xlatService, 'ToasterService': '', 'MinCharToSearch': 0, 'IsDynamicElementCreationEnabled': false, 'AttributeNodeId': 768 });
                oTestCap3RefNoddl.SetDataSourceFromTreeChildsWithType(OrganizationId, DATEntityType.RCOMaster_TestCap18RefNo, _TableNamesEnum.OrganizationAssetsNode);
        ...
        var oUnitsSelectedIndexChanged = function (EventArgs) {
            try {
                OneViewConsole.Debug("YearlyVerificationFacade Start", "YearlyVerificationFacade.oUnitsSelectedIndexChanged");
            ...
            new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'AddlDepartment1ControlId', 'DataSourceModelName': 'Departments', 'DisplayElementModelName': 'NewDCModel.AddlDepartment1ControlId', 'DATEntityTypeId': DATEntityType.RCOMaster_MicrobiologyDepartment, 'xlatService': xlatService, 'ToasterService': '', 'MinCharToSearch': 0, 'AttributeNodeId': 10422, 'IsDynamicElementCreationEnabled': false });
                  ...
                  new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'AddlThermometerCodeControlId', 'DataSourceModelName': 'ThermometerCodes', 'DisplayElementModelName': 'NewDCModel.AddlThermometerCodeControlId', 'DATEntityTypeId': DATEntityType.RCOMaster_ProbeThermometer, 'xlatService': xlatService, 'IsDynamicElementCreationEnabled': false, 'ToasterService': '', 'MinCharToSearch': 0, 'AttributeNodeId': 745 });
                    ...
                    oThermometerCodeddl.SetDataSourceFromTreeChildsWithType(EventArgs.NewValue.Id, DATEntityType.RCOMaster_ProbeThermometer, _TableNamesEnum.OrganizationAssetsNode);
                    ...
                    oIRThermometerCodeddl.SetDataSourceFromTreeChildsWithType(EventArgs.NewValue.Id, DATEntityType.RCOMaster_IRThermometer, _TableNamesEnum.OrganizationAssetsNode);
                    ...
                    var oThermometerCodeddl =
                   new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'AddlThermometerCodeControlId', 'DataSourceModelName': 'ThermometerCodes', 'DisplayElementModelName': 'NewDCModel.AddlThermometerCodeControlId', 'DATEntityTypeId': DATEntityType.RCOMaster_ProbeThermometer, 'xlatService': xlatService, 'ToasterService': '', 'IsDynamicElementCreationEnabled': false, 'MinCharToSearch': 0, 'AttributeNodeId': 745 });
                    oThermometerCodeddl.DefaultRefreshJobs.push({ Type: 'DefaultTextboxRefreshJob', ControlId: 'AddlThermometerSerialNoControlId', ColumnNames: ['Column1'], Seperater: '-' });
                    oThermometerCodeddl.DefaultRefreshJobs.push({ Type: 'DefaultTextboxRefreshJob', ControlId: 'AddlThermometerModelNoControlId', ColumnNames: ['Column2'], Seperater: '-' });
                    oThermometerCodeddl.DefaultRefreshJobs.push({ Type: 'DefaultTextboxRefreshJob', ControlId: 'txtSectionControlId', ColumnNames: ['Column3'], Seperater: '-' });
                    oThermometerCodeddl.DefaultRefreshJobs.push({ Type: 'DefaultTextboxRefreshJob', ControlId: 'txtAllocationControlId', ColumnNames: ['Column4'], Seperater: '-' });
                    ...
                    var oIRThermometerCodeddl =
                      new AutoCompleteUserControl({ 'Scope': $scope, 'ControlId': 'AddlIRThermometerCodeControlId', 'DataSourceModelName': 'IRThermometerCodes', 'DisplayElementModelName': 'NewDCModel.AddlIRThermometerCodeControlId', 'DATEntityTypeId': DATEntityType.RCOMaster_IRThermometer, 'xlatService': xlatService, 'ToasterService': '', 'IsDynamicElementCreationEnabled': false, 'MinCharToSearch': 0, 'AttributeNodeId': 972 });
                    oIRThermometerCodeddl.DefaultRefreshJobs.push({ Type: 'DefaultTextboxRefreshJob', ControlId: 'AddlThermometerSerialNoControlId', ColumnNames: ['Column1'], Seperater: '-' });
                    oIRThermometerCodeddl.DefaultRefreshJobs.push({ Type: 'DefaultTextboxRefreshJob', ControlId: 'AddlThermometerModelNoControlId', ColumnNames: ['Column2'], Seperater: '-' });
                    oIRThermometerCodeddl.DefaultRefreshJobs.push({ Type: 'DefaultTextboxRefreshJob', ControlId: 'txtSectionControlId', ColumnNames: ['Column3'], Seperater: '-' });
                    oIRThermometerCodeddl.DefaultRefreshJobs.push({ Type: 'DefaultTextboxRefreshJob', ControlId: 'txtAllocationControlId', ColumnNames: ['Column4'], Seperater: '-' });
                ...
                OneViewConsole.Debug("YearlyVerificationFacade End", "YearlyVerificationFacade.oUnitsSelectedIndexChanged");
            }
            catch (Excep) {
                throw Excep;
            }
        ...
        var LoadAnswerModes = function () {
            try {
                ...
                //var oThermometerType = new AnswerModeUserControl({ 'Scope': $scope, 'ControlId': 'chkThermometerType', 'DataSourceModelName': 'ThermometerTypes', 'DisplayElementModelName': 'NewDCModel.chkThermometerType' });
                //oThermometerType.AnswerModes(TemplateNodes, 744);
                ...
                oThermometerStatus.AnswerModes(TemplateNodes, 10430);
