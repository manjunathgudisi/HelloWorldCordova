...
var DATBand_ServiceID_11 = {
    YesNo: 1,    
    RiskType: 2, // Need to move risk table
}


var Band_ServiceID_11 =
   {
       1: {//YesNo
           1: { 'Name': 'Yes', 'Value': 1, 'Sequence': 1, 'ColourIndex': 'green' },
           2: { 'Name': 'No', 'Value': 2, 'Sequence': 2, 'ColourIndex': 'red' }
       },
       2: {//RiskType
           1: { 'Name': 'High', 'Value': 1, 'Sequence': 1, 'ColourIndex': 'red' },
           2: { 'Name': 'Medium', 'Value': 2, 'Sequence': 1, 'ColourIndex': 'orange' },
           3: { 'Name': 'Low', 'Value': 3, 'Sequence': 2, 'ColourIndex': 'green' },
       }
   }
...
DATBand = {};
Band = {};
DATBand = eval("DATBand_ServiceID_11");
Band = eval("Band_ServiceID_11");

var TemplateMetaData_ServiceID_11 =
  {
      11: //ServiceId(all service not supporting)
              {
                  2:
