...
var TemplateMetadataToShowPartcularAttributes = {
    3: {
        6: { Id: 6, "DATEntityType": 8, Name: 'Location' },
        7: { Id: 7, "DATEntityType": 8, Name: 'Date & Time of Incident' },
        8: { Id: 8, "DATEntityType": 8, Name: 'Date & Time of Reporting' },
        49: { Id: 49, "DATEntityType": 8, Name: 'Type of the Incident' },
        86: { Id: 86, "DATEntityType": 8, Name: 'What happened? Describe the sequence of events leading up to the incident. How & by whom it was discovered? Give brief description and attach photographs and sketches as appropriate' },
        88: { Id: 88, "DATEntityType": 8, Name: 'Possible Causes for the Incident  (violations, errors, unsafe acts/conditions)?' },
        87: { Id: 87, "DATEntityType": 8, Name: 'Evidences' },
        168: { Id: 168, "DATEntityType": 8, Name: 'Risk Category' },
        169: { Id: 169, "DATEntityType": 8, Name: 'Hazard Classification' },
    }
};
function ActionPreviewUIComponent(param) {
    ...
    this.FormHtml = function (TemplateNodes, DcResultDetailsDict, TemplateId) {
        try {
            ...
            var TemplateConfigMetadata = TemplateMetadataToShowPartcularAttributes[TemplateId];
            var ServiceId = OneViewSessionStorage.Get("ServiceId");
            if (TemplateNodes.TemplateConfigMetaDataDetails.IsAttributeGroup == true) {
                ...
                if (ChildList != null) {
                    ...
                    for (var i = 0; i < ChildList.length ; i++) {
                        ...
                        var IsExists = false;
                        if (ServiceId == 24 && TemplateId == 3) {
                            if (TemplateConfigMetadata !=undefined && TemplateConfigMetadata[Child.Id] != undefined) {
                                IsExists = true;
                            }
                            if (IsExists == true) {
    ...
    var ReadChilds = function (Child, AttributeGroupHeader, DcResultDetailsDict) {
        try {
            ...
            var Html = "";
            var _oActionHeaderFooterPreviewUIComponent = new ActionHeaderFooterPreviewUIComponent();
            if (Child.IsAttributeGroup == true) {
                if (Child.Name != "") {
                    Html += _oActionHeaderFooterPreviewUIComponent.GetAGHeaderHtml(Child.Name);
                }
    ...
    this.FormAnswermodeHtml = function (TemplateData, DcResultDetailsDict) {
        try {
            ...
            var _oActionBandAnswermodePreviewUIComponent = new ActionBandAnswermodePreviewUIComponent();
            var _oActionOtherAnswermodePreviewUIComponent = new ActionOtherAnswermodePreviewUIComponent();
            var _oBandDetailsMasterDAO = new BandDetailsMasterDAO();
           // Html += '<label class="item" style="border-width: 1px; "> ';
            Html += ' <div class="item item-button-right"><div style="white-space:normal"><label><span> ' + xlatService.xlat(TemplateData.Name) + '</span>';// _oActionBandAnswermodePreviewUIComponent.GetQuestionHtml(TemplateData.Name);         
            ...
            for (var k = 0; k < TemplateData.AnswerModes.length; k++) {
                ...
                if (AnswerMode.Type == "DCListViewControlConfig") {
                        ...
                        if (AnswerMode.SelectionType == 0 || AnswerMode.SelectionType == 'SINGLE') {
                            ...
                            if (AnswerList.length > 0) {
                                ...
                                if (AnswerList[0].Answer != "") {
                                     ...
                                     Html += _oActionBandAnswermodePreviewUIComponent.GetAnswerHtml(AnswerList[0].AnswerValue, Color);
                                                                       
                                }
                                else if (AnswerList[0].IsNA == 'true') {
                                    Html += _oActionBandAnswermodePreviewUIComponent.GetAnswerHtml("NA", "grey");
                                    break;
                                }
                            }
                            //else {
                            //    Html += '<label class="item" style="border-width: 1px; "> ';
                            //    Html += _oActionBandAnswermodePreviewUIComponent.GetQuestionHtml(TemplateData.Name);
                            //    Html += '</label> ';
                            ...
                            if (AnswerList.length > 0) {
                                ...
                                for (var m = 0; m < AnswerList.length; m++) {
                                    if (AnswerList[m].Answer != "") {
                                        ...
                                        // Html += _oActionBandAnswermodePreviewUIComponent.GetAnswerHtml(AnswerList[m].AnswerValue, Color);
                                        Html += _oActionOtherAnswermodePreviewUIComponent.GetMultiSelectAnswerHtml(AnswerList[m].AnswerValue, Color);
                        ...
                        if (AnswerMode.SelectionType == 0 || AnswerMode.SelectionType == 'SINGLE') {
                            ...
                            if (AnswerList.length > 0) {
                                if (AnswerList[0].IsNA == 'true') {
                                    ...
                                    Html += _oActionOtherAnswermodePreviewUIComponent.GetAnswerHtml(AnswerList[0].AnswerValue);
                                }
                            }
                        }
                        else if (AnswerMode.SelectionType == 1 || AnswerMode.SelectionType == 'MULTI') {
                            ...
                            //Html += _oActionOtherAnswermodePreviewUIComponent.GetQuestionHtml(TemplateData.Name);
                            if (AnswerList.length > 0) {
                                for (var m = 0; m < AnswerList.length; m++) {
                                    if (AnswerList[m].IsNA == 'true') {
                                        ...
                                        Html += _oActionOtherAnswermodePreviewUIComponent.GetAnswerHtml(AnswerList[m].AnswerValue);
                                    }
                                }
                            }
                            // Html +='</label>';
                    ...
                    if (AnswerList.length > 0) {
                        if (AnswerList[0].Answer != "") {
                            Html += _oActionOtherAnswermodePreviewUIComponent.GetAnswerHtml(AnswerList[0].Answer);
                        }
                        else if (AnswerList[0].IsNA == 'true') {
                            Html += _oActionBandAnswermodePreviewUIComponent.GetAnswerHtml("NA", "grey");
                            AttributeIsNA = true;
    ...
    this.GetMultiMediaSubElementsAnswerModeHtml = function (MultiMediaSubElementsList) {
        try {
            ...
            if (MultiMediaSubElementsList.length > 0) {              
                for (var m = 0; m < MultiMediaSubElementsList.length ; m++) {
                    var LocalURL = '"' + MultiMediaSubElementsList[m].LocalURL + '"';
                             
                     // Html +=  ' <a href=' + LocalURL + ' class="angularbox"><img src=' + LocalURL + ' rel=' + LocalURL + ' alt="No Image"></a>';
                    Html += ' <a href={{' + LocalURL + '}} class="angularbox"><img src=' + LocalURL + ' rel=' + LocalURL + ' alt="No Image"></a>';
                  }
               // Html = "<div>" + Html + "</div>";
                  
                Html = '<div class="col rounded light-bg cam-photo">' + Html + '</div>';              
               // alert('Html : ' + Html);
...
function ActionBandAnswermodePreviewUIComponent() {

    var MyInstance = this;

    this.GetHtml = function (Question, Answer, Color) {
        try {
            OneViewConsole.Debug("GetHtml Start", "ActionBandAnswermodePreviewUIComponent.GetHtml");
          //  alert(Question + "," + Answer + "," + Color);
            ...
            OneViewConsole.Debug("GetHtml End", "ActionBandAnswermodePreviewUIComponent.GetHtml");
           // alert('GetHtml : ' + Html);
            return Html;
        }

        catch (Excep) {
            throw oOneViewExceptionHandler.Create("Framework", "ActionBandAnswermodePreviewUIComponent.GetHtml", Excep);
        }
    }
...
function ActionOtherAnswermodePreviewUIComponent() {

    var MyInstance = this;

    this.GetHtml = function (Question, Answer) {
        try {
            OneViewConsole.Debug("GetHtml Start", "ActionOtherAnswermodePreviewUIComponent.GetHtml");
            ...
            OneViewConsole.Debug("GetHtml End", "ActionOtherAnswermodePreviewUIComponent.GetHtml");
            ...
            throw oOneViewExceptionHandler.Create("Framework", "ActionOtherAnswermodePreviewUIComponent.GetHtml", Excep);
        }
    }
    ...
    this.GetAnswerHtml = function (Answer) {
        try {
            ...
            var Html = '<p style="white-space: normal; background-color: #f8f8f8;">' + Answer + ' </p>';
    ...
    this.GetMultiSelectAnswerHtml = function (Answer, Color) {
        try {
            OneViewConsole.Debug("GetMultiSelectAnswerHtml Start", "ActionOtherAnswermodePreviewUIComponent.GetMultiSelectAnswerHtml");

            var Html = ' <span class="input-label" style="color:' + Color + ';">' + Answer + '</span>';

            OneViewConsole.Debug("GetMultiSelectAnswerHtml End", "ActionOtherAnswermodePreviewUIComponent.GetMultiSelectAnswerHtml");
...
function ActionHeaderFooterPreviewUIComponent() {

    var MyInstance = this;

    this.GetAGHeaderHtml = function (DisplayHeaderName) {
        try {
            OneViewConsole.Debug("GetAGHeaderHtml Start", "ActionHeaderFooterPreviewUIComponent.GetAGHeaderHtml");

            var Html = '<div class="title-bar rounded margin-top">' + DisplayHeaderName + '</div>';

            OneViewConsole.Debug("GetAGHeaderHtml End", "ActionHeaderFooterPreviewUIComponent.GetAGHeaderHtml");
           // alert('GetAGHeaderHtml Html : ' + Html);
            return Html;
        }

        catch (Excep) {
            throw oOneViewExceptionHandler.Create("Framework", "ActionHeaderFooterPreviewUIComponent.GetAGHeaderHtml", Excep);
        }
    }

    this.GetPageHeaderHtml = function (PageHeaderName) {
        try {
            OneViewConsole.Debug("GetPageHeaderHtml Start", "ActionHeaderFooterPreviewUIComponent.GetPageHeaderHtml");
            ...
            OneViewConsole.Debug("GetPageHeaderHtml End", "ActionHeaderFooterPreviewUIComponent.GetPageHeaderHtml");

            return Html;
        }

        catch (Excep) {
            throw oOneViewExceptionHandler.Create("Framework", "ActionHeaderFooterPreviewUIComponent.GetPageHeaderHtml", Excep);
        }
    }
}
